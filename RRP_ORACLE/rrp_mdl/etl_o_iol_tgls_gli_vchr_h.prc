CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_O_IOL_TGLS_GLI_VCHR_H(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_O_IOL_TGLS_GLI_VCHR_H
  *  功能描述：接口传票历史表
  *  创建日期：20220820
  *  开发人员：梅炜
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_O_IOL_TGLS_GLI_VCHR_H'; -- 程序名称
