CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_INIT_O_ICL_CMM_INDV_CUST_BASIC_INFO(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_INIT_O_ICL_CMM_INDV_CUST_BASIC_INFO
  *  功能描述：个人客户基本信息
  *  创建日期：20220525
  *  开发人员：梅炜
  *  来源表：
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_INIT_O_ICL_CMM_INDV_CUST_BASIC_INFO'; -- 程序名称
...
EXECUTE IMMEDIATE 'TRUNCATE TABLE '|| V_TABLE_NAME;
  ...
  V_TAB_NAME := 'O_ICL_CMM_INDV_CUST_BASIC_INFO'; --表名
  ...
  V_STEP_DESC := '-- 程序跑批开始 --';
  V_STARTTIME := SYSDATE;
   -- EXECUTE IMMEDIATE ' TRUNCATE TABLE  O_ICL_CMM_INDV_CUST_BASIC_INFO T WHERE  T.ETL_DT = TO_DATE(V_P_DATE,'YYYYMMDD');
  -- -- EXECUTE IMMEDIATE ' TRUNCATE TABLE O_ICL_CMM_INDV_CUST_BASIC_INFO';
  ...
  V_STARTTIME := SYSDATE;
  INSERT INTO RRP_MDL.O_ICL_CMM_INDV_CUST_BASIC_INFO
  (      ETL_DT  --数据日期
      ,LP_ID  --法人编号
      ,CUST_ID  --客户编号
      ,CUST_TYPE_CD  --客户类型代码
  ...
  END ETL_INIT_O_ICL_CMM_INDV_CUST_BASIC_INFO;
/
