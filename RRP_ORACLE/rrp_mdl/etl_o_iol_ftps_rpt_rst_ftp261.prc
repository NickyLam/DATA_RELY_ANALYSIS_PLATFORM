CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_O_IOL_FTPS_RPT_RST_FTP261 (I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_O_IOL_FTPS_RPT_RST_FTP261
  *  功能描述：FTP初级报表账户明细结果集
  *  创建日期：20221208
  *  开发人员：梅炜
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_O_IOL_FTPS_RPT_RST_FTP261'; -- 程序名称
  ...
  V_STEP_DESC := '-- 程序跑批开始 --';
  V_STARTTIME := SYSDATE;
  DELETE FROM O_IOL_FTPS_RPT_RST_FTP261  T WHERE T.ETL_DT = TO_DATE(V_P_DATE,'YYYYMMDD');
  ...
  (
    ...
    WHERE ETL_DT = TO_DATE(V_P_DATE,'YYYYMMDD');   --视图-FTP初级报表账户明细结果集
  ...
  END ETL_O_IOL_FTPS_RPT_RST_FTP261 ;
/
