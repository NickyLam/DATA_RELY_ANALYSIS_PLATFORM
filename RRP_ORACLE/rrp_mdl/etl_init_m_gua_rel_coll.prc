CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_INIT_M_GUA_REL_COLL(I_P_DATE IN INTEGER,
                                                O_ERRCODE OUT VARCHAR2
                                                )
  /**************************************************************************
  *  程序名称：ETL_INIT_M_GUA_REL_COLL
  *  功能描述：担保合同与押品对应关系表
  *  创建日期：20220525
  *  开发人员：梅炜
  *  来源表：
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(200) := 'ETL_INIT_M_GUA_REL_COLL'; -- 程序名称
 ...
 -- V_LAST_DAT  VARCHAR2(8); -- 当月月末
  ...
  (
      ...
      SELECT    V_P_DATE                  AS DATA_DT         --数据日期
             ...
             ,CASE WHEN B.PRIOR_COMP_WEIGHT_QTTY = 0 THEN '第一顺位' ELSE
               (CASE WHEN C.HXB_PRIOR_SEQ_COMB_CD IN ('0','1') THEN '第一顺位'
                ...
                ELSE '第一顺位' END) END  AS COLL_SEQ      --担保物顺序，目前HXB_PRIOR_SEQ_COMB_CD只有0,1,2
