CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_INIT_O_IOL_ALBS_BLS_CUST_ALL_AML(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_INIT_O_IOL_ALBS_BLS_CUST_ALL_AML
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_INIT_O_IOL_ALBS_BLS_CUST_ALL_AML'; -- 程序名称
...
EXECUTE IMMEDIATE 'TRUNCATE TABLE '|| V_TABLE_NAME;
  ...
  V_STEP_DESC := '-- 程序跑批开始 --';
  V_STARTTIME := SYSDATE;
   -- EXECUTE IMMEDIATE ' TRUNCATE TABLE  O_IOL_ALBS_BLS_CUST_ALL_AML ;
  -- -- EXECUTE IMMEDIATE ' TRUNCATE TABLE O_IOL_ALBS_BLS_CUST_ALL_AML';
...
;
  ...
  END ETL_INIT_O_IOL_ALBS_BLS_CUST_ALL_AML;
/
