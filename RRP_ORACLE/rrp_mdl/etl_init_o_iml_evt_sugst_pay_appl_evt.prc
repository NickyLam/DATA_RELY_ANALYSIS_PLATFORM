CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_INIT_O_IML_EVT_SUGST_PAY_APPL_EVT(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_INIT_O_IML_EVT_SUGST_PAY_APPL_EVT
  *  功能描述：登提示付款申请事件
  *  创建日期：20230113
  *  开发人员：MW
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_INIT_O_IML_EVT_SUGST_PAY_APPL_EVT'; -- 程序名称
...
EXECUTE IMMEDIATE 'TRUNCATE TABLE '|| V_TABLE_NAME;
  ...
  V_STEP_DESC := '-- 程序跑批开始 --';
  V_STARTTIME := SYSDATE;
  -- -- EXECUTE IMMEDIATE ' TRUNCATE TABLE  O_IML_EVT_SUGST_PAY_APPL_EVT ;
   -- EXECUTE IMMEDIATE ' TRUNCATE TABLE O_IML_EVT_SUGST_PAY_APPL_EVT';
...
;
  ...
  END ETL_INIT_O_IML_EVT_SUGST_PAY_APPL_EVT;
/
