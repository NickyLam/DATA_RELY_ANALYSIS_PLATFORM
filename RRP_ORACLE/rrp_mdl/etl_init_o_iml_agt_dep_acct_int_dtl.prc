CREATE OR REPLACE PROCEDURE RRP_MDL."ETL_INIT_O_IML_AGT_DEP_ACCT_INT_DTL" (I_P_DATE IN INTEGER, --跑批日期
                                                 O_ERRCODE  OUT VARCHAR2 --错误代码
                                                 )
 /*******************************************************************
  **存储过程详细说明： 存款账户利息明细表
  **存储过程名称：    ETL_INIT_O_IML_AGT_DEP_ACCT_INT_DTL
  **存储过程创建日期：20221130
  **存储过程创建人：  HULIJUAN
  **输入参数：        I_P_DATE
  **输出参数：        O_ERRCODE
 ...
 AS
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_INIT_O_IML_AGT_DEP_ACCT_INT_DTL'; -- 程序名称
...
END ETL_INIT_O_IML_AGT_DEP_ACCT_INT_DTL;
/
