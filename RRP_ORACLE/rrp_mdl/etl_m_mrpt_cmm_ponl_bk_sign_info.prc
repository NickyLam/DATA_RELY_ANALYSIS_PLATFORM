CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_M_MRPT_CMM_PONL_BK_SIGN_INFO(I_P_DATE IN INTEGER,
                                                O_ERRCODE OUT VARCHAR2
                                                )
  /**************************************************************************
  *  程序名称：ETL_M_MRPT_CMM_PONL_BK_SIGN_INFO
  *  功能描述：个人网银签约信息
  *  创建日期：20230105
  *  开发人员：阳娟
  *  来源表：
  *  目标表：  M_MRPT_CMM_PONL_BK_SIGN_INFO
  *  配置表：  CODE_MAP
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_M_MRPT_CMM_PONL_BK_SIGN_INFO'; -- 程序名称
...
BEGIN
  ...
  V_TAB_NAME := 'M_MRPT_CMM_PONL_BK_SIGN_INFO'; --表名称
  ...
  I_STEP_DESC := '-- 程序跑批开始 --';
  D_STARTTIME := SYSDATE;
  --DELETE FROM M_MRPT_CMM_PONL_BK_SIGN_INFO T WHERE T.DATA_DT = V_P_DATE;--普通表的重跑处理
  /*SELECT COUNT(0)
    INTO V_PART_COUNT
  ...
  I_STEP_DESC := '数据落地-个人网银签约信息';
  D_STARTTIME := SYSDATE;
  INSERT INTO RRP_MDL.M_MRPT_CMM_PONL_BK_SIGN_INFO
  (
           DATA_DT  --数据日期
          ,LP_ID  --法人编号
          ,CUST_ID  --客户编号
     ...
     SELECT
          ...
          ,CTY  --国家
          ,JOB_CD  --任务代码
    FROM RRP_MDL.O_ICL_CMM_PONL_BK_SIGN_INFO
  ...
  END ETL_M_MRPT_CMM_PONL_BK_SIGN_INFO;
/
