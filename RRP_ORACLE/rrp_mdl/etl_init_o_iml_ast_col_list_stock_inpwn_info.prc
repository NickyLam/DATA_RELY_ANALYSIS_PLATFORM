CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_INIT_O_IML_AST_COL_LIST_STOCK_INPWN_INFO(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_INIT_O_IML_AST_COL_LIST_STOCK_INPWN_INFO
  *  功能描述：押品上市公司股权质押信息
  *  创建日期：20221124
  *  开发人员：许晓滨
  *  来源表：
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_INIT_O_IML_AST_COL_LIST_STOCK_INPWN_INFO'; -- 程序名称
...
EXECUTE IMMEDIATE 'TRUNCATE TABLE '|| V_TABLE_NAME;
  ...
  V_STEP_DESC := '-- 程序跑批开始 --';
  V_STARTTIME := SYSDATE;
   -- EXECUTE IMMEDIATE ' TRUNCATE TABLE O_IML_AST_COL_LIST_STOCK_INPWN_INFO';
  ...
  V_STARTTIME := SYSDATE;
  INSERT /*+ APPEND */ INTO O_IML_AST_COL_LIST_STOCK_INPWN_INFO NOLOGGING
    (
         ASSET_ID                   --01 资产编号
        ,LP_ID                      --02 法人编号
        ,STOCK_CD                   --03 股票代码
  ...
  END ETL_INIT_O_IML_AST_COL_LIST_STOCK_INPWN_INFO;
/
