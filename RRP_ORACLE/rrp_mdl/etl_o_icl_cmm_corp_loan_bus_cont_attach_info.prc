CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_O_ICL_CMM_CORP_LOAN_BUS_CONT_ATTACH_INFO(I_P_DATE IN INTEGER,
                                                                         O_ERRCODE OUT VARCHAR2
                                                                         )
  /**************************************************************************
  *  程序名称：ETL_O_ICL_CMM_CORP_LOAN_BUS_CONT_ATTACH_INFO
  *  功能描述：对公贷款业务合同补充信息
  *  创建日期：20220525
  *  开发人员：梅炜
  ...
  *             1    20220525  梅炜     首次创建
                2    20220615           修改参数
  *             3    20240429   YJY     新增养老产业标志、投向政府和社会资本合作项目标志、新机制发放贷款标志
  *             4    20240507   YJY     新增种业振兴贷款标志、县城区贷款标志
  *             5    20240528   YJY     新增投向高技术产业标志、投向数字经济核心产业类型代码
  *             6    20240829   YJY     新增高技术服务业贷款标志、高技术服务业贷款类型代码
  *             7    20241010   YJY     新增关系人保证贷款标志字段
  *             8    20250414   YJY     新增合同金额字段
  *********************************************************************/
AS
  -- 定义变量 --
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_O_ICL_CMM_CORP_LOAN_BUS_CONT_ATTACH_INFO'; --程序名称
...
BEGIN
  ...
  V_STEP_DESC := '-- 程序跑批开始 --';
  V_STARTTIME := SYSDATE;
  DELETE FROM RRP_MDL.O_ICL_CMM_CORP_LOAN_BUS_CONT_ATTACH_INFO T WHERE T.ETL_DT = TO_DATE(V_P_DATE,'YYYYMMDD');
  --EXECUTE IMMEDIATE 'TRUNCATE TABLE RRP_MDL.O_ICL_CMM_CORP_LOAN_BUS_CONT_ATTACH_INFO';
  ...
  INSERT INTO RRP_MDL.O_ICL_CMM_CORP_LOAN_BUS_CONT_ATTACH_INFO
    ...
    ,PROVI_FOR_AGED_PROPERTY_FLG       --养老产业标志   add by yjy 20240429
    ,PPP_PROJ_FLG                      --投向政府和社会资本合作项目标志  add by yjy 20240429
    ,NEW_DISTR_FLG                     --新机制发放贷款标志   add by yjy 20240429
    ,SEED_LOAN_FLG                     --种业振兴贷款标志  add by yjy 202400507
    ,COUNTY_LOAN_FLG                   --县城区贷款标志  add by yjy 202400507
    ,HIGH_TECH_PROPERTY_FLG            --投向高技术产业标志   ADD BY YJY 20240528
    ,DIGIT_ECON_CORE_TYPE_CD           --投向数字经济核心产业类型代码   ADD BY YJY 20240528
    ...
    ,CONT_BAL                          --合同余额 ADD BY YJY 20250414
    )
  SELECT 
     ETL_DT                            --数据日期
    ,LP_ID                             --法人编号
...
END ETL_O_ICL_CMM_CORP_LOAN_BUS_CONT_ATTACH_INFO;
/
