CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_O_IML_AGT_LOAN_REPAY_PLAN_DTL_H(I_P_DATE IN INTEGER,
                                                                O_ERRCODE OUT VARCHAR2
                                                                )
  /**************************************************************************
  *  程序名称：ETL_O_IML_AGT_LOAN_REPAY_PLAN_DTL_H
  *  功能描述：贷款还款计划明细历史
  *  创建日期：20221222
  *  开发人员：梅炜
...
AS
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_O_IML_AGT_LOAN_REPAY_PLAN_DTL_H'; --程序名称
...
BEGIN
  ...
  V_STEP_DESC := '-- 程序跑批开始 --';
  V_STARTTIME := SYSDATE;
  EXECUTE IMMEDIATE 'TRUNCATE TABLE RRP_MDL.O_IML_AGT_LOAN_REPAY_PLAN_DTL_H';
  ...
  ETL_DBMS_STATS(V_P_DATE, 'O_IML_AGT_LOAN_REPAY_PLAN_DTL_H','', O_ERRCODE);
...
END ETL_O_IML_AGT_LOAN_REPAY_PLAN_DTL_H;
/
