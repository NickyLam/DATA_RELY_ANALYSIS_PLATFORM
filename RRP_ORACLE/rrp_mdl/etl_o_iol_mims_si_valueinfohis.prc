CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_O_IOL_MIMS_SI_VALUEINFOHIS(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_O_IOL_MIMS_SI_VALUEINFOHIS
  *  功能描述：押品价值历史信息
  *  创建日期：20221205
  *  开发人员：HULIJUAN
  ...
  *************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_O_IOL_MIMS_SI_VALUEINFOHIS'; -- 程序名称
  ...
  V_STEP_DESC := '-- 程序跑批开始 --';
  V_STARTTIME := SYSDATE;
  DELETE FROM O_IOL_MIMS_SI_VALUEINFOHIS T WHERE T.START_DT >= TO_DATE(V_P_DATE,'YYYYMMDD') AND T.END_DT<TO_DATE(V_P_DATE,'YYYYMMDD');
  ...
  END ETL_O_IOL_MIMS_SI_VALUEINFOHIS;
/
