CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_INIT_O_IML_EVT_IC_CARD_OFFLINE_TRAN_FLOW(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_INIT_O_IML_EVT_IC_CARD_OFFLINE_TRAN_FLOW
  *  功能描述：IC卡脱机交易流水
  *  创建日期：20230114
  *  开发人员：MW
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_INIT_O_IML_EVT_IC_CARD_OFFLINE_TRAN_FLOW'; -- 程序名称
...
EXECUTE IMMEDIATE 'TRUNCATE TABLE '|| V_TABLE_NAME;
  ...
  V_STEP_DESC := '-- 程序跑批开始 --';
  V_STARTTIME := SYSDATE;
  -- -- EXECUTE IMMEDIATE ' TRUNCATE TABLE  O_IML_EVT_IC_CARD_OFFLINE_TRAN_FLOW ;
   -- EXECUTE IMMEDIATE ' TRUNCATE TABLE O_IML_EVT_IC_CARD_OFFLINE_TRAN_FLOW';
...
;
  ...
  END ETL_INIT_O_IML_EVT_IC_CARD_OFFLINE_TRAN_FLOW;
/
