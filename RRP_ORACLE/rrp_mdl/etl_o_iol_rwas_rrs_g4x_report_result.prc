CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_O_IOL_RWAS_RRS_G4X_REPORT_RESULT(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_O_IOL_RWAS_RRS_G4X_REPORT_RESULT
  *  功能描述：风险计量系统1104法人报表
  *  创建日期：20221007
  *  开发人员：HULJ
  *  来源表：
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_O_IOL_RWAS_RRS_G4X_REPORT_RESULT'; -- 程序名称
  ...
  V_STEP_DESC := '-- 程序跑批开始 --';
  V_STARTTIME := SYSDATE;
  --DELETE FROM O_IOL_RWAS_RRS_G4X_REPORT_RESULT T WHERE T.DATA_DATE = TO_DATE(V_P_DATE,'YYYYMMDD');
...
/*    IF TO_CHAR(TO_DATE(I_P_DATE, 'YYYYMMDD')+1, 'DD') = '01' THEN
  ...
  END ETL_O_IOL_RWAS_RRS_G4X_REPORT_RESULT;
/
