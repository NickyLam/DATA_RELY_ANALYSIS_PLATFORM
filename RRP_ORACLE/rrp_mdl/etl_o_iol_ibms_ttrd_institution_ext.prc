CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_O_IOL_IBMS_TTRD_INSTITUTION_EXT(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_O_IOL_IBMS_TTRD_INSTITUTION_EXT
  *  功能描述：机构扩展信息表
  *  创建日期：20220820
  *  开发人员：梅炜
  *  来源表： IOL.V_IBMS_TTRD_INSTITUTION_EXT
  ...
  **************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_O_IOL_IBMS_TTRD_INSTITUTION_EXT'; -- 程序名称
  ...
  END ETL_O_IOL_IBMS_TTRD_INSTITUTION_EXT;
/
