CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_O_IOL_FAMS_PBC_REPORT (I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_O_IOL_FAMS_PBC_REPORT
  *  功能描述：人行报表
  *  创建日期：20221211
  *  开发人员：梅炜
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_O_IOL_FAMS_PBC_REPORT'; -- 程序名称
  ...
  V_STEP_DESC := '-- 程序跑批开始 --';
  V_STARTTIME := SYSDATE;
  --DELETE FROM O_IOL_FAMS_PBC_REPORT  T WHERE T.ETL_DT = TO_DATE(V_P_DATE,'YYYYMMDD');
  ...
  (
    ...
    WHERE ETL_DT = TO_DATE(V_P_DATE,'YYYYMMDD');  --视图-人行报表
