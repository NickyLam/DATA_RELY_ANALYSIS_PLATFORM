CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_INIT_O_IOL_CTMS_VI_FBS_ACCOUNT_CPTYS_INFO(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_INIT_O_IOL_CTMS_VI_FBS_ACCOUNT_CPTYS_INFO
  *  功能描述：资金交易对手_外币
  *  创建日期：20221227
  *  开发人员：梅炜
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_INIT_O_IOL_CTMS_VI_FBS_ACCOUNT_CPTYS_INFO'; -- 程序名称
...
EXECUTE IMMEDIATE 'TRUNCATE TABLE '|| V_TABLE_NAME;
  ...
  V_STEP_DESC := '-- 程序跑批开始 --';
  V_STARTTIME := SYSDATE;
  -- -- EXECUTE IMMEDIATE ' TRUNCATE TABLE  O_IOL_CTMS_VI_FBS_ACCOUNT_CPTYS_INFO ;
   -- EXECUTE IMMEDIATE ' TRUNCATE TABLE O_IOL_CTMS_VI_FBS_ACCOUNT_CPTYS_INFO';
...
;
  ...
  END ETL_INIT_O_IOL_CTMS_VI_FBS_ACCOUNT_CPTYS_INFO;
/
