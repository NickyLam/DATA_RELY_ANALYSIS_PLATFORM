CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_O_IOL_CTMS_FBS_V_COUNTERPARTY(I_P_DATE IN INTEGER,
                                                              O_ERRCODE OUT VARCHAR2
                                                              )
  /**************************************************************************
  *  程序名称：ETL_O_IOL_CTMS_FBS_V_COUNTERPARTY
  *  功能描述：交易对手视图
  *  创建日期：20220820
  *  开发人员：梅炜
  *  来源表： IOL.V_CTMS_FBS_V_COUNTERPARTY
...
AS
  ...
  V_TAB_NAME  VARCHAR2(200) := 'O_IOL_CTMS_FBS_V_COUNTERPARTY'; --表名
  V_PROC_NAME VARCHAR2(50) := 'ETL_O_IOL_CTMS_FBS_V_COUNTERPARTY'; --程序名称
...
END ETL_O_IOL_CTMS_FBS_V_COUNTERPARTY;
/
