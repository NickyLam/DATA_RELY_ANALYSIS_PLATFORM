CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_S_IOL_ICMS_MYHB_AC_SUMMARY_TRANS_01(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_S_IOL_ICMS_MYHB_AC_SUMMARY_TRANS_01
  *  功能描述：花呗汇总记账文件(每天增量)
  *  创建日期：20230114
  *  开发人员：MW
  *  来源表： IOL.V_ICMS_MYHB_AC_SUMMARY_TRANS_01
  *  目标表： S_IOL_ICMS_MYHB_AC_SUMMARY_TRANS_01
  *  配置表：
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_S_IOL_ICMS_MYHB_AC_SUMMARY_TRANS_01'; -- 程序名称
  ...
  V_TAB_NAME := 'S_IOL_ICMS_MYHB_AC_SUMMARY_TRANS_01'; --表名
  ...
  V_STARTTIME := SYSDATE;
  INSERT INTO RRP_MDL.S_IOL_ICMS_MYHB_AC_SUMMARY_TRANS_01
  (
               DATA_DT  ---数据日期
              ,SETTLEDATE  --业务日期
              ,REGIONCODE  --行政区划代码
...
;
 ...
 -- V_STEP := V_STEP + 1;
  ...
  END ETL_S_IOL_ICMS_MYHB_AC_SUMMARY_TRANS_01;
/
