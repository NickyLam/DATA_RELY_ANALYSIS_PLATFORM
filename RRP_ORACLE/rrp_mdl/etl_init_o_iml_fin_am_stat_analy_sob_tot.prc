CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_INIT_O_IML_FIN_AM_STAT_ANALY_SOB_TOT(I_P_DATE IN INTEGER,
                                                O_ERRCODE OUT VARCHAR2
                                                )
  /**************************************************************************
  *  程序名称：ETL_INIT_O_IML_FIN_AM_STAT_ANALY_SOB_TOT
  *  功能描述：资管统计分析账套汇总
  *  创建日期：20220611
  *  开发人员：梅炜
  *  来源表：
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_INIT_O_IML_FIN_AM_STAT_ANALY_SOB_TOT'; -- 程序名称
...
EXECUTE IMMEDIATE 'TRUNCATE TABLE '|| V_TABLE_NAME;
  ...
  V_STEP_DESC := '-- 程序跑批开始 --';
  V_STARTTIME := SYSDATE;
   -- EXECUTE IMMEDIATE ' TRUNCATE TABLE  O_IML_FIN_AM_STAT_ANALY_SOB_TOT ';
  -- -- EXECUTE IMMEDIATE ' TRUNCATE TABLE O_IML_FIN_AM_STAT_ANALY_SOB_TOT';
  ...
  */
  ...
  END ETL_INIT_O_IML_FIN_AM_STAT_ANALY_SOB_TOT;
/
