CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_O_IOL_NCBS_RB_BATCH_RESERVE_INFO(I_P_DATE IN INTEGER,
                                O_ERRCODE OUT VARCHAR2
                                 )
    /**************************************************************************
    *  程序名称：ETL_O_IOL_NCBS_RB_BATCH_RESERVE_INFO
    *  功能描述：备款基础信息表
    *  创建日期：20230302
    *  开发人员：MW
    ...
    **************************************************************************/
    ...
    V_PROC_NAME VARCHAR2(50) := 'ETL_O_IOL_NCBS_RB_BATCH_RESERVE_INFO'; -- 程序名称
    ...
    V_STEP_DESC := '-- 程序跑批开始 --';
    V_STARTTIME := SYSDATE;
    --DELETE FROM O_IOL_NCBS_RB_BATCH_RESERVE_INFO T WHERE T.ETL_DT = TO_DATE(V_P_DATE,'YYYYMMDD');
    EXECUTE IMMEDIATE 'TRUNCATE TABLE RRP_MDL.O_IOL_NCBS_RB_BATCH_RESERVE_INFO';
    ...
    END ETL_O_IOL_NCBS_RB_BATCH_RESERVE_INFO;
/
