CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_INIT_O_IML_EVT_LOAN_FIN_TRAN_FLOW(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_INIT_O_IML_EVT_LOAN_FIN_TRAN_FLOW
  *  功能描述：贷款金融交易流水
  *  创建日期：20220525
  *  开发人员：梅炜
  *  来源表：
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(500) := 'ETL_INIT_O_IML_EVT_LOAN_FIN_TRAN_FLOW'; -- 程序名称
...
EXECUTE IMMEDIATE 'TRUNCATE TABLE '|| V_TABLE_NAME;
  ...
  V_STEP_DESC := '-- 程序跑批开始 --';
  V_STARTTIME := SYSDATE;
   -- EXECUTE IMMEDIATE ' TRUNCATE TABLE  O_IML_EVT_LOAN_FIN_TRAN_FLOW ;
  -- -- EXECUTE IMMEDIATE ' TRUNCATE TABLE O_IML_EVT_LOAN_FIN_TRAN_FLOW';
  ...
  (      ETL_DT  --数据日期
    ...
    SELECT
      ...
      ,BUS_FLOW_NUM  --业务流水号
    ,JOB_CD --任务代码
    FROM IML.V_EVT_LOAN_FIN_TRAN_FLOW@LINK_SIT2  --视图-贷款金融交易流水
  ...
  END ETL_INIT_O_IML_EVT_LOAN_FIN_TRAN_FLOW;
/
