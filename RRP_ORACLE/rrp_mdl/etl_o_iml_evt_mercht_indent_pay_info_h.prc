CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_O_IML_EVT_MERCHT_INDENT_PAY_INFO_H(I_P_DATE IN INTEGER,
                                                                   O_ERRCODE OUT VARCHAR2
                                                                   )
  /**************************************************************************
  *  程序名称：ETL_O_IML_EVT_MERCHT_INDENT_PAY_INFO_H
  *  功能描述：商户订单支付信息历史
  *  创建日期：20221210
  *  开发人员：梅炜
  *  来源表：
...
AS
  ...
  V_TAB_NAME  VARCHAR2(50) := 'O_IML_EVT_MERCHT_INDENT_PAY_INFO_H'; --表名
  V_PROC_NAME VARCHAR2(50) := 'ETL_O_IML_EVT_MERCHT_INDENT_PAY_INFO_H'; --程序名称
...
BEGIN
  ...
  V_STEP_DESC := '-- 程序跑批开始 --';
  V_STARTTIME := SYSDATE;
  EXECUTE IMMEDIATE 'TRUNCATE TABLE RRP_MDL.O_IML_EVT_MERCHT_INDENT_PAY_INFO_H';
  ...
  V_STARTTIME := SYSDATE;
  INSERT /*+APPEND*/ INTO RRP_MDL.O_IML_EVT_MERCHT_INDENT_PAY_INFO_H
    (EVT_ID                         --事件编号
    ,LP_ID                          --法人编号
...
END ETL_O_IML_EVT_MERCHT_INDENT_PAY_INFO_H;
/
