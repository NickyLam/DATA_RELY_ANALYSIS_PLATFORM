CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_INIT_O_IOL_BDMS_TBL_ACCT_TRANS_FLOW(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_INIT_O_IOL_BDMS_TBL_ACCT_TRANS_FLOW
  *  功能描述：交易流水中间表
  *  创建日期：20230216
  *  开发人员：梅炜
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_INIT_O_IOL_BDMS_TBL_ACCT_TRANS_FLOW'; -- 程序名称
...
EXECUTE IMMEDIATE 'TRUNCATE TABLE '|| V_TABLE_NAME;
 ...
 --清理当天数据
  ...
  SELECT /*+PARALLEL*/
						...
						,ID_MARK  --增删标志
						,ETL_TIMESTAMP  --ETL处理时间戳
    FROM IOL.V_BDMS_TBL_ACCT_TRANS_FLOW   --主指令表(视图)_视图
;
 ...
 V_SQLCOUNT := SQL%ROWCOUNT;
  ...
  END ETL_INIT_O_IOL_BDMS_TBL_ACCT_TRANS_FLOW;
/
