CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_O_ICL_CMM_RETL_LOAN_CONT_INFO(I_P_DATE IN INTEGER,
                                                              O_ERRCODE OUT VARCHAR2
                                                              )
  /**************************************************************************
  *  程序名称：ETL_O_ICL_CMM_RETL_LOAN_CONT_INFO
  *  功能描述：零售贷款合同信息
  *  创建日期：20220525
  *  开发人员：梅炜
  *  来源表：
  ...
  *             4    20250905  YJY      新增申请流水号
  *             5    20251126  YJY      新增养老产业标识
  *************************************************************************/
AS
  -- 定义变量 --
  ...
  V_TAB_NAME  VARCHAR2(100) := 'O_ICL_CMM_RETL_LOAN_CONT_INFO'; --表名
  V_PROC_NAME VARCHAR2(50) := 'ETL_O_ICL_CMM_RETL_LOAN_CONT_INFO'; --程序名称
...
BEGIN
  ...
  V_STEP_DESC := '-- 程序跑批开始 --';
  V_STARTTIME := SYSDATE;
  --DELETE FROM RRP_MDL.O_ICL_CMM_RETL_LOAN_CONT_INFO T WHERE T.ETL_DT = TO_DATE(V_P_DATE,'YYYYMMDD');
  --EXECUTE IMMEDIATE 'TRUNCATE TABLE RRP_MDL.O_ICL_CMM_RETL_LOAN_CONT_INFO';
  ...
  INSERT INTO RRP_MDL.O_ICL_CMM_RETL_LOAN_CONT_INFO
    ...
    ,APLV_FLOW_NUM              --申请流水号  ADD BY YJY 20250905
    ,PROVI_FOR_AGED_PROPERTY_FLG--养老产业标识  ADD BY YJY 20251126
    )
  SELECT 
     ETL_DT                     --数据日期
    ,LP_ID                      --法人编号
...
END ETL_O_ICL_CMM_RETL_LOAN_CONT_INFO;
/
