CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_INIT_O_IOL_NCBS_RB_TRAN_CONTRA_REG(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_INIT_O_IOL_NCBS_RB_TRAN_CONTRA_REG
  *  功能描述：真实交易对手登记簿
  *  创建日期：20230115
  *  开发人员：MW
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_INIT_O_IOL_NCBS_RB_TRAN_CONTRA_REG'; -- 程序名称
...
EXECUTE IMMEDIATE 'TRUNCATE TABLE '|| V_TABLE_NAME;
  ...
  V_STEP_DESC := '-- 程序跑批开始 --';
  V_STARTTIME := SYSDATE;
  -- -- EXECUTE IMMEDIATE ' TRUNCATE TABLE  O_IOL_NCBS_RB_TRAN_CONTRA_REG ;
   -- EXECUTE IMMEDIATE ' TRUNCATE TABLE O_IOL_NCBS_RB_TRAN_CONTRA_REG';
...
;
  ...
  END ETL_INIT_O_IOL_NCBS_RB_TRAN_CONTRA_REG;
/
