CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_O_IOL_RCDS_SRC_DW_AGT_CMS_RISK_RAT(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_O_IOL_RCDS_SRC_DW_AGT_CMS_RISK_RAT
  *  功能描述：数仓_信贷风险评级
  *  创建日期：20220525
  *  开发人员：梅炜
  *  来源表：
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_O_IOL_RCDS_SRC_DW_AGT_CMS_RISK_RAT'; -- 程序名称
  ...
  V_STEP_DESC := '-- 程序跑批开始 --';
  V_STARTTIME := SYSDATE;
  DELETE FROM O_IOL_RCDS_SRC_DW_AGT_CMS_RISK_RAT T WHERE T.ETL_DT = TO_DATE(V_P_DATE,'YYYYMMDD');
  ...
  END ETL_O_IOL_RCDS_SRC_DW_AGT_CMS_RISK_RAT;
/
