CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_INIT_O_IOL_NIBS_IB_UPM_USERLOGIN_LOG(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_INIT_O_IOL_NIBS_IB_UPM_USERLOGIN_LOG
  *  功能描述：用户登录登出日志表
  *  创建日期：20220820
  *  开发人员：梅炜
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_INIT_O_IOL_NIBS_IB_UPM_USERLOGIN_LOG'; -- 程序名称
...
EXECUTE IMMEDIATE 'TRUNCATE TABLE '|| V_TABLE_NAME;
 ...
 V_SQLCOUNT := SQL%ROWCOUNT;
  ...
  END ETL_INIT_O_IOL_NIBS_IB_UPM_USERLOGIN_LOG;
/
