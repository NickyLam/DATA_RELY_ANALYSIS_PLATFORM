CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_INIT_O_IOL_TGLS_GLA_VCHR_H(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_INIT_O_IOL_TGLS_GLA_VCHR_H
  *  功能描述：传票信息历史表
  *  创建日期：20230115
  *  开发人员：MW
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_INIT_O_IOL_TGLS_GLA_VCHR_H'; -- 程序名称
...
;
  ...
  END ETL_INIT_O_IOL_TGLS_GLA_VCHR_H;
/
