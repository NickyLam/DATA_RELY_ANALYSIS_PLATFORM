CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_INIT_O_IOL_IBMS_VTRD_SET_INSTRUCTION_CASH(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_INIT_O_IOL_IBMS_VTRD_SET_INSTRUCTION_CASH
  *  功能描述：POS商户信息
  *  创建日期：20220525
  *  开发人员：梅炜
  *  来源表：
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_INIT_O_IOL_IBMS_VTRD_SET_INSTRUCTION_CASH'; -- 程序名称
...
EXECUTE IMMEDIATE 'TRUNCATE TABLE '|| V_TABLE_NAME;
 ...
 INSERT /*+APPEND*/ INTO RRP_MDL.O_IOL_IBMS_VTRD_SET_INSTRUCTION_CASH NOLOGGING
  ...
  END ETL_INIT_O_IOL_IBMS_VTRD_SET_INSTRUCTION_CASH;
/
