CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_INIT_O_IML_EVT_PPPS_PS_AGT_PAY_FLOW(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_INIT_O_IML_EVT_PPPS_PS_AGT_PAY_FLOW
  *  功能描述：PPPS协议支付流水
  *  创建日期：20230302
  *  开发人员：梅炜
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_INIT_O_IML_EVT_PPPS_PS_AGT_PAY_FLOW'; -- 程序名称
...
EXECUTE IMMEDIATE 'TRUNCATE TABLE '|| V_TABLE_NAME;
  ...
  V_STEP_DESC := '-- 程序跑批开始 --';
  V_STARTTIME := SYSDATE;
  -- -- EXECUTE IMMEDIATE ' TRUNCATE TABLE  O_IML_EVT_PPPS_PS_AGT_PAY_FLOW ;
   -- EXECUTE IMMEDIATE ' TRUNCATE TABLE O_IML_EVT_PPPS_PS_AGT_PAY_FLOW';
...
;
  ...
  END ETL_INIT_O_IML_EVT_PPPS_PS_AGT_PAY_FLOW;
/
