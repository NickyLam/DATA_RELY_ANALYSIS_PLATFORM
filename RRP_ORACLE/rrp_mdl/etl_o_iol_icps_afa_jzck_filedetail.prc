CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_O_IOL_ICPS_AFA_JZCK_FILEDETAIL(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_O_IOL_ICPS_AFA_JZCK_FILEDETAIL
  *  功能描述：文件明细表
  *  创建日期：20230302
  *  开发人员：梅炜
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_O_IOL_ICPS_AFA_JZCK_FILEDETAIL'; -- 程序名称
  ...
  V_STEP_DESC := '-- 程序跑批开始 --';
  V_STARTTIME := SYSDATE;
  DELETE FROM O_IOL_ICPS_AFA_JZCK_FILEDETAIL T WHERE T.ETL_DT = TO_DATE(V_P_DATE,'YYYYMMDD');
  ...
  END ETL_O_IOL_ICPS_AFA_JZCK_FILEDETAIL;
/
