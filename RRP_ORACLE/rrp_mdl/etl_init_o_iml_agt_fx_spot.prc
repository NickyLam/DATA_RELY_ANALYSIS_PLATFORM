CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_INIT_O_IML_AGT_FX_SPOT(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_INIT_O_IML_AGT_FX_SPOT
  *  功能描述：外汇即期交易
  *  创建日期：20220525
  *  开发人员：梅炜
  *  来源表：
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_INIT_O_IML_AGT_FX_SPOT'; -- 程序名称
...
EXECUTE IMMEDIATE 'TRUNCATE TABLE '|| V_TABLE_NAME;
  ...
  V_STEP_DESC := '-- 程序跑批开始 --';
  V_STARTTIME := SYSDATE;
   -- EXECUTE IMMEDIATE ' TRUNCATE TABLE  O_IML_AGT_FX_SPOT ;
  -- -- EXECUTE IMMEDIATE ' TRUNCATE TABLE O_IML_AGT_FX_SPOT';
  ...
  END ETL_INIT_O_IML_AGT_FX_SPOT;
/
