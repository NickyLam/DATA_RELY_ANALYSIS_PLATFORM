CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_DBMS_STATS(I_DATADATE       IN CHAR, --跑批日期
...
BEGIN
  ...
  ---记录正常日志
  V_ENDTIME := SYSDATE;
  ETL_YUSYS_LOG(V_P_DATE,V_SYSTEM,V_PROC_NAME,V_STARTTIME,V_ENDTIME,V_STEP,V_STEP_DESC,V_COUNT,O_ERRCODE,'');
