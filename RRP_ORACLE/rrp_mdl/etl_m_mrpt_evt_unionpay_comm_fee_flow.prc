CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_M_MRPT_EVT_UNIONPAY_COMM_FEE_FLOW(I_P_DATE IN INTEGER,
                                                                  O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_M_MRPT_EVT_UNIONPAY_COMM_FEE_FLOW
  *  功能描述：银联手续费流水
  *  创建日期：20221229
  *  开发人员：阳娟
  *  来源表： O_IML_EVT_UNIONPAY_COMM_FEE_FLOW
  *  目标表： M_MRPT_EVT_UNIONPAY_COMM_FEE_FLOW
  *  配置表：
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_M_MRPT_EVT_UNIONPAY_COMM_FEE_FLOW'; -- 程序名称 --XZY 新建一个的时候，批量替换成新的名字就行
...
BEGIN
  ...
  V_TAB_NAME := 'M_MRPT_EVT_UNIONPAY_COMM_FEE_FLOW'; --表名称
  ...
  END IF ;*/
  V_SQL :='TRUNCATE TABLE M_MRPT_EVT_UNIONPAY_COMM_FEE_FLOW';
  EXECUTE IMMEDIATE V_SQL;
  ...
  D_STARTTIME := SYSDATE;
  INSERT INTO RRP_MDL.M_MRPT_EVT_UNIONPAY_COMM_FEE_FLOW
  (
           DATA_DT
          ,EVT_ID  --事件编号
          ,LP_ID  --法人编号
  ...
  END ETL_M_MRPT_EVT_UNIONPAY_COMM_FEE_FLOW;
/
