CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_INIT_O_IOL_ICMS_MYHB_AC_SUMMARY_TRANS_02(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_INIT_O_IOL_ICMS_MYHB_AC_SUMMARY_TRANS_02
  *  功能描述：花呗汇总记账文件
  *  创建日期：20230114
  *  开发人员：MW
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_INIT_O_IOL_ICMS_MYHB_AC_SUMMARY_TRANS_02'; -- 程序名称
...
;
  ...
  END ETL_INIT_O_IOL_ICMS_MYHB_AC_SUMMARY_TRANS_02;
/
