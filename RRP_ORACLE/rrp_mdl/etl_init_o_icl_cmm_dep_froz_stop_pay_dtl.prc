CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_INIT_O_ICL_CMM_DEP_FROZ_STOP_PAY_DTL(I_P_DATE IN INTEGER,
                                                O_ERRCODE OUT VARCHAR2
                                                )
  /**************************************************************************
  *  程序名称：ETL_INIT_O_ICL_CMM_DEP_FROZ_STOP_PAY_DTL
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_INIT_O_ICL_CMM_DEP_FROZ_STOP_PAY_DTL'; -- 程序名称
...
EXECUTE IMMEDIATE 'TRUNCATE TABLE '|| V_TABLE_NAME;
  ...
  V_STEP_DESC := '-- 程序跑批开始 --';
  V_STARTTIME := SYSDATE;
  -- EXECUTE IMMEDIATE ' TRUNCATE TABLE O_ICL_CMM_DEP_FROZ_STOP_PAY_DTL';
  ...
  */
  ...
  END ETL_INIT_O_ICL_CMM_DEP_FROZ_STOP_PAY_DTL;
/
