CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_O_IOL_IBMS_TTRD_ACCOUNTING_SECU_OBJ_HIS(I_P_DATE IN INTEGER,O_ERRCODE OUT VARCHAR2)
  /**************************************************************************
  *  程序名称：ETL_O_IOL_IBMS_TTRD_ACCOUNTING_SECU_OBJ_HIS
  *  功能描述：中国债券信用评级表
  *  创建日期：20220820
  *  开发人员：梅炜
...
AS
  ...
  V_TAB_NAME  VARCHAR2(50) := 'O_IOL_IBMS_TTRD_ACCOUNTING_SECU_OBJ_HIS'; --表名
  V_PROC_NAME VARCHAR2(50) := 'ETL_O_IOL_IBMS_TTRD_ACCOUNTING_SECU_OBJ_HIS'; --程序名称
...
BEGIN
 ...
 --清理当天数据
  ...
  -- 如需要分析表，请用如下代码 --
  -- DBMS_STATS.GATHER_TABLE_STATS(OWNNAME=> 'RRP_MDL',TABLENAME => V_TAB_NAME,PARTNAME => 'P_'||V_P_DATE||'',DEGREE => 16,CASCATE => TRUE);
...
END ETL_O_IOL_IBMS_TTRD_ACCOUNTING_SECU_OBJ_HIS;
/
