CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_O_IOL_IBMS_TTRD_P_TYPE(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_O_IOL_IBMS_TTRD_P_TYPE
  *  功能描述：资产类型表
  *  创建日期：20220820
  *  开发人员：梅炜
  ...
  **************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_O_IOL_IBMS_TTRD_P_TYPE'; -- 程序名称
 ...
 -- 如需要分析表，请用如下代码 --
  ...
  END ETL_O_IOL_IBMS_TTRD_P_TYPE;
/
