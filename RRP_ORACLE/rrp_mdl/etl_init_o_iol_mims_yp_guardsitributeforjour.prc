CREATE OR REPLACE PROCEDURE RRP_MDL."ETL_INIT_O_IOL_MIMS_YP_GUARDSITRIBUTEFORJOUR" (I_P_DATE IN INTEGER, --跑批日期
                                                 O_ERRCODE  OUT VARCHAR2 --错误代码
                                                 )
 /*******************************************************************
  **存储过程详细说明： 按业务规则分配G13结果表
  **存储过程名称：    ETL_INIT_O_IOL_MIMS_YP_GUARDSITRIBUTEFORJOUR
  **存储过程创建日期：20221128
  **存储过程创建人：  HULIJUAN
  **输入参数：        I_P_DATE
  **输出参数：        O_ERRCODE
 ...
 AS
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_INIT_O_IOL_MIMS_YP_GUARDSITRIBUTEFORJOUR'; -- 程序名称
...
EXECUTE IMMEDIATE 'TRUNCATE TABLE '|| V_TABLE_NAME;
 ...
 INSERT /*+APPEND*/ INTO RRP_MDL.O_IOL_MIMS_YP_GUARDSITRIBUTEFORJOUR NOLOGGING
    (
      SCCODE  --押品编号
     ,CONTRACTNO  --合同号
     ,BALANCE  --合同余额
...
END ETL_INIT_O_IOL_MIMS_YP_GUARDSITRIBUTEFORJOUR;
/
