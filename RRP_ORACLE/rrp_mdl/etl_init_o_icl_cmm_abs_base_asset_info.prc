CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_INIT_O_ICL_CMM_ABS_BASE_ASSET_INFO(I_P_DATE IN INTEGER,
                                                O_ERRCODE OUT VARCHAR2
                                                )
  /**************************************************************************
  *  程序名称：ETL_INIT_O_ICL_CMM_ABS_BASE_ASSET_INFO
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_INIT_O_ICL_CMM_ABS_BASE_ASSET_INFO'; -- 程序名称
...
EXECUTE IMMEDIATE 'TRUNCATE TABLE '|| V_TABLE_NAME;
  ...
  V_STEP_DESC := '-- 程序跑批开始 --';
  V_STARTTIME := SYSDATE;
   -- EXECUTE IMMEDIATE ' TRUNCATE TABLE  O_ICL_CMM_ABS_BASE_ASSET_INFO ';
 ...
 /* V_STEP := V_STEP + 1;
  V_STEP_DESC := '分区处理';
  V_STARTTIME := SYSDATE;
  ETL_PARTITION_ADD(I_P_DATE, 'O_ICL_CMM_ABS_BASE_ASSET_INFO', '1', O_ERRCODE);
  V_SQLCOUNT := SQL%ROWCOUNT;
 ...
 -- 如需要分析表，请用如下代码 --
  ...
  END ETL_INIT_O_ICL_CMM_ABS_BASE_ASSET_INFO;
/
