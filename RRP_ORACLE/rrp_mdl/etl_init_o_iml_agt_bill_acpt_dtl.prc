CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_INIT_O_IML_AGT_BILL_ACPT_DTL(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_INIT_O_IML_AGT_BILL_ACPT_DTL
  *  功能描述：票据承兑明细
  *  创建日期：20230302
  *  开发人员：梅炜
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_INIT_O_IML_AGT_BILL_ACPT_DTL'; -- 程序名称
...
EXECUTE IMMEDIATE 'TRUNCATE TABLE '|| V_TABLE_NAME;
  ...
  V_STEP_DESC := '-- 程序跑批开始 --';
  V_STARTTIME := SYSDATE;
  -- -- EXECUTE IMMEDIATE ' TRUNCATE TABLE  O_IML_AGT_BILL_ACPT_DTL ;
   -- EXECUTE IMMEDIATE ' TRUNCATE TABLE O_IML_AGT_BILL_ACPT_DTL';
...
;
  ...
  END ETL_INIT_O_IML_AGT_BILL_ACPT_DTL;
/
