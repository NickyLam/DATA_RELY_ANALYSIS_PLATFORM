CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_O_IOL_WIND_CBONDISSUER(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_O_IOL_WIND_CBONDISSUER
  *  功能描述：中国债券主体表
  *  创建日期：20220820
  *  开发人员：梅炜
  ...
  **************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_O_IOL_WIND_CBONDISSUER'; -- 程序名称
  ...
  V_STEP_DESC := '-- 程序跑批开始 --';
  V_STARTTIME := SYSDATE;
  EXECUTE IMMEDIATE 'TRUNCATE TABLE RRP_MDL.O_IOL_WIND_CBONDISSUER';
  ...
  END ETL_O_IOL_WIND_CBONDISSUER;
/
