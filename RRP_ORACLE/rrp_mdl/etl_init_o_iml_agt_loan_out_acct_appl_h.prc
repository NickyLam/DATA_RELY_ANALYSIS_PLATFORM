CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_INIT_O_IML_AGT_LOAN_OUT_ACCT_APPL_H(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_INIT_O_IML_AGT_LOAN_OUT_ACCT_APPL_H
  *  功能描述：贷款出账申请历史
  *  创建日期：20220525
  *  开发人员：梅炜
  *  来源表：
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(500) := 'ETL_INIT_O_IML_AGT_LOAN_OUT_ACCT_APPL_H'; -- 程序名称
...
EXECUTE IMMEDIATE 'TRUNCATE TABLE '|| V_TABLE_NAME;
  ...
  V_STEP_DESC := '-- 程序跑批开始 --';
  V_STARTTIME := SYSDATE;
   -- EXECUTE IMMEDIATE ' TRUNCATE TABLE O_IML_AGT_LOAN_OUT_ACCT_APPL_H';
  ...
  (				AGT_ID  --申请编号
    ...
    SELECT
				...
				,JOB_CD  --任务编码
				,ETL_TIMESTAMP  --ETL处理时间戳
    FROM IML.V_AGT_LOAN_OUT_ACCT_APPL_H --视图-贷款出账申请历史(拉链表，全表抽取)
     ;
  ...
  END ETL_INIT_O_IML_AGT_LOAN_OUT_ACCT_APPL_H;
/
