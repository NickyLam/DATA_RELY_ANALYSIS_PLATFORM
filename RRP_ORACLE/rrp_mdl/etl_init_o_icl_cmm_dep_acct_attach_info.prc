CREATE OR REPLACE PROCEDURE RRP_MDL."ETL_INIT_O_ICL_CMM_DEP_ACCT_ATTACH_INFO" (I_P_DATE IN INTEGER, --跑批日期
                                                 O_ERRCODE  OUT VARCHAR2 --错误代码
                                                 )
 /*******************************************************************
  **存储过程详细说明： 存款账户附加信息
  **存储过程名称：    ETL_INIT_O_ICL_CMM_DEP_ACCT_ATTACH_INFO
  **存储过程创建日期：20221128
  **存储过程创建人：  HULIJUAN
  **输入参数：        I_P_DATE
  **输出参数：        O_ERRCODE
 ...
 AS
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_INIT_O_ICL_CMM_DEP_ACCT_ATTACH_INFO'; -- 程序名称
 ...
 INSERT /*+APPEND*/ INTO RRP_MDL.O_ICL_CMM_DEP_ACCT_ATTACH_INFO NOLOGGING
  ...
  SELECT /*+PARALLEL*/
     ETL_DT
      ...
      ,JOB_CD
      ,ETL_TIMESTAMP
    FROM ICL.V_CMM_DEP_ACCT_ATTACH_INFO   --存款账户附加信息_视图
...
END ETL_INIT_O_ICL_CMM_DEP_ACCT_ATTACH_INFO;
/
