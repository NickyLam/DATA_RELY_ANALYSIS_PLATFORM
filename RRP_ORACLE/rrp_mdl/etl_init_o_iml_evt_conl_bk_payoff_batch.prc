CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_INIT_O_IML_EVT_CONL_BK_PAYOFF_BATCH(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_INIT_O_IML_EVT_CONL_BK_PAYOFF_BATCH
  *  功能描述：企业网银代发批次
  *  创建日期：20221227
  *  开发人员：梅炜
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_INIT_O_IML_EVT_CONL_BK_PAYOFF_BATCH'; -- 程序名称
...
EXECUTE IMMEDIATE 'TRUNCATE TABLE '|| V_TABLE_NAME;
  ...
  V_STEP_DESC := '-- 程序跑批开始 --';
  V_STARTTIME := SYSDATE;
  -- -- EXECUTE IMMEDIATE ' TRUNCATE TABLE  O_IML_EVT_CONL_BK_PAYOFF_BATCH ;
   -- EXECUTE IMMEDIATE ' TRUNCATE TABLE O_IML_EVT_CONL_BK_PAYOFF_BATCH';
...
;
  ...
  END ETL_INIT_O_IML_EVT_CONL_BK_PAYOFF_BATCH;
/
