CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_INIT_O_IOL_ICMS_MYHB_IQP_LOAN_APP(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_INIT_O_IOL_ICMS_MYHB_IQP_LOAN_APP
  *  功能描述：花呗申请信息
  *  创建日期：20230216
  *  开发人员：梅炜
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_INIT_O_IOL_ICMS_MYHB_IQP_LOAN_APP'; -- 程序名称
...
;
 ...
 V_SQLCOUNT := SQL%ROWCOUNT;
  ...
  END ETL_INIT_O_IOL_ICMS_MYHB_IQP_LOAN_APP;
/
