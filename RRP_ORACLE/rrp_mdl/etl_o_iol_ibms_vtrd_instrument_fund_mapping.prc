CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_O_IOL_IBMS_VTRD_INSTRUMENT_FUND_MAPPING(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_O_IOL_IBMS_VTRD_INSTRUMENT_FUND_MAPPING
  *  功能描述：金融工具关联标准产品码
  *  创建日期：20220525
  *  开发人员：梅炜
  *  来源表：
  *  目标表： O_IOL_IBMS_VTRD_INSTRUMENT_FUND_MAPPING
  *  配置表：
  ...
  **************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_O_IOL_IBMS_VTRD_INSTRUMENT_FUND_MAPPING'; -- 程序名称
  ...
  V_STEP_DESC := '-- 程序跑批开始 --';
  V_STARTTIME := SYSDATE;
  EXECUTE IMMEDIATE 'TRUNCATE TABLE RRP_MDL.O_IOL_IBMS_VTRD_INSTRUMENT_FUND_MAPPING';
  ...
  V_STEP_DESC := '数据落地-金融工具关联标准产品码';
  V_STARTTIME := SYSDATE;
  INSERT /*+APPEND*/ INTO RRP_MDL.O_IOL_IBMS_VTRD_INSTRUMENT_FUND_MAPPING NOLOGGING
  ( PROD_CODE             --标准产品码
    ,I_CODE               --金融工具代码
    ,A_TYPE               --资产类型
    ,M_TYPE               --市场类型
  ...
  SELECT /*+PARALLEL*/
    ...
    ,END_DT               --结束时间
    ,ID_MARK              --增删标志
    FROM IOL.V_IBMS_VTRD_INSTRUMENT_FUND_MAPPING   --金融工具关联标准产品码视图_视图
  ...
  END ETL_O_IOL_IBMS_VTRD_INSTRUMENT_FUND_MAPPING;
/
