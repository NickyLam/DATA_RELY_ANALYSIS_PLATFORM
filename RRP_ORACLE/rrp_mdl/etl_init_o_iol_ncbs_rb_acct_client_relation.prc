CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_INIT_O_IOL_NCBS_RB_ACCT_CLIENT_RELATION(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_INIT_O_IOL_NCBS_RB_ACCT_CLIENT_RELATION
  *  功能描述：账户客户关系表
  *  创建日期：20220619
  *  开发人员：梅炜
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_INIT_O_IOL_NCBS_RB_ACCT_CLIENT_RELATION'; -- 程序名称
...
;
  ...
  END ETL_INIT_O_IOL_NCBS_RB_ACCT_CLIENT_RELATION;
/
