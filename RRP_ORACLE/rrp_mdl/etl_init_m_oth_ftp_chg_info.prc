CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_INIT_M_OTH_FTP_CHG_INFO(I_P_DATE IN INTEGER,O_ERRCODE OUT VARCHAR2)
  /**************************************************************************
  *  程序名称：ETL_INIT_M_OTH_FTP_CHG_INFO
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(200) := 'ETL_INIT_M_OTH_FTP_CHG_INFO'; -- 程序名称
  ...
  V_TAB_NAME := 'M_OTH_FTP_CHG_INFO'; --表名
  ...
  INSERT INTO M_OTH_FTP_CHG_INFO
  (
   DATA_DT      --数据日期
  ,LGL_REP_ID   --法人编号
  ,ORG_ID       --机构编号
  ...
  FROM O_IOL_FTPS_RPT_RST_FTP261_INFO A  --FTP账户明细结果集
  ...
  END ETL_INIT_M_OTH_FTP_CHG_INFO;
/
