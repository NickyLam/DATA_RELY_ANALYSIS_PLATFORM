CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_INIT_O_IOL_IBMS_TTRD_ACC_SECU(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_INIT_O_IOL_IBMS_TTRD_ACC_SECU
  *  功能描述：中国债券信用评级表
  *  创建日期：20220820
  *  开发人员：梅炜
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_INIT_O_IOL_IBMS_TTRD_ACC_SECU'; -- 程序名称
...
;
 ...
 V_SQLCOUNT := SQL%ROWCOUNT;
  ...
  END ETL_INIT_O_IOL_IBMS_TTRD_ACC_SECU;
/
