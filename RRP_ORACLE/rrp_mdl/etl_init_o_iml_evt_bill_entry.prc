CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_INIT_O_IML_EVT_BILL_ENTRY(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_INIT_O_IML_EVT_BILL_ENTRY
  *  功能描述：票据记账事件
  *  创建日期：20230114
  *  开发人员：MW
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_INIT_O_IML_EVT_BILL_ENTRY'; -- 程序名称
...
EXECUTE IMMEDIATE 'TRUNCATE TABLE '|| V_TABLE_NAME;
  ...
  V_STEP_DESC := '-- 程序跑批开始 --';
  V_STARTTIME := SYSDATE;
  -- -- EXECUTE IMMEDIATE ' TRUNCATE TABLE  O_IML_EVT_BILL_ENTRY ;
   -- EXECUTE IMMEDIATE ' TRUNCATE TABLE O_IML_EVT_BILL_ENTRY';
...
;
  ...
  END ETL_INIT_O_IML_EVT_BILL_ENTRY;
/
