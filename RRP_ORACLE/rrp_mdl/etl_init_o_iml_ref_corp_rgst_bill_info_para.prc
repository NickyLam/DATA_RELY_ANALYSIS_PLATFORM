CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_INIT_O_IML_REF_CORP_RGST_BILL_INFO_PARA(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_INIT_O_IML_REF_CORP_RGST_BILL_INFO_PARA
  *  功能描述：企业登记中心票据信息参数
  *  创建日期：20230215
  *  开发人员：MW
  *  来源表：
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_INIT_O_IML_REF_CORP_RGST_BILL_INFO_PARA'; -- 程序名称
...
EXECUTE IMMEDIATE 'TRUNCATE TABLE '|| V_TABLE_NAME;
  ...
  V_STEP_DESC := '-- 程序跑批开始 --';
  V_STARTTIME := SYSDATE;
  -- -- EXECUTE IMMEDIATE ' TRUNCATE TABLE  O_IML_REF_CORP_RGST_BILL_INFO_PARA ;
   -- EXECUTE IMMEDIATE ' TRUNCATE TABLE O_IML_REF_CORP_RGST_BILL_INFO_PARA';
  ...
  END ETL_INIT_O_IML_REF_CORP_RGST_BILL_INFO_PARA;
/
