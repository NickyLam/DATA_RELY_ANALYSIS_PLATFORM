CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_O_IOL_ICMS_MYHB_AC_SUMMARY_TRANS_01(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_O_IOL_ICMS_MYHB_AC_SUMMARY_TRANS_01
  *  功能描述：花呗汇总记账文件
  *  创建日期：20230114
  *  开发人员：MW
  *  来源表： IOL.V_ICMS_MYHB_AC_SUMMARY_TRANS_01
  *  目标表： O_IOL_ICMS_MYHB_AC_SUMMARY_TRANS_01
  *  配置表：
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_O_IOL_ICMS_MYHB_AC_SUMMARY_TRANS_01'; -- 程序名称
  ...
  V_STEP_DESC := '-- 程序跑批开始 --';
  V_STARTTIME := SYSDATE;
  --DELETE FROM O_IOL_ICMS_MYHB_AC_SUMMARY_TRANS_01 T WHERE T.ETL_DT = TO_DATE(V_P_DATE,'YYYYMMDD');
  EXECUTE IMMEDIATE 'TRUNCATE TABLE O_IOL_ICMS_MYHB_AC_SUMMARY_TRANS_01';
  ...
  V_STARTTIME := SYSDATE;
  INSERT INTO RRP_MDL.O_IOL_ICMS_MYHB_AC_SUMMARY_TRANS_01
  (
							SETTLEDATE  --业务日期
							,REGIONCODE  --行政区划代码
    ...
    SELECT
              ...
              ,ETL_DT  --ETL处理日期
              ,ETL_TIMESTAMP  --ETL处理时间戳
    FROM IOL.V_ICMS_MYHB_AC_SUMMARY_TRANS_01  --视图-花呗汇总记账文件
...
;
  ...
  END ETL_O_IOL_ICMS_MYHB_AC_SUMMARY_TRANS_01;
/
