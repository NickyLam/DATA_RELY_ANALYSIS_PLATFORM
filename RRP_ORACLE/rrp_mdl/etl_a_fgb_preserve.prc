CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_A_FGB_PRESERVE
(I_P_DATE IN INTEGER,
 O_ERRCODE OUT VARCHAR2
)
  /**************************************************************************
  *  程序名称：ETL_A_FGB_PRESERVE
  *  功能描述：风管部特殊资产处置台账
  *  创建日期：20221107
  *  开发人员：孙满洋
  *  来源表：
  *  目标表：A_FGB_PRESERVE --特殊资产处置台账
  *  配置表：CODE_MAP
  *  修改情况：
     序号  修改日期   修改人     修改原因
  *   1    20230105   smy        首次创建
  *   2    20230523   liuyu      根据测试数据调整过滤条件
  ***************************************************************************/
  AS
  -- 定义变量 --
  V_STEP       INTEGER := 0;     -- 处理步骤
  V_PROC_NAME  VARCHAR2(30) := 'ETL_A_FGB_PRESERVE';
                                 -- 程序名称
  ...
  V_TAB_NAME   := 'A_FGB_PRESERVE'; --表名,写目标表表名
