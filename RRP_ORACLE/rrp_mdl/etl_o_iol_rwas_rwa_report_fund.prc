CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_O_IOL_RWAS_RWA_REPORT_FUND(I_P_DATE IN INTEGER,
                              O_ERRCODE OUT VARCHAR2
                               )
  /**************************************************************************
  *  程序名称：ETL_O_IOL_RWAS_RWA_REPORT_FUND
  *  功能描述：POS商户信息
  *  创建日期：20220525
  *  开发人员：梅炜
  *  来源表：
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_O_IOL_RWAS_RWA_REPORT_FUND'; -- 程序名称
  ...
  END ETL_O_IOL_RWAS_RWA_REPORT_FUND;
/
