CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_O_IOL_WIND_CBONDDESCRIPTION (I_P_DATE IN INTEGER, --跑批日期
                                                 O_ERRCODE  OUT VARCHAR2 --错误代码
                                                 )
 /*******************************************************************
  **存储过程详细说明： 中国债券基本资料
  **存储过程名称：    ETL_O_IOL_WIND_CBONDDESCRIPTION
  **存储过程创建日期：20221129
  **存储过程创建人：  HULIJUAN
  **输入参数：        I_P_DATE
  **输出参数：        O_ERRCODE
 ...
 AS
  ...
  V_PROC_NAME VARCHAR2(50) := 'ETL_O_IOL_WIND_CBONDDESCRIPTION'; -- 程序名称
  ...
  SELECT /*+PARALLEL*/
     ...
     ,ID_MARK                    --增删标志
     ,ETL_TIMESTAMP
    FROM IOL.V_WIND_CBONDDESCRIPTION   --视图-中国债券基本资料
   WHERE ID_MARK <> 'D';
...
END ETL_O_IOL_WIND_CBONDDESCRIPTION;
/
