CREATE OR REPLACE PROCEDURE RRP_MDL.ETL_INIT_M_GUA_REL_GUAR(I_P_DATE IN INTEGER,
                                                O_ERRCODE OUT VARCHAR2
                                                )
  /**************************************************************************
  *  程序名称：ETL_INIT_M_GUA_REL_GUAR
  *  功能描述：保函与信用证信息表
  *  创建日期：20220525
  *  开发人员：梅炜
  *  来源表：
  ...
  ***************************************************************************/
  ...
  V_PROC_NAME VARCHAR2(200) := 'ETL_INIT_M_GUA_REL_GUAR'; -- 程序名称
 ...
 WHERE A.GUAR_CONT_ID IS NOT NULL
   AND NVL(A.GUARTOR_ID,' ') <> ' '
   AND A.CUST_ID <> A.GUARTOR_ID --剔除无效数据
