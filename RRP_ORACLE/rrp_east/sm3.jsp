create or replace and compile java source named RRP_EAST.sm3 as
...
public class SM3 {
    ...
    public static  String Encode(String str)  {
      ...
      if (str != null/* & str.length()> 0*/) {
          text= SM3.byteArrayToHexString(SM3.hash(str.getBytes("UTF-8"))).toLowerCase();
      }
        } catch (IOException e) {
