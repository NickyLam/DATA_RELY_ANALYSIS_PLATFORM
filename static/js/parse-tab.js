...
(function() {
    ...
    // Expose public interfaces (referenced from HTML onclick/ondragover/etc.)
    ...
    window.triggerFullParse = triggerFullParse;
    window.showParsedList = showParsedList;
