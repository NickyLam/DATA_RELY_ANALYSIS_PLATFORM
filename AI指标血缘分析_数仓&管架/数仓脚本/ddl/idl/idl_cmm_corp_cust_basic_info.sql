...
comment on column ${idl_schema}.cmm_corp_cust_basic_info.open_acct_dt is '客户开户日期';
...
comment on column ${idl_schema}.cmm_corp_cust_basic_info.create_chn_cd is '创建渠道编号';
...
comment on column ${idl_schema}.cmm_corp_cust_basic_info.group_type_cd is '集团类型代码';
comment on column ${idl_schema}.cmm_corp_cust_basic_info.green_bond_proj_flg is '绿色债券项目标志';
comment on column ${idl_schema}.cmm_corp_cust_basic_info.dep_class_cust_flg is '存款类客户标志';
comment on column ${idl_schema}.cmm_corp_cust_basic_info.loan_class_cust_flg is '贷款类客户标志';
comment on column ${idl_schema}.cmm_corp_cust_basic_info.guar_class_cust_flg is '担保类客户标志';
comment on column ${idl_schema}.cmm_corp_cust_basic_info.anti_mon_lau_belong_org_id is '反洗钱归属机构编号';
