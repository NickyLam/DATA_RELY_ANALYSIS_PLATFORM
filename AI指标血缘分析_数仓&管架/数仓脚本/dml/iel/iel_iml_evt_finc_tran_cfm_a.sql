...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_finc_tran_cfm_a
CreateDate: 20180529
...
' \
    ...
    ,t.tot_cost as tot_cost
    ,replace(replace(t.init_cfm_flow_num,chr(13),''),chr(10),'') as init_cfm_flow_num
from iml.evt_finc_tran_cfm t 
where t.cfm_dt >= to_date('20190101','yyyymmdd') and t.cfm_dt <= to_date('20210513','yyyymmdd')" \
