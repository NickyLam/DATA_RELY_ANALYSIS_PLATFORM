...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iof_cqss_e_r_messageheader_a
CreateDate: 20250714
FileName:   ${iel_data_path}/cqss_e_r_messageheader.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
from iol.cqss_e_r_messageheader t
  where to_char(t.crt_dt_tm,'yyyymmdd')<='${batch_date}' " \
        ...
        file="${iel_data_path}/cqss_e_r_messageheader.a.${batch_date}.dat" \
        charset=utf8
        safe=yes
