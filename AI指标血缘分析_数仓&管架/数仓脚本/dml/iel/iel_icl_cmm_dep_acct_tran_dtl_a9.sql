...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_icl_cmm_dep_acct_tran_dtl_a9
CreateDate: 20230822
...
' \
        query="select
to_char(etl_dt,'yyyymmdd') as etl_dt
...
where etl_dt <= to_date('${batch_date}','yyyymmdd') and etl_dt >= add_months(TRUNC(to_date('${batch_date}','YYYYmmdd'),'mm'),-3) and t1.entry_flg='1';" \
