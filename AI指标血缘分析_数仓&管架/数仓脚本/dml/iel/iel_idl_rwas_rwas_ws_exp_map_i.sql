...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_rwas_rwas_ws_exp_map_i
CreateDate: 20240326
FileName:   ${iel_data_path}/rwas_rwas_ws_exp_map.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
,t1.accountrefcd as accountrefcd
,t1.crmrefcd as crmrefcd
,t1.obligorname as obligorname
...
,t1.industrygroupid as industrygroupid
,t1.corp_size_cd as corp_size_cd
,t1.grade_model_cd as grade_model_cd
,t1.remmaturity_bandid as remmaturity_bandid
,t1.loan_ref_no as loan_ref_no
,t1.five_class_cd as five_class_cd

from ${idl_schema}.rwas_rwas_ws_exp_map t1
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/rwas_rwas_ws_exp_map.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
