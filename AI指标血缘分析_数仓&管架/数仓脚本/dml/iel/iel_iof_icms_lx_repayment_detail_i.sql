...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iof_icms_lx_repayment_detail_i
CreateDate: 20250804
FileName:   ${iel_data_path}/icms_lx_repayment_detail.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/icms_lx_repayment_detail.i.${batch_date}.dat" \
        charset=utf8
        safe=yes
