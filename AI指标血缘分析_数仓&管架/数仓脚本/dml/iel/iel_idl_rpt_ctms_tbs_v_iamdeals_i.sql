...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_rpt_ctms_tbs_v_iamdeals_i
CreateDate: 20180529
FileName:   ${iel_data_path}/rpt_ctms_tbs_v_iamdeals.i.${batch_date}.dat
IF_mark:    i
Logs:
