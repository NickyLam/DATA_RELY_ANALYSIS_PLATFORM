...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_dc_cap_asset_bal_chg_dtl_a
CreateDate: 20180529
FileName:   ${iel_data_path}/evt_dc_cap_asset_bal_chg_dtl.a.${batch_date}.dat
IF_mark:    a
Logs:
...
where t1.etl_dt <= to_date('20230430','yyyymmdd') and t1.etl_dt >= to_date('20230101','yyyymmdd')" \
        ...
        file="${iel_data_path}/evt_dc_cap_asset_bal_chg_dtl.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes