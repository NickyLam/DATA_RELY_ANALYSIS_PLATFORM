...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_agt_we_dep_acct_ip_check_dtl_f
CreateDate: 20220512
FileName:   ${iel_data_path}/agt_we_dep_acct_ip_check_dtl.f.${batch_date}.dat
IF_mark:    f
Logs:
   sundexin
' \
...
where 1=1 " \
        ...
        file="${iel_data_path}/agt_we_dep_acct_ip_check_dtl.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes