...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_icl_cmm_abmt_remit_dtl_a
CreateDate: 20231117
FileName:   ${iel_data_path}/cmm_abmt_remit_dtl.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where etl_dt <= to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/cmm_abmt_remit_dtl.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
