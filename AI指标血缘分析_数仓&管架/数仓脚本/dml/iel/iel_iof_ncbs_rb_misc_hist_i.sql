...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iof_ncbs_rb_misc_hist_i
CreateDate: 20250514
FileName:   ${iel_data_path}/ncbs_rb_misc_hist.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/ncbs_rb_misc_hist.i.${batch_date}.dat" \
        charset=utf8
        safe=yes
