...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iof_ifrs_fct_ecl_res_dtl_a2
CreateDate: 20250321
FileName:   ${iel_data_path}/ifrs_fct_ecl_res_dtl.a.${batch_date}.dat
IF_mark:    a
Logs:
...
" \
        ...
        file="${iel_data_path}/ifrs_fct_ecl_res_dtl.a.${batch_date}.dat" \
        charset=utf8
        safe=yes