...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_hdws_cml_c_sub_coa_mild_sum_f
CreateDate: 20180529
FileName:   ${iel_data_path}/hdws_cml_c_sub_coa_mild_sum.f.${batch_date}.dat
IF_mark:    f
Logs:
...
where etl_dt = to_date('${batch_date}','yyyymmdd');" \
        ...
        file="${iel_data_path}/hdws_cml_c_sub_coa_mild_sum.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes