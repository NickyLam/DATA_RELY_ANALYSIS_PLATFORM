...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_wind_hxyhinsideholder_a1
CreateDate: 20221110
FileName:   ${iel_data_path}/wind_hxyhinsideholder.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where 1=1 ;" \
        ...
        file="${iel_data_path}/wind_hxyhinsideholder.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
