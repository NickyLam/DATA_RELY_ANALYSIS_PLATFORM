...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_finc_redem_cost_info_h_a
CreateDate: 20180529
FileName:   ${iel_data_path}/evt_finc_redem_cost_info_h.a.${batch_date}.dat
IF_mark:    a
Logs:
...
where 1=1 " \
        ...
        file="${iel_data_path}/evt_finc_redem_cost_info_h.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes