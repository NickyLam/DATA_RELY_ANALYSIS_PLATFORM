...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_rsts_src_dw_agt_cms_risk_rat_f
CreateDate: 20241012
FileName:   ${iel_data_path}/rsts_src_dw_agt_cms_risk_rat.f.${batch_date}.dat
IF_mark:    f
Logs:
' \
        query="select
