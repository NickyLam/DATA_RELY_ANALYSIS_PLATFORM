...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_cabs_bussiness_info_statistics_i
CreateDate: 20180529
FileName:   ${iel_data_path}/cabs_bussiness_info_statistics.i.${batch_date}.dat
IF_mark:    i
Logs:
...
' \
      ...
      ,end_dt
      ,id_mark
  from ${iol_schema}.cabs_bussiness_info_statistics t1 where start_dt = to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/cabs_bussiness_info_statistics.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes