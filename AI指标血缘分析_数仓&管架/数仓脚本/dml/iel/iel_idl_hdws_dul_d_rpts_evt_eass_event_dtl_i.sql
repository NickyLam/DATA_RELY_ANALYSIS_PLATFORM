...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_hdws_dul_d_rpts_evt_eass_event_dtl_i
CreateDate: 20180529
FileName:   ${iel_data_path}/hdws_dul_d_rpts_evt_eass_event_dtl.i.${batch_date}.dat
IF_mark:    i
Logs:
...
where to_date(${batch_date},'yyyymmdd') = etl_dt;" \
        ...
        file="${iel_data_path}/hdws_dul_d_rpts_evt_eass_event_dtl.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes