...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iof_pbms_tbl_bonus_plan_detail_expire_f
CreateDate: 20251014
FileName:   ${iel_data_path}/pbms_tbl_bonus_plan_detail_expire.f.${batch_date}.dat
IF_mark:    f
Logs:
' \
        query="select
...
from ${iol_schema}.pbms_tbl_bonus_plan_detail_expire t1
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/pbms_tbl_bonus_plan_detail_expire.f.${batch_date}.dat" \
        charset=utf8
        safe=yes
