...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_aml_ref_bill_info_para_i
CreateDate: 20180529
FileName:   ${iel_data_path}/aml_ref_bill_info_para.i.${batch_date}.dat
IF_mark:    i
Logs:
...
,payoff_flg from idl.aml_ref_bill_info_para where etl_dt =to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/aml_ref_bill_info_para.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes