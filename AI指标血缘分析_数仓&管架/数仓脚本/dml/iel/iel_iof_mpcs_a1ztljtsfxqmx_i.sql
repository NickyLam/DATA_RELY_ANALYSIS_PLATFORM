...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iof_mpcs_a1ztljtsfxqmx_i
CreateDate: 20251010
FileName:   ${iel_data_path}/mpcs_a1ztljtsfxqmx.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/mpcs_a1ztljtsfxqmx.i.${batch_date}.dat" \
        charset=utf8
        safe=yes
