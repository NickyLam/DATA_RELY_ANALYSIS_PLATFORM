...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idf_crps_agt_cust_chn_lmt_info_h_f
CreateDate: 20241022
FileName:   ${iel_data_path}/crps_agt_cust_chn_lmt_info_h.f.${batch_date}.dat
IF_mark:    f
Logs:
' \
        query="select
...
from  iml.agt_cust_chn_lmt_info_h t1 where 1 = 1;" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/crps_agt_cust_chn_lmt_info_h.f.${batch_date}.dat" \
        charset=utf8
        safe=yes
