...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_rcrs_intercept_rule_i
CreateDate: 20180529
FileName:   ${iel_data_path}/rcrs_intercept_rule.i.${batch_date}.dat
IF_mark:    i
Logs:
...
where start_dt = to_date('${batch_date}','yyyymmdd');" \
        ...
        file="${iel_data_path}/rcrs_intercept_rule.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes