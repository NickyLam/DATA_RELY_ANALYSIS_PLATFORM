...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_icl_cmm_retl_loan_dubil_info_a
CreateDate: 20180529
FileName:   ${iel_data_path}/cmm_retl_loan_dubil_info.a.${batch_date}.dat
IF_mark:    f
Logs:
...
' \
    ...
    ,t.last_level5_cls_modif_dt as last_level5_cls_modif_dt
...
from icl.cmm_retl_loan_dubil_info t
where t.etl_dt <= to_date('${batch_date}','yyyymmdd')
and t.etl_dt >= to_date('20210901','yyyymmdd') " \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/cmm_retl_loan_dubil_info.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes