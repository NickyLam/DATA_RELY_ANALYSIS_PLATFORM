...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_icl_cmm_conl_bk_sign_info_a
CreateDate: 20180529
FileName:   ${iel_data_path}/cmm_conl_bk_sign_info.a.${batch_date}.dat
IF_mark:    a
Logs:
...
where etl_dt <= to_date('20230430', 'yyyymmdd') and etl_dt >= to_date('20220831', 'yyyymmdd') and etl_dt = last_day(etl_dt);" \
        ...
        file="${iel_data_path}/cmm_conl_bk_sign_info.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes