...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_icms_business_approve_f
CreateDate: 20180529
...
,replace(replace(t1.contractflag,chr(13),''),chr(10),'') as contractflag
...
,replace(replace(t1.finalapproveopinion,chr(13),''),chr(10),'') as finalapproveopinion
...
,replace(replace(t1.operatedate,chr(13),''),chr(10),'') as operatedate
...
,replace(replace(t1.reinforceflag,chr(13),''),chr(10),'') as reinforceflag
...
,replace(replace(t1.checkyearstatus,chr(13),''),chr(10),'') as checkyearstatus
...
from ${iol_schema}.icms_business_approve t1
