...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_distr_finc_tran_cfm_dtl_i
CreateDate: 20180529
FileName:   ${iel_data_path}/evt_distr_finc_tran_cfm_dtl.i.${batch_date}.dat
IF_mark:    i
Logs:
...
from ${iml_schema}.evt_distr_finc_tran_cfm_dtl t1 
where etl_dt = to_date('${batch_date}','yyyymmdd');" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/evt_distr_finc_tran_cfm_dtl.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes