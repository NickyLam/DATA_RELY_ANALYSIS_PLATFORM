...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_wind_financialbalancesheetdetails_i
CreateDate: 20180529
FileName:   ${iel_data_path}/wind_financialbalancesheetdetails.i.${batch_date}.dat
IF_mark:    i
Logs:
...
from ${iol_schema}.wind_financialbalancesheetdetails t1 
where etl_dt = to_date('${batch_date}','yyyymmdd');" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/wind_financialbalancesheetdetails.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes