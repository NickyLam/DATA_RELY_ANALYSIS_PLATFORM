...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_os_invest_finc_bus_flow_i
CreateDate: 20180529
FileName:   ${iel_data_path}/evt_os_invest_finc_bus_flow.i.${batch_date}.dat
IF_mark:    i
Logs:
...
where t.etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/evt_os_invest_finc_bus_flow.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes