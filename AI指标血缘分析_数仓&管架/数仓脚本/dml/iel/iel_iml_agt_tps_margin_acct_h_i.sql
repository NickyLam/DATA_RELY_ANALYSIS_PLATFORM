...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_agt_tps_margin_acct_h_i
CreateDate: 20180529
FileName:   ${iel_data_path}/agt_tps_margin_acct_h.i.${batch_date}.dat
IF_mark:    i
Logs:
...
where start_dt <= to_date('${batch_date}','yyyymmdd') and end_dt > to_date('${batch_date}','yyyymmdd') and t.rgst_dt = to_date('${batch_date}','yyyymmdd')-1; " \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/agt_tps_margin_acct_h.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes