...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_imf_evt_loan_acct_info_modif_oper_dtl_a
CreateDate: 20241022
FileName:   ${iel_data_path}/evt_loan_acct_info_modif_oper_dtl.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where etl_dt <= to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/evt_loan_acct_info_modif_oper_dtl.a.${batch_date}.dat" \
        charset=utf8
        safe=yes
