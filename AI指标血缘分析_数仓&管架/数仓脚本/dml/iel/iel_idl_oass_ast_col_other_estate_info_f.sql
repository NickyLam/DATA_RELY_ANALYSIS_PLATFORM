...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_oass_ast_col_other_estate_info_f
CreateDate: 20230116
FileName:   ${iel_data_path}/oass_ast_col_other_estate_info.f.${batch_date}.dat
IF_mark:    f
Logs:
' \
        query="select
to_date('${batch_date}','yyyymmdd') as etl_dt
,t1.ready_house_flg as ready_house_flg
...
from ${idl_schema}.oass_ast_col_other_estate_info t1
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/oass_ast_col_other_estate_info.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
