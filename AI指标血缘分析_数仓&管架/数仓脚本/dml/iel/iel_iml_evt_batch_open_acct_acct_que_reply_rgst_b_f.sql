...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_batch_open_acct_acct_que_reply_rgst_b_f
CreateDate: 20221229
FileName:   ${iel_data_path}/evt_batch_open_acct_acct_que_reply_rgst_b.f.${batch_date}.dat
IF_mark:    f
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/evt_batch_open_acct_acct_que_reply_rgst_b.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
