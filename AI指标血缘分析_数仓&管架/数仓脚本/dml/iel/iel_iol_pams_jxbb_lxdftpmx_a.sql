...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_pams_jxbb_lxdftpmx_a
CreateDate: 20250220
FileName:   ${iel_data_path}/pams_jxbb_lxdftpmx.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where t1.tjrq <= '${batch_date}'" \
        ...
        file="${iel_data_path}/pams_jxbb_lxdftpmx.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
