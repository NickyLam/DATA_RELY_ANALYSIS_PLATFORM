...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iof_cass_r_rpt_rst0016_i
CreateDate: 20250226
FileName:   ${iel_data_path}/cass_r_rpt_rst0016.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="
...
" \
        ...
        file="${iel_data_path}/cass_r_rpt_rst0016.i.${batch_date}.dat" \
        charset=utf8
        safe=yes
