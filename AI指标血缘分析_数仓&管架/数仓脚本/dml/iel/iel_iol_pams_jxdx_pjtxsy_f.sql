...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_pams_jxdx_pjtxsy_f
CreateDate: 20250609
FileName:   ${iel_data_path}/pams_jxdx_pjtxsy.f.${batch_date}.dat
IF_mark:    f
Logs:
' \
        query="select
...
from ${iol_schema}.pams_jxdx_pjtxsy t1
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/pams_jxdx_pjtxsy.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
