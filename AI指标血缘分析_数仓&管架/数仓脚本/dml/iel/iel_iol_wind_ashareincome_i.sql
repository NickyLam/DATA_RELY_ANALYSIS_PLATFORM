...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_wind_ashareincome_i
CreateDate: 20180529
FileName:   ${iel_data_path}/wind_ashareincome.i.${batch_date}.dat
IF_mark:    i
Logs:
...
" \
        ...
        file="${iel_data_path}/wind_ashareincome.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes