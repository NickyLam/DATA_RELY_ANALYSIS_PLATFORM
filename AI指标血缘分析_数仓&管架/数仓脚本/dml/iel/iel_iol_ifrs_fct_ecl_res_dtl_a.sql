...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_ifrs_fct_ecl_res_dtl_a
CreateDate: 20180529
...
where etl_dt = to_date('20221231','yyyymmdd') or etl_dt = to_date('20230501','yyyymmdd')" \
