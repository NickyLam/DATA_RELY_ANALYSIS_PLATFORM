...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_payoff_sal_dtl_a
CreateDate: 20221111
FileName:   ${iel_data_path}/evt_payoff_sal_dtl.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where etl_dt <= to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/evt_payoff_sal_dtl.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
