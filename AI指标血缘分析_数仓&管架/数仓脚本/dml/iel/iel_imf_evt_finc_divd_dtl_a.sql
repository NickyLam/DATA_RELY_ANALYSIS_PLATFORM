...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_imf_evt_finc_divd_dtl_a
CreateDate: 20180529
FileName:   ${iel_data_path}/evt_finc_divd_dtl.a.${batch_date}.dat
IF_mark:    a
Logs:
...
where etl_dt <= to_date('${batch_date}','yyyymmdd');" \
        ...
        file="${iel_data_path}/evt_finc_divd_dtl.a.${batch_date}.dat" \
        charset=utf8
        safe=yes