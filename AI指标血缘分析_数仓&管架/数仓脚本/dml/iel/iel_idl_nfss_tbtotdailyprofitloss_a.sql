...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_nfss_tbtotdailyprofitloss_a
CreateDate: 20250904
...
where record_date<=to_char(to_date('${batch_date}','yyyymmdd')-1,'yyyymmdd'); " \
