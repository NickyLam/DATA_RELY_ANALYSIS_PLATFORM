...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_epc_pay_h_a
CreateDate: 20220826
FileName:   ${iel_data_path}/evt_epc_pay_h.a.${batch_date}.dat
IF_mark:    a
Logs:
        sundexin 
' \
...
where to_char(final_update_tm,'yyyymmdd') <= '${batch_date}'
and to_char(final_update_tm,'yyyymmdd') >= '20220801' " \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/evt_epc_pay_h.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes