...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_imf_agt_cust_lmt_info_h_a
CreateDate: 20240828
FileName:   ${iel_data_path}/agt_cust_lmt_info_h.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where 1 = 1" \
        ...
        file="${iel_data_path}/agt_cust_lmt_info_h.a.${batch_date}.dat" \
        charset=utf8
        safe=yes
