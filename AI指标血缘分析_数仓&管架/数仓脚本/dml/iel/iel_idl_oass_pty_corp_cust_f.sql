...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_oass_pty_corp_cust_f
CreateDate: 20230116
FileName:   ${iel_data_path}/oass_pty_corp_cust.f.${batch_date}.dat
IF_mark:    f
Logs:
' \
        query="select
...
,t1.nation_tax_tax_regi_cert_num as nation_tax_tax_regi_cert_num
,t1.local_tax_tax_regi_cert_num as local_tax_tax_regi_cert_num
,t1.fin_dept_phone as fin_dept_phone
,t1.oper_field_area as oper_field_area
,t1.oper_field_prop_cd as oper_field_prop_cd
,t1.fin_inst_lics as fin_inst_lics
,t1.rgst_land_dist_cd as rgst_land_dist_cd
,t1.fir_lon_dt as fir_lon_dt
,t1.crdtc_subm_corp_idti_idf_type_cd as crdtc_subm_corp_idti_idf_type_cd
,t1.actl_ctrler_cnt as actl_ctrler_cnt
,t1.major_contrior_cnt as major_contrior_cnt
,t1.green_crdt_subclass_cd as green_crdt_subclass_cd
...
from ${idl_schema}.oass_pty_corp_cust t1
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/oass_pty_corp_cust.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
