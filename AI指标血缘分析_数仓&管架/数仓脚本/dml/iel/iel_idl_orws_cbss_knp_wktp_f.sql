...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_orws_cbss_knp_wktp_f
CreateDate: 20180529
FileName:   ${iel_data_path}/orws_cbss_knp_wktp.f.${batch_date}.dat
IF_mark:    f
Logs:
...
where t.start_dt <= to_date('${batch_date}','yyyymmdd') and t.end_dt > to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/orws_cbss_knp_wktp.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes