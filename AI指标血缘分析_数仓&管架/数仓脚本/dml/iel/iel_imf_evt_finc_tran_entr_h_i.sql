...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_imf_evt_finc_tran_entr_h_i
CreateDate: 20250619
FileName:   ${iel_data_path}/evt_finc_tran_entr_h.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where start_dt = to_date('${batch_date}','yyyymmdd');" \
        ...
        file="${iel_data_path}/evt_finc_tran_entr_h.i.${batch_date}.dat" \
        charset=utf8
        safe=yes
