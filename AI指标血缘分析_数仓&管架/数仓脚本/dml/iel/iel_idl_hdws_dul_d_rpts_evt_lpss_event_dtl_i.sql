...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_hdws_dul_d_rpts_evt_lpss_event_dtl_i
CreateDate: 20180529
FileName:   ${iel_data_path}/hdws_dul_d_rpts_evt_lpss_event_dtl.i.${batch_date}.dat
IF_mark:    i
Logs:
...
' \
      ...
      ,replace(replace(agt_id_name,chr(10),''),chr(13),'') as agt_id_name
      ,replace(replace(agt_blng_acct_num,chr(10),''),chr(13),'') as agt_blng_acct_num
      ...
      ,replace(replace(pay_chnl_typ_cd,chr(10),''),chr(13),'') as pay_chnl_typ_cd
      ...
      ,replace(replace(cntrpty_acct_num_id,chr(10),''),chr(13),'') as cntrpty_acct_num_id
      ...
      ,replace(replace(bal_typ_cd,chr(10),''),chr(13),'') as bal_typ_cd
      ...
      ,replace(replace(biz_cate_cd,chr(10),''),chr(13),'') as biz_cate_cd
      ,replace(replace(data_src_cd,chr(10),''),chr(13),'') as data_src_cd
      ,etl_dt 
from idl.hdws_dul_d_rpts_evt_lpss_event_dtl 
where to_date(${batch_date},'yyyymmdd') = etl_dt;" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/hdws_dul_d_rpts_evt_lpss_event_dtl.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes