...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_oass_agt_loan_lmt_seg_h_i
CreateDate: 20230116
FileName:   ${iel_data_path}/oass_agt_loan_lmt_seg_h.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/oass_agt_loan_lmt_seg_h.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
