...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_amls_t2a_case_trans_cur_f
CreateDate: 20180529
FileName:   ${iel_data_path}/amls_t2a_case_trans_cur.f.${batch_date}.dat
IF_mark:    f
Logs:
...
' \
    ...
    ,replace(replace(t.rela_orgkey,chr(13),''),chr(10),'') as rela_orgkey
 ...
 from iol.amls_t2a_case_trans_cur t
where start_dt <= to_date('${batch_date}','yyyymmdd') and end_dt > to_date('${batch_date}','yyyymmdd')
" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/amls_t2a_case_trans_cur.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes