...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_cqss_i_r_nonrevolvingloan_i_w
CreateDate: 20180529
FileName:   ${iel_data_path}/cqss_i_r_nonrevolvingloan_w.i.${batch_date}.dat
IF_mark:    i_w
Logs:
