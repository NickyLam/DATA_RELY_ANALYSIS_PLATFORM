...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_ibms_tcb_bond_eval_i_w
CreateDate: 20180529
FileName:   ${iel_data_path}/ibms_tcb_bond_eval_w.i.${batch_date}.dat
IF_mark:    i_w
Logs:
...
from iol.ibms_tcb_bond_eval where etl_dt between to_date('${batch_date}', 'yyyymmdd') - 6 and to_date('${batch_date}', 'yyyymmdd');" \
        ...
        file="${iel_data_path}/ibms_tcb_bond_eval_w.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes