...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_super_olbk_tran_evt_a
CreateDate: 20180529
...
' \
  ...
  from ${iml_schema}.evt_super_olbk_tran_evt t1 where t1.send_bank_dt <= to_date('${batch_date}','yyyymmdd') and t1.send_bank_dt >= to_date(substr('${batch_date}',1,6)||'01','yyyymmdd');" \
