...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_hdws_ibms_tbnd_i
CreateDate: 20180529
FileName:   ${iel_data_path}/hdws_ibms_tbnd.i.${batch_date}.dat
IF_mark:    i
Logs:
...
,t1.end_dt
,t1.id_mark
from ${idl_schema}.hdws_ibms_tbnd t1 
where etl_dt = to_date('${batch_date}','yyyymmdd');" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/hdws_ibms_tbnd.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes