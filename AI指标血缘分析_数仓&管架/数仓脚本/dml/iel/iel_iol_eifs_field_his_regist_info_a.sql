...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_eifs_field_his_regist_info_a
CreateDate: 20220819
FileName:   ${iel_data_path}/eifs_field_his_regist_info.a.${batch_date}.dat
IF_mark:    a
Logs:
   sundexin
' \
        query="select
     t.last_updated_ts as etl_dt
...
where to_char(last_updated_ts,'yyyymmdd') <= '${batch_date}'  " \
        ...
        file="${iel_data_path}/eifs_field_his_regist_info.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes