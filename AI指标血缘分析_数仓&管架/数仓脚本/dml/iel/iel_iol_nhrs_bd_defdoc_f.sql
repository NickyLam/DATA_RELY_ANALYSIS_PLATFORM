...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_nhrs_bd_defdoc_f
CreateDate: 20180529
...
' \
    ...
    ,replace(replace(t.pid,chr(13),''),chr(10),'') as pid
    ,replace(replace(t.pk_defdoc,chr(13),''),chr(10),'') as pk_defdoc
