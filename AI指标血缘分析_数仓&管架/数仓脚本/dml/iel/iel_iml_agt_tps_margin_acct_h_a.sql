...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_agt_tps_margin_acct_h_a
CreateDate: 20180529
FileName:   ${iel_data_path}/agt_tps_margin_acct_h.a.${batch_date}.dat
IF_mark:    a
Logs:
...
where t.rgst_dt >= to_date('20200101','yyyymmdd') and t.rgst_dt <= to_date('${batch_date}','yyyymmdd') " \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/agt_tps_margin_acct_h.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes