...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_icl_cmm_exch_rat_info_a
CreateDate: 20180529
FileName:   ${iel_data_path}/cmm_exch_rat_info.a.${batch_date}.dat
IF_mark:    a
Logs:
...
where etl_dt <= to_date('${batch_date}','yyyymmdd') and etl_dt >= to_date('20240101','yyyymmdd');" \
        ...
        file="${iel_data_path}/cmm_exch_rat_info.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes