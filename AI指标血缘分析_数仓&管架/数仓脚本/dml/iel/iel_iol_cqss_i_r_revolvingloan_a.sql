...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_cqss_i_r_revolvingloan_a
CreateDate: 20241111
FileName:   ${iel_data_path}/cqss_i_r_revolvingloan.a.${batch_date}.dat
IF_mark:    a
Logs:
...
from iol.cqss_i_r_revolvingloan t
  where to_char(t.crt_dt_tm,'yyyymmdd') <= '${batch_date}' " \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/cqss_i_r_revolvingloan.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes