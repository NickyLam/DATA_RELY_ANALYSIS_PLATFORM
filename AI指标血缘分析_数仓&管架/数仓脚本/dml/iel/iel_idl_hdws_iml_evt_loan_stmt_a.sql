...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_hdws_iml_evt_loan_stmt_i
CreateDate: 20180529
FileName:   ${iel_data_path}/hdws_iml_evt_loan_stmt.i.${batch_date}.dat
IF_mark:    i
Logs:
...
where etl_dt <= to_date('${batch_date}','yyyymmdd') and etl_dt >= to_date('20211001','yyyymmdd');" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/hdws_iml_evt_loan_stmt.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes