...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iof_albs_bps_rsh_cust_hit_fund_i
CreateDate: 20240826
FileName:   ${iel_data_path}/albs_bps_rsh_cust_hit_fund.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/albs_bps_rsh_cust_hit_fund.i.${batch_date}.dat" \
        charset=utf8
        safe=yes
