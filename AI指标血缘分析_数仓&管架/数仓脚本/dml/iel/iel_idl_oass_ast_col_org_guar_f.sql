...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_oass_ast_col_org_guar_f
CreateDate: 20230116
FileName:   ${iel_data_path}/oass_ast_col_org_guar.f.${batch_date}.dat
IF_mark:    f
Logs:
' \
        query="select
...
,t1.guartor_orgnz_cd as guartor_orgnz_cd
...
,t1.guar_insure_policy_num as guar_insure_policy_num
,t1.stage_guar_flg as stage_guar_flg
,t1.guar_amt as guar_amt
,t1.guar_corp_margin_amt as guar_corp_margin_amt
...
from ${idl_schema}.oass_ast_col_org_guar t1
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/oass_ast_col_org_guar.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
