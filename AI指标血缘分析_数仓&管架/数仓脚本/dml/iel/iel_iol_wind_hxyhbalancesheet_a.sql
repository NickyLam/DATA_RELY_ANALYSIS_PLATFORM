...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_wind_hxyhbalancesheet_a
CreateDate: 20221108
FileName:   ${iel_data_path}/wind_hxyhbalancesheet.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where etl_dt <= to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/wind_hxyhbalancesheet.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
