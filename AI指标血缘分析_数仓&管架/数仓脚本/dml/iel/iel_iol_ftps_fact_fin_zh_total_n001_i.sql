...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_ftps_fact_fin_zh_total_n001_i
CreateDate: 20240719
FileName:   ${iel_data_path}/ftps_fact_fin_zh_total_n001.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/ftps_fact_fin_zh_total_n001.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
