...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_dep_acct_imp_evt_rgst_b_a
CreateDate: 20180529
FileName:   ${iel_data_path}/evt_dep_acct_imp_evt_rgst_b.a.${batch_date}.dat
IF_mark:    a
Logs:
...
where etl_dt <= to_date('${batch_date}','yyyymmdd');" \
        ...
        file="${iel_data_path}/evt_dep_acct_imp_evt_rgst_b.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes