...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iof_amls_t4a_cust_risk_wf_log_hst_f
CreateDate: 20241118
FileName:   ${iel_data_path}/amls_t4a_cust_risk_wf_log_hst.f.${batch_date}.dat
IF_mark:    f
Logs:
' \
        query="select
...
from ${iol_schema}.amls_t4a_cust_risk_wf_log_hst t1
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/amls_t4a_cust_risk_wf_log_hst.f.${batch_date}.dat" \
        charset=utf8
        safe=yes
