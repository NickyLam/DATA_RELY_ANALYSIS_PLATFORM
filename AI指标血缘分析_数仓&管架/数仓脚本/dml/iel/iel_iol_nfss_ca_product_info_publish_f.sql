...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_nfss_ca_product_info_publish_f
CreateDate: 20220916
FileName:   ${iel_data_path}/nfss_ca_product_info_publish.f.${batch_date}.dat
IF_mark:    f
Logs:
   Sundexin
' \
...
from iol.nfss_ca_product_info_publish t
where start_dt <=to_date('${batch_date}','yyyymmdd') and end_dt >to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/nfss_ca_product_info_publish.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes