...
Author: Sunline
Usage: python $ETL_HOME/script/main.py yyyymmdd iel_idl_hdws_mpcs_a50ubcardjourhis_a
CreateDate: 20180529
FileName:  ${iel_data_path}/hdws_mpcs_a50ubcardjourhis.i.${batch_date}.dat
IF_mark:  i
Logs: zjj 2018-07-27 create template
' \  query="select 
...
,replace(replace(t1.onlnbl,chr(13),''),chr(10),'') as onlnbl 
,replace(replace(t1.avalbl,chr(13),''),chr(10),'') as avalbl 
,replace(replace(t1.cravbl,chr(13),''),chr(10),'') as cravbl 
...
,replace(replace(t1.settlmtamt,chr(13),''),chr(10),'') as settlmtamt 
...
,replace(replace(t1.foriegnbl,chr(13),''),chr(10),'') as foriegnbl 
...
where transdate>='20210416' and transdate<='${batch_date}';" \
