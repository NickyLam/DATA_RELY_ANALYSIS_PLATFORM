...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_oass_agt_loan_appl_basic_info_h_f
CreateDate: 20221111
FileName:   ${iel_data_path}/oass_agt_loan_appl_basic_info_h.f.${batch_date}.dat
IF_mark:    f
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/oass_agt_loan_appl_basic_info_h.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
