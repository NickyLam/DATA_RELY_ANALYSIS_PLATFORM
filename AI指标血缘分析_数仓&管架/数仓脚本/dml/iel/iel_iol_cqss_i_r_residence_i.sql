...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_cqss_i_r_residence_i
CreateDate: 20180529
FileName:   ${iel_data_path}/cqss_i_r_residence.i.${batch_date}.dat
IF_mark:    i
Logs:
...
from iol.cqss_i_r_residence t
  where to_char(t.crt_dt_tm,'yyyymmdd')='${batch_date}' " \
        ...
        file="${iel_data_path}/cqss_i_r_residence.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes