...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_rpt_mpcs_a50ubcardjourhis_i
CreateDate: 20180529
FileName:   ${iel_data_path}/rpt_mpcs_a50ubcardjourhis.i.${batch_date}.dat
IF_mark:    i
Logs:
...
where etl_dt>=to_date('${batch_date}','yyyymmdd') -14 and etl_dt<=to_date('${batch_date}','yyyymmdd');" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/rpt_mpcs_a50ubcardjourhis.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes