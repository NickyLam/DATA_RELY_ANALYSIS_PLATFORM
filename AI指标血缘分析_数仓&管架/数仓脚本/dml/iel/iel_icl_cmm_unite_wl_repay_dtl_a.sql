...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_icl_cmm_unite_wl_repay_dtl_a
CreateDate: 20231026
...
where etl_dt <= to_date('${batch_date}','yyyymmdd')-1 and etl_dt >= to_date('20230501','yyyymmdd')" \
