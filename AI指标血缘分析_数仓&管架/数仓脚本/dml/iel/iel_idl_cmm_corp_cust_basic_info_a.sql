...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_cmm_corp_cust_basic_info_a
CreateDate: 20221121
FileName:   ${iel_data_path}/cmm_corp_cust_basic_info.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where etl_dt <= to_date('20230430', 'yyyymmdd') and etl_dt >= to_date('20220831', 'yyyymmdd') and etl_dt = last_day(etl_dt)" \
        ...
        file="${iel_data_path}/cmm_corp_cust_basic_info.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
