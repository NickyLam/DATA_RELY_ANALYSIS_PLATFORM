...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_imf_evt_loan_sub_acct_bal_flow_i
CreateDate: 20241104
FileName:   ${iel_data_path}/evt_loan_sub_acct_bal_flow.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/evt_loan_sub_acct_bal_flow.i.${batch_date}.dat" \
        charset=utf8
        safe=yes
