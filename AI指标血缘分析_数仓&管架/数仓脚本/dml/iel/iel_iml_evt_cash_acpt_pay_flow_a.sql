...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_cash_acpt_pay_flow_a
CreateDate: 20221105
FileName:   ${iel_data_path}/evt_cash_acpt_pay_flow.a.${batch_date}.dat
IF_mark:    a
Logs:
   sundexin
' \
...
from iml.evt_cash_acpt_pay_flow t
  where 1=1 " \
        ...
        file="${iel_data_path}/evt_cash_acpt_pay_flow.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes