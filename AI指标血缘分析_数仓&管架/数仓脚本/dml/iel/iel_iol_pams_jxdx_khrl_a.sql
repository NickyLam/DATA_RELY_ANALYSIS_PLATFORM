...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_pams_jxdx_khrl_a
CreateDate: 20180529
FileName:   ${iel_data_path}/pams_jxdx_khrl.a.${batch_date}.dat
IF_mark:    a
Logs:
...
from iol.pams_jxdx_khrl t1 
where 1=1 " \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/pams_jxdx_khrl.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes