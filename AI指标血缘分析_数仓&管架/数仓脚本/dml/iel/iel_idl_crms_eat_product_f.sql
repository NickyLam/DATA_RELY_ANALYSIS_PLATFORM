...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_crms_eat_product_f
CreateDate: 20180529
FileName:   ${iel_data_path}/crms_eat_product_${batch_date}_f.dat
IF_mark:    f
Logs:
...
,created_stamp
,created_tx_stamp
from ${idl_schema}.crms_eat_product
where etl_dt=to_date('${batch_date}','yyyymmdd');" \
        field="|#|" record="0x0a"  \
        file="${iel_data_path}/crms_eat_product_${batch_date}_f.dat" \
        charset=zhs16gbk
        safe=yes