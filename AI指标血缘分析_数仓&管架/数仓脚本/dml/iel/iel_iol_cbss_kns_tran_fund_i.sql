...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_cbss_kns_tran_fund_i
CreateDate: 20180529
FileName:   ${iel_data_path}/cbss_kns_tran_fund.i.${batch_date}.dat
IF_mark:    i
Logs:
...
where to_char(t.trandt)= '${batch_date}'" \
        ...
        file="${iel_data_path}/cbss_kns_tran_fund.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes