...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_orws_t_ghbr_bv_details_i
CreateDate: 20180529
FileName:   ${iel_data_path}/orws_t_ghbr_bv_details.i.${batch_date}.dat
IF_mark:    i
Logs:
...
from ${iol_schema}.orws_t_ghbr_bv_details t1 
where trunc(txn_dt,'dd')=to_date('${batch_date}','yyyymmdd');" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/orws_t_ghbr_bv_details.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes