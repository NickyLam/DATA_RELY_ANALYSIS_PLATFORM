...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_cpms_t_account_point_list_a
CreateDate: 20180529
FileName:   ${iel_data_path}/cpms_t_account_point_list.a.${batch_date}.dat
IF_mark:    a
Logs:
...
from iol.cpms_t_account_point_list t
  where 1= 1 " \
        ...
        file="${iel_data_path}/cpms_t_account_point_list.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes