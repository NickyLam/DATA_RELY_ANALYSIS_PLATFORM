...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_prd_am_finc_prod_f_w
CreateDate: 20180529
FileName:   ${iel_data_path}/prd_am_finc_prod_w.f.${batch_date}.dat
IF_mark:    f_w
Logs:
...
,t1.job_cd 
from ${idl_schema}.prd_am_finc_prod t1 
where etl_dt between to_date('${batch_date}','yyyymmdd')-6 and to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/prd_am_finc_prod_w.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes