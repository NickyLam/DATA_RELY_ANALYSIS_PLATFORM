...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_alss_rate_ol_cust_curr_f
CreateDate: 20221117
FileName:   ${iel_data_path}/alss_rate_ol_cust_curr.f.${batch_date}.dat
IF_mark:    f
Logs:
' \
        query="select
...
where start_dt <= to_date('${batch_date}','yyyymmdd') and end_dt > to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/alss_rate_ol_cust_curr.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
