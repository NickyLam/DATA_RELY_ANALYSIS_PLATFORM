...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idf_crps_cmm_unite_wl_loan_cont_info_morning_f
CreateDate: 20260407
FileName:   ${iel_data_path}/crps_cmm_unite_wl_loan_cont_info_morning.f.${batch_date}.dat
IF_mark:    f
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/crps_cmm_unite_wl_loan_cont_info_morning.f.${batch_date}.dat" \
        charset=utf8
        safe=yes
