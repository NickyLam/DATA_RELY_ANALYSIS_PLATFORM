...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_ibank_manual_entry_evt_i
CreateDate: 20231229
FileName:   ${iel_data_path}/evt_ibank_manual_entry_evt.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/evt_ibank_manual_entry_evt.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
