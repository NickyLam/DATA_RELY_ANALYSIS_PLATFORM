...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_agt_finc_acct_unpaid_prft_h_a
CreateDate: 20180529
FileName:   ${iel_data_path}/agt_finc_acct_unpaid_prft_h.a.${batch_date}.dat
IF_mark:    a
Logs:
...
from iml.agt_finc_acct_unpaid_prft_h t
  where t.start_dt <= to_date('${batch_date}','yyyymmdd') and t.end_dt > to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/agt_finc_acct_unpaid_prft_h.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes