...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_rpt_cmm_retl_loan_acct_info_f
CreateDate: 20180529
FileName:   ${iel_data_path}/rpt_cmm_retl_loan_acct_info.f.${batch_date}.dat
IF_mark:    f
Logs:
...
,off_bs_int_subj_id
,int_income_subj_id
,int_income_adj_subj_id
,td_int_income_adj
,irr_repay_way_cd
from idl.rpt_cmm_retl_loan_acct_info 
where etl_dt =to_date('${batch_date}','yyyymmdd');" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/rpt_cmm_retl_loan_acct_info.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes