...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_cbss_fcs_list_a
CreateDate: 20180529
FileName:   ${iel_data_path}/cbss_fcs_list.a.${batch_date}.dat
IF_mark:    a
Logs:
...
where t.trandt <= '${batch_date}' and t.trandt >= '20200101'" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/cbss_fcs_list.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes