...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_scfs_hdws_iml_agt_ln_ac_amt_info_f
CreateDate: 20180529
FileName:   ${iel_data_path}/scfs_hdws_iml_agt_ln_ac_amt_info.f.${batch_date}.dat
IF_mark:    f
Logs:
...
from ${idl_schema}.scfs_hdws_iml_agt_ln_ac_amt_info t1 
where etl_dt = to_date('${batch_date}','yyyymmdd') and data_src_cd in ('CRSS','CBSS');" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/scfs_hdws_iml_agt_ln_ac_amt_info.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
