...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_oc_acct_rgst_dtl_flow_a
CreateDate: 20180529
FileName:   ${iel_data_path}/evt_oc_acct_rgst_dtl_flow.a.${batch_date}.dat
IF_mark:    a
Logs:
...
from iml.evt_oc_acct_rgst_dtl_flow t1
where t1.oc_acct_dt >= to_date('20200301','yyyymmdd') and t1.oc_acct_dt <= to_date('20200924','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/evt_oc_acct_rgst_dtl_flow.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes