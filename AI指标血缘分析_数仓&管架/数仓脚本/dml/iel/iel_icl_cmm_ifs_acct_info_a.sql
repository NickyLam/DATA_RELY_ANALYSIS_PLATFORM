...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_icl_cmm_ifs_acct_info_a
CreateDate: 20180529
FileName:   ${iel_data_path}/cmm_ifs_acct_info.a.${batch_date}.dat
IF_mark:    a
Logs:
...
from icl.cmm_ifs_acct_info t1 
where t1.etl_dt >= to_date('20201231','yyyymmdd') and t1.etl_dt <= to_date('${batch_date}','yyyymmdd') " \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/cmm_ifs_acct_info.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes