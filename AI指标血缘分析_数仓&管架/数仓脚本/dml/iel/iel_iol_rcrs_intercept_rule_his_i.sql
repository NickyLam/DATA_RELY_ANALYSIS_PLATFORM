...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_rcrs_intercept_rule_his_i
CreateDate: 20180529
FileName:   ${iel_data_path}/rcrs_intercept_rule_his.i.${batch_date}.dat
IF_mark:    i
Logs:
...
from iol.rcrs_intercept_rule_his t
where replace(substr(t.update_date,1,10),'-','')='${batch_date}';" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/rcrs_intercept_rule_his.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes