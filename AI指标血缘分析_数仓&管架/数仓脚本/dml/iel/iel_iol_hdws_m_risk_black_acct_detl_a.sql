...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_hdws_m_risk_black_acct_detl_a
CreateDate: 20180529
FileName:   ${iel_data_path}/hdws_m_risk_black_acct_detl.a.${batch_date}.dat
IF_mark:    a
Logs:
...
from iol.hdws_m_risk_black_acct_detl t
where 1=1" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/hdws_m_risk_black_acct_detl.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes