...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iof_mpcs_a08thvhp_a
CreateDate: 20250410
FileName:   ${iel_data_path}/mpcs_a08thvhp.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where etl_dt <= to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/mpcs_a08thvhp.a.${batch_date}.dat" \
        charset=utf8
        safe=yes
