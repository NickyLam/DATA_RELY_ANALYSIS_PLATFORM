...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_icf_cmm_ibank_tran_instr_dtl_i
CreateDate: 20230602
FileName:   ${iel_data_path}/cmm_ibank_tran_instr_dtl.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/cmm_ibank_tran_instr_dtl.i.${batch_date}.dat" \
        charset=utf8
        safe=yes
