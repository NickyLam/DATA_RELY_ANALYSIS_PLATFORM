...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_wind_hkcompanyinfo_f
CreateDate: 20230823
FileName:   ${iel_data_path}/wind_hkcompanyinfo.f.${batch_date}.dat
IF_mark:    f
Logs:
' \
        query="select
...
where start_dt <= to_date('${batch_date}','yyyymmdd') and end_dt > to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/wind_hkcompanyinfo.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
