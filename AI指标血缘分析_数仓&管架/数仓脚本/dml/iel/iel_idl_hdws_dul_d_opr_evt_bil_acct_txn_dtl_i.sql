...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_hdws_dul_d_opr_evt_bil_acct_txn_dtl_i
CreateDate: 20180529
FileName:   ${iel_data_path}/hdws_dul_d_opr_evt_bil_acct_txn_dtl.i.${batch_date}.dat
IF_mark:    i
Logs:
...
' \
      ...
      ,txn_amt
      ,replace(replace(acct_bal,chr(10),''),chr(13),'') as acct_bal
      ...
      ,etl_dt 
from idl.hdws_dul_d_opr_evt_bil_acct_txn_dtl 
where to_char(etl_dt,'yyyymmdd') = '${batch_date}';" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/hdws_dul_d_opr_evt_bil_acct_txn_dtl.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes