...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_eifs_t09_corp_cust_info_modify_seq_i
CreateDate: 20180529
FileName:   ${iel_data_path}/eifs_t09_corp_cust_info_modify_seq.i.${batch_date}.dat
IF_mark:    i
Logs:
...
from ${iol_schema}.eifs_t09_corp_cust_info_modify_seq t1
where etl_dt = to_date('${batch_date}','yyyymmdd');" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/eifs_t09_corp_cust_info_modify_seq.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes