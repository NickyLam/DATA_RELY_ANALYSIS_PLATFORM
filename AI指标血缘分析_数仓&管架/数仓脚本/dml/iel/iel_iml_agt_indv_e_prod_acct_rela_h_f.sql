...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_agt_indv_e_prod_acct_rela_h_f
CreateDate: 20180529
FileName:   ${iel_data_path}/agt_indv_e_prod_acct_rela_h.f.${batch_date}.dat
IF_mark:    f
Logs:
...
,replace(replace(t1.fea_name_cd,chr(13),''),chr(10),'') as fea_name_cd 
...
from ${iml_schema}.agt_indv_e_prod_acct_rela_h t1 
where start_dt <= to_date('${batch_date}','yyyymmdd') and end_dt > to_date('${batch_date}','yyyymmdd');" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/agt_indv_e_prod_acct_rela_h.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes