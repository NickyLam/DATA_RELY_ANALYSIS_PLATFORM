...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_loan_distr_flow_f
CreateDate: 20240523
FileName:   ${iel_data_path}/evt_loan_distr_flow.f.${batch_date}.dat
IF_mark:    f
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/evt_loan_distr_flow.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
