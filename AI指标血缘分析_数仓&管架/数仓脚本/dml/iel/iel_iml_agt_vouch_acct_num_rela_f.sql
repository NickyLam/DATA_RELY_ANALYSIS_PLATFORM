...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_agt_vouch_acct_num_rela_f
CreateDate: 20180529
FileName:   ${iel_data_path}/agt_vouch_acct_num_rela.f.${batch_date}.dat
IF_mark:    f
Logs:
...
from iml.agt_vouch_acct_num_rela t
where start_dt <= to_date('${batch_date}','yyyymmdd') and end_dt > to_date('${batch_date}','yyyymmdd')
" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/agt_vouch_acct_num_rela.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes