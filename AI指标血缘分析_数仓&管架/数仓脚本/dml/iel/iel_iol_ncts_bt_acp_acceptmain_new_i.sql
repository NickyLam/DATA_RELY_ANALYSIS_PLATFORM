...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_ncts_bt_acp_acceptmain_new_i
CreateDate: 20180529
FileName:   ${iel_data_path}/ncts_bt_acp_acceptmain_new.i.${batch_date}.dat
IF_mark:    i
Logs:
...
where etl_dt = to_date('${batch_date}','yyyymmdd');" \
        ...
        file="${iel_data_path}/ncts_bt_acp_acceptmain_new.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes