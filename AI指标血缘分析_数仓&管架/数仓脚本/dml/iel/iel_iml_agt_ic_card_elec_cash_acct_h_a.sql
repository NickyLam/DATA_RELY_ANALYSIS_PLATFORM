...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_agt_ic_card_elec_cash_acct_h_a
CreateDate: 20221229
FileName:   ${iel_data_path}/agt_ic_card_elec_cash_acct_h.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
to_date('20230430','yyyymmdd') as etl_dt
...
where start_dt <= to_date('20230430','yyyymmdd') and end_dt > to_date('20230430','yyyymmdd') " \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/agt_ic_card_elec_cash_acct_h.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
