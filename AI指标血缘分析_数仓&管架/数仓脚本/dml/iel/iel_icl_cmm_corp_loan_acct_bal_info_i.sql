...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_icl_cmm_corp_loan_acct_bal_info_i
CreateDate: 20180529
FileName:   ${iel_data_path}/cmm_corp_loan_acct_bal_info.i.${batch_date}.dat
IF_mark:    i
Logs:
...
from icl.cmm_corp_loan_acct_bal_info t
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/cmm_corp_loan_acct_bal_info.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes