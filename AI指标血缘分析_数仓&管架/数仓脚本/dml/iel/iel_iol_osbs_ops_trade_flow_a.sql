...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_osbs_ops_trade_flow_a
CreateDate: 20220306
FileName:   ${iel_data_path}/osbs_ops_trade_flow.a.${batch_date}.dat
IF_mark:    a
Logs:
   sundexin
' \
...
from iol.osbs_ops_trade_flow t
  ...
  and   t.otf_transdate >= '20210901'   " \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/osbs_ops_trade_flow.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes