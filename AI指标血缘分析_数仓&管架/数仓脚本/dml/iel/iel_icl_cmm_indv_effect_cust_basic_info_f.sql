...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_icl_cmm_indv_effect_cust_basic_info_f
CreateDate: 20240603
FileName:   ${iel_data_path}/cmm_indv_effect_cust_basic_info.f.${batch_date}.dat
IF_mark:    f
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd') and cust_status_cd = '1';" \
        ...
        file="${iel_data_path}/cmm_indv_effect_cust_basic_info.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
