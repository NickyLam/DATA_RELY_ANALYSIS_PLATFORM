...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iof_amls_t4a_cust_risk_wf_log_a
CreateDate: 20241231
FileName:   ${iel_data_path}/amls_t4a_cust_risk_wf_log.a.${batch_date}.dat
IF_mark:    a
Logs:
...
where etl_dt <= to_date('${batch_date}','yyyymmdd');" \
        ...
        file="${iel_data_path}/amls_t4a_cust_risk_wf_log.a.${batch_date}.dat" \
        charset=utf8
        safe=yes