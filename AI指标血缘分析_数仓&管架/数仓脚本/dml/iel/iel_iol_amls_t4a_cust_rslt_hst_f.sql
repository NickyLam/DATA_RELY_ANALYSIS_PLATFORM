...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_amls_t4a_cust_rslt_hst_f
CreateDate: 20180529
FileName:   ${iel_data_path}/amls_t4a_cust_rslt_hst.f.${batch_date}.dat
IF_mark:    f
Logs:
...
from ${iol_schema}.amls_t4a_cust_rslt_hst t1
where etl_dt = to_date('${batch_date}','yyyymmdd');" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/amls_t4a_cust_rslt_hst.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes