...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_ncbs_rb_lm_limit_cumulative_a
CreateDate: 20231031
FileName:   ${iel_data_path}/ncbs_rb_lm_limit_cumulative.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where etl_dt <= to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/ncbs_rb_lm_limit_cumulative.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
