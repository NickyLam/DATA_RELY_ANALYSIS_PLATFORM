...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_fams_ptl_raised_amt_a
CreateDate: 20240719
FileName:   ${iel_data_path}/fams_ptl_raised_amt.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where etl_dt <= to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/fams_ptl_raised_amt.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
