...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_ifrs_val_rpt_trade_a
CreateDate: 20221115
FileName:   ${iel_data_path}/ifrs_val_rpt_trade.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where t1.d_data_dt = to_date('20230501','yyyymmdd') or t1.d_data_dt = to_date('20221231','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/ifrs_val_rpt_trade.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
