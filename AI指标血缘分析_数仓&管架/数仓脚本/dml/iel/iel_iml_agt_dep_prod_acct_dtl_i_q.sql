...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_agt_dep_prod_acct_dtl_i_q
CreateDate: 20180529
FileName:   ${iel_data_path}/agt_dep_prod_acct_dtl_q.i.${batch_date}.dat
IF_mark:    i_q
Logs:
...
from ${iml_schema}.agt_dep_prod_acct_dtl t1
where t1.acct_dt > add_months(to_date('${batch_date}','yyyymmdd') ,-3) and t1.acct_dt <= to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/agt_dep_prod_acct_dtl_q.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes