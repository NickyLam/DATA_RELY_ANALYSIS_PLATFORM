...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_taxable_tran_dtl_a1
CreateDate: 20240312
FileName:   ${iel_data_path}/evt_taxable_tran_dtl.a.${batch_date}.dat
IF_mark:    a
Logs:
...
where t1.etl_dt <= to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/evt_taxable_tran_dtl.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes