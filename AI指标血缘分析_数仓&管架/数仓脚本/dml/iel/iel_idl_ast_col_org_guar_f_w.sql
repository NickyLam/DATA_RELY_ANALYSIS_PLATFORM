...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_ast_col_org_guar_f_w
CreateDate: 20180529
FileName:   ${iel_data_path}/ast_col_org_guar_w.f.${batch_date}.dat
IF_mark:    f_w
Logs:
...
,t.guar_insure_policy_num as guar_insure_policy_num
...
,t.job_cd 
from ${idl_schema}.ast_col_org_guar t 
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/ast_col_org_guar_w.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes