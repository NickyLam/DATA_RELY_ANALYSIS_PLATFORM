...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idf_crps_cmm_unite_wl_repay_dtl_i
CreateDate: 20180529
FileName:   ${iel_data_path}/crps_cmm_unite_wl_repay_dtl.i.${batch_date}.dat
IF_mark:    i
Logs:
...
where etl_dt = to_date('${batch_date}','yyyymmdd');" \
        ...
        file="${iel_data_path}/crps_cmm_unite_wl_repay_dtl.i.${batch_date}.dat" \
        charset=utf8
        safe=yes