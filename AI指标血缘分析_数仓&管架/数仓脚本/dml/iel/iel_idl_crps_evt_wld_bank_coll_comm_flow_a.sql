...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_crps_evt_wld_bank_coll_comm_flow_a
CreateDate: 20231225
FileName:   ${iel_data_path}/crps_evt_wld_bank_coll_comm_flow.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where etl_dt <= to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/crps_evt_wld_bank_coll_comm_flow.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
