...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_finc_tran_entr_h_a
CreateDate: 20231012
...
where start_dt<=to_date('20231019','yyyymmdd') and end_dt>to_date('20231019','yyyymmdd');" \
