...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_cqss_e_r_dbtcraccnidrryrsplinf_a
CreateDate: 20240923
FileName:   ${iel_data_path}/cqss_e_r_dbtcraccnidrryrsplinf.a.${batch_date}.dat
IF_mark:    a
Logs:
...
from iol.cqss_e_r_dbtcraccnidrryrsplinf t
  where to_char(t.crt_dt_tm,'yyyymmdd')<='${batch_date}' " \
        ...
        file="${iel_data_path}/cqss_e_r_dbtcraccnidrryrsplinf.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes