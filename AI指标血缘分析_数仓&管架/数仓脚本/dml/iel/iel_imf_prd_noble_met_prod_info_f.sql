...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_imf_prd_noble_met_prod_info_f
CreateDate: 20180529
FileName:   ${iel_data_path}/prd_noble_met_prod_info.f.${batch_date}.dat
IF_mark:    f
Logs:
...
where t.start_dt <= to_date('${batch_date}','yyyymmdd') and t.end_dt > to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/prd_noble_met_prod_info.f.${batch_date}.dat" \
        charset=utf8
        safe=yes