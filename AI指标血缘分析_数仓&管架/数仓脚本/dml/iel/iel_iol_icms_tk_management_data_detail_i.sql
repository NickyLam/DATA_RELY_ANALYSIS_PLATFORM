...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_icms_tk_management_data_detail_i
CreateDate: 20250724
FileName:   ${iel_data_path}/icms_tk_management_data_detail.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd') - 1" \
        ...
        file="${iel_data_path}/icms_tk_management_data_detail.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
