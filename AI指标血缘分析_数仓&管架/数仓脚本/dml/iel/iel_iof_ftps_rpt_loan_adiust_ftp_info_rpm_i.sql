...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iof_ftps_rpt_loan_adiust_ftp_info_rpm_i
CreateDate: 20250218
FileName:   ${iel_data_path}/ftps_rpt_loan_adiust_ftp_info_rpm.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/ftps_rpt_loan_adiust_ftp_info_rpm.i.${batch_date}.dat" \
        charset=utf8
        safe=yes
