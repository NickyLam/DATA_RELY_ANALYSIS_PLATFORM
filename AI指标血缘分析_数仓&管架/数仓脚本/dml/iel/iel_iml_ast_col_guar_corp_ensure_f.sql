...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_ast_col_guar_corp_ensure_f
CreateDate: 20221021
FileName:   ${iel_data_path}/ast_col_guar_corp_ensure.f.${batch_date}.dat
IF_mark:    f
Logs:
' \
        query="select
...
from ${iml_schema}.ast_col_guar_corp_ensure t1
where 1=1" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/ast_col_guar_corp_ensure.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
