...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_rsts_rcd_ir_tzbl_dbxx_a
CreateDate: 20241012
FileName:   ${iel_data_path}/rsts_rcd_ir_tzbl_dbxx.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
from ${iol_schema}.rsts_rcd_ir_tzbl_dbxx t1
where etl_dt <= to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/rsts_rcd_ir_tzbl_dbxx.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
