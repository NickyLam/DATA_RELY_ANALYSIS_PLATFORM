...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_icf_cmm_dep_acct_tran_dtl_attach_info_a1
CreateDate: 20251217
...
where etl_dt between date'2024-12-06' and to_date('${batch_date}','yyyymmdd')" \
