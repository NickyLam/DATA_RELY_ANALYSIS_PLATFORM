...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_prd_consmt_fund_day_sell_h_i
CreateDate: 20180529
FileName:   ${iel_data_path}/prd_consmt_fund_day_sell_h.i.${batch_date}.dat
IF_mark:    i
Logs:
...
where t.start_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/prd_consmt_fund_day_sell_h.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes