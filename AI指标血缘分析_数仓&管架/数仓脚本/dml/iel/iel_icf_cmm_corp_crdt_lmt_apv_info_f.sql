...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_icf_cmm_corp_crdt_lmt_apv_info_f
CreateDate: 20180529
FileName:   ${iel_data_path}/cmm_corp_crdt_lmt_apv_info.f.${batch_date}.dat
IF_mark:    f
Logs:
...
from ${icl_schema}.cmm_corp_crdt_lmt_apv_info t1
where etl_dt = to_date('${batch_date}','yyyymmdd');" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/cmm_corp_crdt_lmt_apv_info.f.${batch_date}.dat" \
        charset=utf8
        safe=yes