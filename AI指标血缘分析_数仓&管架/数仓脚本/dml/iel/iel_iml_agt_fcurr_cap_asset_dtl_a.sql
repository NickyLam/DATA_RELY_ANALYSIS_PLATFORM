...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_agt_fcurr_cap_asset_dtl_a
CreateDate: 20230804
FileName:   ${iel_data_path}/agt_fcurr_cap_asset_dtl.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where etl_dt <= to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/agt_fcurr_cap_asset_dtl.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
