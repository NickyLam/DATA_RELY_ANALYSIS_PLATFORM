...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_trust_tran_entr_h_a
CreateDate: 20180529
FileName:   ${iel_data_path}/evt_trust_tran_entr_h.a.${batch_date}.dat
IF_mark:    a
Logs:
...
from iml.evt_trust_tran_entr_h t1 
where 1=1 " \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/evt_trust_tran_entr_h.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes