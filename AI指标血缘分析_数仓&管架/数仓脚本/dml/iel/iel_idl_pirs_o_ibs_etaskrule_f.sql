...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_pirs_o_ibs_etaskrule_f
CreateDate: 20180529
FileName:   ${iel_data_path}/pirs_o_ibs_etaskrule_${batch_date}_f.dat
IF_mark:    f
Logs:
...
,failamt
,remaintimes
from iol.ibss_etaskrule;" \
        field="|#|" record="0x0a"  \
        file="${iel_data_path}/pirs_o_ibs_etaskrule_${batch_date}_f.dat" \
        charset=zhs16gbk
        safe=yes