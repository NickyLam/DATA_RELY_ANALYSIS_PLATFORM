...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_ponl_bk_cust_login_flow_a
CreateDate: 20220407
FileName:   ${iel_data_path}/evt_ponl_bk_cust_login_flow.a.${batch_date}.dat
IF_mark:    a
Logs:
   sundexin
' \
...
from iml.evt_ponl_bk_cust_login_flow t
where t.etl_dt >= to_date('20210101','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/evt_ponl_bk_cust_login_flow.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes