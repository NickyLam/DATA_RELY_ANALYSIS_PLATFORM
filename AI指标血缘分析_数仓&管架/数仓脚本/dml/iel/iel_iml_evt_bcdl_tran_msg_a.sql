...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_bcdl_tran_msg_a
CreateDate: 20180529
FileName:   ${iel_data_path}/evt_bcdl_tran_msg.a.${batch_date}.dat
IF_mark:    a
Logs:
...
where etl_dt <= to_date('20230417','yyyymmdd') and etl_dt >= to_date('20210101','yyyymmdd');" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/evt_bcdl_tran_msg.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes