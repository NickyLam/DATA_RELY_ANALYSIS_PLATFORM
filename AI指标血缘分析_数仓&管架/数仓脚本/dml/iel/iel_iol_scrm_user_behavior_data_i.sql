...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_scrm_user_behavior_data_i
CreateDate: 20230804
FileName:   ${iel_data_path}/scrm_user_behavior_data.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/scrm_user_behavior_data.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
