...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_oass_pty_corp_a
CreateDate: 20230116
FileName:   ${iel_data_path}/oass_pty_corp.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/oass_pty_corp.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
