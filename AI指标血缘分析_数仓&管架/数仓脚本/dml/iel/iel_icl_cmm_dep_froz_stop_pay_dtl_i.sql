...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_icl_cmm_dep_froz_stop_pay_dtl_i
CreateDate: 20180529
FileName:   ${iel_data_path}/cmm_dep_froz_stop_pay_dtl.i.${batch_date}.dat
IF_mark:    i
Logs:
...
,t1.froz_stop_pay_dt as froz_stop_pay_dt
...
where etl_dt = to_date('${batch_date}','yyyymmdd');" \
        ...
        file="${iel_data_path}/cmm_dep_froz_stop_pay_dtl.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes