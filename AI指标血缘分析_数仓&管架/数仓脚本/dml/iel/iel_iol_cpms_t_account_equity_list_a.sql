...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_cpms_t_account_equity_list_a
CreateDate: 20240311
FileName:   ${iel_data_path}/cpms_t_account_equity_list.a.${batch_date}.dat
IF_mark:    a
Logs:
...
where t.etl_dt <= to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/cpms_t_account_equity_list.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes