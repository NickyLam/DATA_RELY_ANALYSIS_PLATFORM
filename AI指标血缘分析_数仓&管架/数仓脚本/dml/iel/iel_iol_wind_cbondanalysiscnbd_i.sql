...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_wind_cbondanalysiscnbd_i
CreateDate: 20230423
FileName:   ${iel_data_path}/wind_cbondanalysiscnbd.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
from ${iol_schema}.wind_cbondanalysiscnbd t1
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/wind_cbondanalysiscnbd.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
