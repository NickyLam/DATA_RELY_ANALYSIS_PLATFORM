...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_indv_e_acct_pay_dtl_i
CreateDate: 20180529
FileName:   ${iel_data_path}/evt_indv_e_acct_pay_dtl.i.${batch_date}.dat
IF_mark:    i
Logs:
...
from iml.evt_indv_e_acct_pay_dtl t
  where t.etl_dt = to_date('${batch_date}','yyyymmdd') " \
        ...
        file="${iel_data_path}/evt_indv_e_acct_pay_dtl.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes