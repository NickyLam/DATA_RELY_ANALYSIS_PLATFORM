...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_os_priv_serv_bus_flow_i
CreateDate: 20180529
FileName:   ${iel_data_path}/evt_os_priv_serv_bus_flow.i.${batch_date}.dat
IF_mark:    i
Logs:
...
from iml.evt_os_priv_serv_bus_flow t
where t.etl_dt = to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/evt_os_priv_serv_bus_flow.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes