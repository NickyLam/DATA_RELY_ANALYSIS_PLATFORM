...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_mercht_clear_info_a
CreateDate: 20180529
FileName:   ${iel_data_path}/evt_mercht_clear_info.a.${batch_date}.dat
IF_mark:    a
Logs:
...
where t1.etl_dt <= to_date('20230430','yyyymmdd') and t1.etl_dt >= to_date('20230101','yyyymmdd')" \
        ...
        file="${iel_data_path}/evt_mercht_clear_info.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes