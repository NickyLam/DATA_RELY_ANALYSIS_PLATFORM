...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_hdws_iml_evt_dpst_open_colse_dtl_i_m
CreateDate: 20180529
FileName:   ${iel_data_path}/hdws_iml_evt_dpst_open_colse_dtl_m.i.${batch_date}.dat
IF_mark:    i_m
Logs:
...
where etl_dt <= to_date('${batch_date}','yyyymmdd') and etl_dt >= trunc(to_date('${batch_date}','yyyymmdd'),'mm');" \
        ...
        file="${iel_data_path}/hdws_iml_evt_dpst_open_colse_dtl_m.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes