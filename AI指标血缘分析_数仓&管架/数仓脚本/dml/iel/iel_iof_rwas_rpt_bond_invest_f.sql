...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iof_rwas_rpt_bond_invest_f
CreateDate: 20260127
FileName:   ${iel_data_path}/rwas_rpt_bond_invest.f.${batch_date}.dat
IF_mark:    f
Logs:
' \
        query="select
...
from ${iol_schema}.rwas_rpt_bond_invest t1
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/rwas_rpt_bond_invest.f.${batch_date}.dat" \
        charset=utf8
        safe=yes
