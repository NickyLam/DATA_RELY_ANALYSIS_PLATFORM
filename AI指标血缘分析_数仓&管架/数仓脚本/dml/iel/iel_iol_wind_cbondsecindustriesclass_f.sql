...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_wind_cbondsecindustriesclass_f
CreateDate: 20180529
FileName:   ${iel_data_path}/wind_cbondsecindustriesclass.f.${batch_date}.dat
IF_mark:    f
Logs:
...
from iol.wind_cbondsecindustriesclass t
where etl_dt =to_date('${batch_date}','yyyymmdd');
" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/wind_cbondsecindustriesclass.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes