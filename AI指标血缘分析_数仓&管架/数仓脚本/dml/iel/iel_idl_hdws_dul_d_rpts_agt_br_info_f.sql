...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_hdws_dul_d_rpts_agt_br_info_f
CreateDate: 20180529
FileName:   ${iel_data_path}/hdws_dul_d_rpts_agt_br_info.f.${batch_date}.dat
IF_mark:    f
Logs:
...
,replace(replace(t1.payer_pty_id,chr(13),''),chr(10),'') as payer_pty_id
...
from ${idl_schema}.hdws_dul_d_rpts_agt_br_info t1
where etl_dt = to_date('${batch_date}','yyyymmdd');" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/hdws_dul_d_rpts_agt_br_info.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes