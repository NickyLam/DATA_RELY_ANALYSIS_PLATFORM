...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_wind_hkgsdbalancesheet_a1
CreateDate: 20180529
FileName:   ${iel_data_path}/wind_hkgsdbalancesheet.a.${batch_date}.dat
IF_mark:    a
Logs:
...
" \
        ...
        file="${iel_data_path}/wind_hkgsdbalancesheet.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes