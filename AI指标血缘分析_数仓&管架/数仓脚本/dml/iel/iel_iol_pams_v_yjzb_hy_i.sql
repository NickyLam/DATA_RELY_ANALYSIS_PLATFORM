...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_pams_v_yjzb_hy_i
CreateDate: 20250620
FileName:   ${iel_data_path}/pams_v_yjzb_hy.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where t1.tjrq = '${batch_date}'" \
        ...
        file="${iel_data_path}/pams_v_yjzb_hy.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
