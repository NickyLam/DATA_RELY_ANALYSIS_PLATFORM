...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_bkcp_check_tran_flow_a
CreateDate: 20180529
FileName:   ${iel_data_path}/evt_bkcp_check_tran_flow.a.${batch_date}.dat
IF_mark:    a
Logs:
...
from iml.evt_bkcp_check_tran_flow t1
where t1.check_entry_dt >= to_date('20200301','yyyymmdd') and t1.check_entry_dt <= to_date('20200924','yyyymmdd')
" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/evt_bkcp_check_tran_flow.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes