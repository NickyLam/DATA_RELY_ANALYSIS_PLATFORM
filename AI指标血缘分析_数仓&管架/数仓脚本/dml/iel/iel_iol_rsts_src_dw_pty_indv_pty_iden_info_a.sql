...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_rsts_src_dw_pty_indv_pty_iden_info_a
CreateDate: 20241014
FileName:   ${iel_data_path}/rsts_src_dw_pty_indv_pty_iden_info.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where etl_dt <= to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/rsts_src_dw_pty_indv_pty_iden_info.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
