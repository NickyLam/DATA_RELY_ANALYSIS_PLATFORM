...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_icl_cmm_pbc_pass_tran_flow_m_i
CreateDate: 20221122
FileName:   ${iel_data_path}/cmm_pbc_pass_tran_flow_m.i.${batch_date}.dat
IF_mark:    m_i
Logs:
' \
        query="select
...
where to_char(tran_dt,'yyyymm') = to_char(to_date('${batch_date}','yyyymmdd'),'yyyymm')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/cmm_pbc_pass_tran_flow_m.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
