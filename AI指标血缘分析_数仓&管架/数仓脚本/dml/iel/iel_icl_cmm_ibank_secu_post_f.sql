...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_icl_cmm_ibank_secu_post_f
CreateDate: 20240424
FileName:   ${iel_data_path}/cmm_ibank_secu_post.f.${batch_date}.dat
IF_mark:    f
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/cmm_ibank_secu_post.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
