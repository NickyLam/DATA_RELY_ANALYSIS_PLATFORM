...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iof_mpcs_a1xdztransjour_sxf_i
CreateDate: 20260407
FileName:   ${iel_data_path}/mpcs_a1xdztransjour_sxf.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/mpcs_a1xdztransjour_sxf.i.${batch_date}.dat" \
        charset=utf8
        safe=yes
