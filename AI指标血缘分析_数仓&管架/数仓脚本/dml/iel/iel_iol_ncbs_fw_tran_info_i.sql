...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_ncbs_fw_tran_info_i
CreateDate: 20230302
FileName:   ${iel_data_path}/ncbs_fw_tran_info.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
from ${iol_schema}.ncbs_fw_tran_info t1
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/ncbs_fw_tran_info.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
