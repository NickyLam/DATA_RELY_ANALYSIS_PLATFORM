...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_retl_loan_acct_tran_dtl_i
CreateDate: 20180529
FileName:   ${iel_data_path}/evt_retl_loan_acct_tran_dtl.i.${batch_date}.dat
IF_mark:    i
Logs:
...
from iml.evt_retl_loan_acct_tran_dtl t 
  where t.acct_dt = to_date('${batch_date}','yyyymmdd') " \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/evt_retl_loan_acct_tran_dtl.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes