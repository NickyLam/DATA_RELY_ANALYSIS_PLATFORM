...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_hdws_dul_d_rpts_agt_loan_plan_repay_01_f
CreateDate: 20180529
FileName:   ${iel_data_path}/hdws_dul_d_rpts_agt_loan_plan_repay_01.f.${batch_date}.dat
IF_mark:    f
Logs:
...
from ${idl_schema}.hdws_dul_d_rpts_agt_loan_plan_repay_01 t1 
where etl_dt = to_date('${batch_date}','yyyymmdd')-1;" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/hdws_dul_d_rpts_agt_loan_plan_repay_01.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes