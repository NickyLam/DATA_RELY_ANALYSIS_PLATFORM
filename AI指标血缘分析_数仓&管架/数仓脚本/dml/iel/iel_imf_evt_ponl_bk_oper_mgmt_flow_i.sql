...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_imf_evt_ponl_bk_oper_mgmt_flow_i
CreateDate: 20240809
FileName:   ${iel_data_path}/evt_ponl_bk_oper_mgmt_flow.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
from ${iml_schema}.evt_ponl_bk_oper_mgmt_flow t1
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/evt_ponl_bk_oper_mgmt_flow.i.${batch_date}.dat" \
        charset=utf8
        safe=yes
