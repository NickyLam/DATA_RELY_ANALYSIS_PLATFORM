...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_hdws_iml_pty_corp_party_info_f
CreateDate: 20180529
FileName:   ${iel_data_path}/hdws_iml_pty_corp_party_info.f.${batch_date}.dat
IF_mark:    f
Logs:
...
,data_src_cd
,del_flg
,NVL2(t1.data_src_cd,'PTY_CORP_PARTY_INFO'||'_'||DECODE(T1.DATA_SRC_CD,'LHWD',UPPER(SUBSTR(T1.JOB_CD,1,4)),T1.DATA_SRC_CD),'PTY_CORP_PARTY_INFO') as etl_task_name
,self_cert_decl_flg
,rvn_resd_iden_cd
,rvn_org_typ_cd
,rvn_resd_en_name
...
where etl_dt = to_date('${batch_date}','yyyymmdd');" \
        ...
        file="${iel_data_path}/hdws_iml_pty_corp_party_info.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes