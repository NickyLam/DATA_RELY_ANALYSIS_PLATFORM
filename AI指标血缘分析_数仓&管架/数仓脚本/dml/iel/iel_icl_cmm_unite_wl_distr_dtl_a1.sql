...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_icl_cmm_unite_wl_distr_dtl_a1
CreateDate: 20241119
...
where t1.etl_dt between to_date('${batch_date}','yyyymmdd')-1 - 365 and to_date('${batch_date}','yyyymmdd')-1; " \
