...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_hdws_dul_d_ccrm_pty_corp_pty_addr_info_f
CreateDate: 20180529
FileName:   ${iel_data_path}/hdws_dul_d_ccrm_pty_corp_pty_addr_info.f.${batch_date}.dat
IF_mark:    f
Logs:
...
from idl.hdws_dul_d_ccrm_pty_corp_pty_addr_info 
where to_date(${batch_date},'yyyymmdd') = etl_dt;" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/hdws_dul_d_ccrm_pty_corp_pty_addr_info.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes