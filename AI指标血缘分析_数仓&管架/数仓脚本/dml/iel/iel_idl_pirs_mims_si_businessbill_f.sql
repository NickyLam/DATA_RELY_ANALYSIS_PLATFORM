...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_pirs_mims_si_businessbill_f
CreateDate: 20180529
FileName:   ${iel_data_path}/pirs_mims_si_businessbill.f.${batch_date}.dat
IF_mark:    f
Logs:
...
,'' as data_date
from ${iol_schema}.mims_si_businessbill t1
where t1.start_dt <= to_date('${batch_date}','yyyymmdd') and t1.end_dt > to_date('${batch_date}','yyyymmdd');" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/pirs_mims_si_businessbill.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes