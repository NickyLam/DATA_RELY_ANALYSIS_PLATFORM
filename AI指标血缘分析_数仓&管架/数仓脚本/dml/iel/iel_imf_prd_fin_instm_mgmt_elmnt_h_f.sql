...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_imf_prd_fin_instm_mgmt_elmnt_h_f
CreateDate: 20250822
...
,replace(replace(t1.spv_vector_type_code,chr(13),''),chr(10),'') as spv_vector_type_code
,replace(replace(t1.spv_vector_name,chr(13),''),chr(10),'') as spv_vector_name
