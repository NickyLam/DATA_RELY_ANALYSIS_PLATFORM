...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_bill_redcst_exp_redem_batch_a
CreateDate: 20230602
FileName:   ${iel_data_path}/evt_bill_redcst_exp_redem_batch.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where start_dt <= to_date('${batch_date}','yyyymmdd') and end_dt > to_date('${batch_date}','yyyymmdd') " \
        ...
        file="${iel_data_path}/evt_bill_redcst_exp_redem_batch.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
