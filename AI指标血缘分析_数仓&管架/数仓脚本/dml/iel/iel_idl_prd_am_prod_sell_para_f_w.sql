...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_prd_am_prod_sell_para_f_w
CreateDate: 20180529
FileName:   ${iel_data_path}/prd_am_prod_sell_para_w.f.${batch_date}.dat
IF_mark:    f_w
Logs:
...
from ${idl_schema}.prd_am_prod_sell_para t1 
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/prd_am_prod_sell_para_w.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes