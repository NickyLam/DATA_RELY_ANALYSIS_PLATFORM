...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iof_icms_tmp_ncbs_lpdc_info_i
CreateDate: 20231025
FileName:   ${iel_data_path}/icms_tmp_ncbs_lpdc_info.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/icms_tmp_ncbs_lpdc_info.i.${batch_date}.dat" \
        charset=utf8
        safe=yes
