...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_pams_jxbb_zjywsrmx_i
CreateDate: 20260228
FileName:   ${iel_data_path}/pams_jxbb_zjywsrmx.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
from ${iol_schema}.pams_jxbb_zjywsrmx t1
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/pams_jxbb_zjywsrmx.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
