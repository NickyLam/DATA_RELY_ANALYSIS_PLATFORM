...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_hdws_dul_d_rpts_c_sub_coa_mild_sum_f
CreateDate: 20180529
FileName:   ${iel_data_path}/hdws_dul_d_rpts_c_sub_coa_mild_sum.f.${batch_date}.dat
IF_mark:    f
Logs:
...
where to_char(etl_dt,'yyyymmdd') = '${batch_date}';" \
        ...
        file="${iel_data_path}/hdws_dul_d_rpts_c_sub_coa_mild_sum.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes