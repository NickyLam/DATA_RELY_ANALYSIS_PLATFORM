...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_nfss_tbtotdailyprofitloss_i
CreateDate: 20180529
...
where record_date>=to_char(to_date('${batch_date}','yyyymmdd')-14,'yyyymmdd') and record_date<='${batch_date}'" \
