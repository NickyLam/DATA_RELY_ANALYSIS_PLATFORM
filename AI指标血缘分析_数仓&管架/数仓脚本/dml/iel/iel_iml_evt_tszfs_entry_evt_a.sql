...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_tszfs_entry_evt_a
CreateDate: 20180529
FileName:   ${iel_data_path}/evt_tszfs_entry_evt.a.${batch_date}.dat
IF_mark:    a
Logs:
...
where etl_dt <= to_date('${batch_date}','yyyymmdd') and etl_dt >= to_date(substr('${batch_date}',1,6)||'01','yyyymmdd');" \
        ...
        file="${iel_data_path}/evt_tszfs_entry_evt.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes