...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_ctms_tbs_v_issuer_rating_f_w
CreateDate: 20180529
FileName:   ${iel_data_path}/ctms_tbs_v_issuer_rating_w.f.${batch_date}.dat
IF_mark:    f_w
Logs:
...
,id_mark
,etl_timestamp
from iol.ctms_tbs_v_issuer_rating
where start_dt between to_date('${batch_date}', 'yyyymmdd') - 6 and to_date('${batch_date}', 'yyyymmdd');" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/ctms_tbs_v_issuer_rating_w.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes