...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_accti_midgrod_acct_ety_a
CreateDate: 20231013
FileName:   ${iel_data_path}/evt_accti_midgrod_acct_ety.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where etl_dt <= to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/evt_accti_midgrod_acct_ety.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
