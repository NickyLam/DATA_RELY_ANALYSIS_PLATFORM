...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_icf_cmm_dep_acct_tran_dtl_attach_info_i
CreateDate: 20251217
FileName:   ${iel_data_path}/cmm_dep_acct_tran_dtl_attach_info.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/cmm_dep_acct_tran_dtl_attach_info.i.${batch_date}.dat" \
        charset=utf8
        safe=yes
