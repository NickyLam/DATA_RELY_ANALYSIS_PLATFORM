...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_ponl_bk_authen_flow_f
CreateDate: 20230512
FileName:   ${iel_data_path}/evt_ponl_bk_authen_flow.f.${batch_date}.dat
IF_mark:    f
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/evt_ponl_bk_authen_flow.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
