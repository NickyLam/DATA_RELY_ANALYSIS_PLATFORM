...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_wind_shiborprices_i_w
CreateDate: 20180529
FileName:   ${iel_data_path}/wind_shiborprices_w.i.${batch_date}.dat
IF_mark:    i_w
Logs:
...
,etl_dt
,etl_timestamp
from  ${iol_schema}.wind_shiborprices
where etl_dt between to_date('${batch_date}', 'yyyymmdd') - 6 and to_date('${batch_date}', 'yyyymmdd');" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/wind_shiborprices_w.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes