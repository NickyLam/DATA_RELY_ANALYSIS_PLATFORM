...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iof_icps_afa_jzck_accounts_i
CreateDate: 20241028
FileName:   ${iel_data_path}/icps_afa_jzck_accounts.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/icps_afa_jzck_accounts.i.${batch_date}.dat" \
        charset=utf8
        safe=yes
