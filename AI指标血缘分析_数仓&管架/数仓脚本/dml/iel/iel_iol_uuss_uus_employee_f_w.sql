...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_uuss_uus_employee_f_w
CreateDate: 20180529
FileName:   ${iel_data_path}/uuss_uus_employee_w.f.${batch_date}.dat
IF_mark:    f_w
Logs:
...
,replace(replace(placehr,chr(10),''),chr(13),'') as placehr
,start_dt
,end_dt
,id_mark
,etl_timestamp
...
where start_dt between to_date('${batch_date}', 'yyyymmdd') - 6 and to_date('${batch_date}', 'yyyymmdd');" \
        ...
        file="${iel_data_path}/uuss_uus_employee_w.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes