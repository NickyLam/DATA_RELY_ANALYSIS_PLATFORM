...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_oass_prd_finc_f
CreateDate: 20230116
FileName:   ${iel_data_path}/oass_prd_finc.f.${batch_date}.dat
IF_mark:    f
Logs:
' \
        query="select
...
,t1.supt_buy_way_cd as supt_buy_way_cd
,t1.std_prod_id as std_prod_id
,t1.prod_id as prod_id
,t1.lp_id as lp_id

from ${idl_schema}.oass_prd_finc t1
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/oass_prd_finc.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
