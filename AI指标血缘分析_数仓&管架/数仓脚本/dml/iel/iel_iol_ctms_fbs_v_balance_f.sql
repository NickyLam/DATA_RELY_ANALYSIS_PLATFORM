...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_ctms_fbs_v_balance_f
CreateDate: 20180529
FileName:   ${iel_data_path}/ctms_fbs_v_balance.f.${batch_date}.dat
IF_mark:    f
Logs:
...
from iol.ctms_fbs_v_balance t1
where t1.start_dt<=TO_DATE('${batch_date}','yyyymmdd') and t1.end_dt>TO_DATE('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/ctms_fbs_v_balance.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes