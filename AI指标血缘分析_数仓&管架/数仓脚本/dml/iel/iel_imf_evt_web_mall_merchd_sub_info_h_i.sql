...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_imf_evt_web_mall_merchd_sub_info_h_i
CreateDate: 20180529
FileName:   ${iel_data_path}/evt_web_mall_merchd_sub_info_h.i.${batch_date}.dat
IF_mark:    i
Logs:
...
where t.start_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/evt_web_mall_merchd_sub_info_h.i.${batch_date}.dat" \
        charset=utf8
        safe=yes