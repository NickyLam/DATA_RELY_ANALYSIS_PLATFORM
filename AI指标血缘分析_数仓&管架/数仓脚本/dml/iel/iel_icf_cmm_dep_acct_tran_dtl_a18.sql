...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py 20231231 iel_icf_cmm_dep_acct_tran_dtl_a18
CreateDate: 20250715
...
where t1.etl_dt between to_date('20220101','yyyymmdd') and to_date('20231231', 'yyyymmdd') 
and t1.entry_flg = '1'; " \
