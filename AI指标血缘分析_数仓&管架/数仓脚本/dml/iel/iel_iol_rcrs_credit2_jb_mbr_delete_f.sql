...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_rcrs_credit2_jb_mbr_delete_f
CreateDate: 20180529
FileName:   ${iel_data_path}/rcrs_credit2_jb_mbr_delete.f.${batch_date}.dat
IF_mark:    f
Logs:
...
' \
    ...
    ,t.infsurccode as infsurccode
    ,replace(replace(t.create_time,chr(13),''),chr(10),'') as create_time
from iol.rcrs_credit2_jb_mbr_delete t
where  t.etl_dt = to_date('${batch_date}','yyyymmdd') " \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/rcrs_credit2_jb_mbr_delete.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes