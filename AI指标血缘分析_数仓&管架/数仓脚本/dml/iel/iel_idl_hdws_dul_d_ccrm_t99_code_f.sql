...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_hdws_dul_d_ccrm_t99_code_f
CreateDate: 20180529
FileName:   ${iel_data_path}/hdws_dul_d_ccrm_t99_code.f.${batch_date}.dat
IF_mark:    f
Logs:
...
where 1=1;" \
        ...
        file="${iel_data_path}/hdws_dul_d_ccrm_t99_code.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes