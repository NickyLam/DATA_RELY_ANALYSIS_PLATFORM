...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iof_amls_t00_user_a
CreateDate: 20241126
FileName:   ${iel_data_path}/amls_t00_user.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where 1=1" \
        ...
        file="${iel_data_path}/amls_t00_user.a.${batch_date}.dat" \
        charset=utf8
        safe=yes
