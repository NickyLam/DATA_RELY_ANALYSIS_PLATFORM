...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_cqss_i_r_afterpaybusiness_a
CreateDate: 20241107
FileName:   ${iel_data_path}/cqss_i_r_afterpaybusiness.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where to_char(crt_dt_tm,'yyyymmdd') <= '${batch_date}' " \
        ...
        file="${iel_data_path}/cqss_i_r_afterpaybusiness.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
