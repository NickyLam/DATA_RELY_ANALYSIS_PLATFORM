...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_aml_cmm_pbc_pass_tran_flow_i
CreateDate: 20180529
FileName:   ${iel_data_path}/aml_cmm_pbc_pass_tran_flow.i.${batch_date}.dat
IF_mark:    i
Logs:
...
,vtual_open_acct_org_id from idl.aml_cmm_pbc_pass_tran_flow where etl_dt =to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/aml_cmm_pbc_pass_tran_flow.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes