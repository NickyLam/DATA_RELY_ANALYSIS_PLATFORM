...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_ref_curr_cd_f
CreateDate: 20180529
FileName:   ${iel_data_path}/ref_curr_cd.f.${batch_date}.dat
IF_mark:    f
Logs:
...
from ${iml_schema}.ref_curr_cd t1
where 1=1;" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/ref_curr_cd.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes