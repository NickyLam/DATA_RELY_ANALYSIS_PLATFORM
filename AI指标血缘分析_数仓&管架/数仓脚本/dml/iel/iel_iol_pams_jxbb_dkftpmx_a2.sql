...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_pams_jxbb_dkftpmx_a2
CreateDate: 20250516
...
where (etl_dt between to_date('20250501','yyyymmdd') and to_date('20250531','yyyymmdd')) or (etl_dt between to_date('20231201','yyyymmdd') and to_date('20251130','yyyymmdd') and etl_dt = last_day(etl_dt))" \
