...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idf_aml_icps_afa_jzck_documents_a
CreateDate: 20241029
FileName:   ${iel_data_path}/aml_icps_afa_jzck_documents.a.${batch_date}.dat
IF_mark:    a
Logs:
...
where t1.workdate between '20240101' and '${batch_date}'; "\
        ...
        file="${iel_data_path}/aml_icps_afa_jzck_documents.a.${batch_date}.dat" \
        charset=utf8
        safe=yes