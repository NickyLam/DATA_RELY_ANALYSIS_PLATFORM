...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_icf_cmm_dep_acct_tran_dtl_a20
CreateDate: 20250715
...
where t1.etl_dt between to_date('20250101','yyyymmdd') and to_date('${batch_date}', 'yyyymmdd') 
and t1.entry_flg = '1'; " \
