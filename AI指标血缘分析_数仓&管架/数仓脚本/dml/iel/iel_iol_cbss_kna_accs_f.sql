...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_cbss_kna_accs_f
CreateDate: 20180529
FileName:   ${iel_data_path}/cbss_kna_accs.f.${batch_date}.dat
IF_mark:    f
Logs:
...
where start_dt <= to_date('${batch_date}','yyyymmdd') and end_dt > to_date('${batch_date}','yyyymmdd');" \
        ...
        file="${iel_data_path}/cbss_kna_accs.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes