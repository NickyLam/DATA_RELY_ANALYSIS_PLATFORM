...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idf_evt_mercht_clear_batch_dtl_i
CreateDate: 20251107
FileName:   ${iel_data_path}/evt_mercht_clear_batch_dtl.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where etl_dt <= to_date('${batch_date}','yyyymmdd')-1" \
        ...
        file="${iel_data_path}/evt_mercht_clear_batch_dtl.a.${batch_date}.dat" \
        charset=utf8
        safe=yes
