...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_cqss_i_r_latest24monthpaymentstate_i
CreateDate: 20241107
FileName:   ${iel_data_path}/cqss_i_r_latest24monthpaymentstate.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
from ${iol_schema}.cqss_i_r_latest24monthpaymentstate t1
where to_char(crt_dt_tm,'yyyymmdd') = '${batch_date}' " \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/cqss_i_r_latest24monthpaymentstate.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
