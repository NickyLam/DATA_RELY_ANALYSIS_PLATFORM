...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_atmp_unionpay_tran_flow_m_i
CreateDate: 20180529
FileName:   ${iel_data_path}/evt_atmp_unionpay_tran_flow_m.i.${batch_date}.dat
IF_mark:    m_i
Logs:
...
where to_char(etl_dt,'yyyymm') = to_char(to_date('${batch_date}','yyyymmdd'),'yyyymm') " \
        ...
        file="${iel_data_path}/evt_atmp_unionpay_tran_flow_m.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes