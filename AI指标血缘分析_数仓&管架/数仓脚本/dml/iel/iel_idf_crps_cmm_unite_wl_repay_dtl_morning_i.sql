...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idf_crps_cmm_unite_wl_repay_dtl_morning_i
CreateDate: 20180529
FileName:   ${iel_data_path}/crps_cmm_unite_wl_repay_dtl_morning.i.${batch_date}.dat
IF_mark:    i
Logs:
...
from ${idl_schema}.crps_cmm_unite_wl_repay_dtl t1
where etl_dt = to_date('${batch_date}','yyyymmdd');" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/crps_cmm_unite_wl_repay_dtl_morning.i.${batch_date}.dat" \
        charset=utf8
        safe=yes