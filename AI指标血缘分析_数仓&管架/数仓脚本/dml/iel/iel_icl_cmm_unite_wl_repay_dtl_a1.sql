...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_icl_cmm_unite_wl_repay_dtl_a1
CreateDate: 20240326
...
where etl_dt <= to_date('${batch_date}','yyyymmdd')-1 and etl_dt >= to_date('20210101','yyyymmdd')" \
