...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_hdws_dul_d_opr_nsd_bank_corp_stmt_a
CreateDate: 20180529
FileName:   ${iel_data_path}/hdws_dul_d_opr_nsd_bank_corp_stmt.a.${batch_date}.dat
IF_mark:    a
Logs:
...
from dml.d_opr_nsd_bank_corp_stmt@tmp_hdwdb t1
where etl_dt >= to_date('20210101','yyyymmdd') and  DEL_FLG='0';" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/hdws_dul_d_opr_nsd_bank_corp_stmt.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes