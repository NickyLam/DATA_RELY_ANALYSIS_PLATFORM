...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_os_priv_serv_bus_flow_a
CreateDate: 20180529
FileName:   ${iel_data_path}/evt_os_priv_serv_bus_flow.a.${batch_date}.dat
IF_mark:    a
Logs:
...
where t.etl_dt >= to_date('20201201','yyyymmdd') and t.etl_dt <= to_date('${batch_date}','yyyymmdd') " \
        ...
        file="${iel_data_path}/evt_os_priv_serv_bus_flow.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes