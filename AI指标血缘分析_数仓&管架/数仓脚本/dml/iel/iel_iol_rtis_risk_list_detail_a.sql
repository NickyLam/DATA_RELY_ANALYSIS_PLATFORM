...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_rtis_risk_list_detail_a
CreateDate: 20240704
FileName:   ${iel_data_path}/rtis_risk_list_detail.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where etl_dt <= to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/rtis_risk_list_detail.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
