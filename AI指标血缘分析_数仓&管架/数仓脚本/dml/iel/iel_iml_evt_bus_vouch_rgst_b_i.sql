...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_bus_vouch_rgst_b_i
CreateDate: 20240321
FileName:   ${iel_data_path}/evt_bus_vouch_rgst_b.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/evt_bus_vouch_rgst_b.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
