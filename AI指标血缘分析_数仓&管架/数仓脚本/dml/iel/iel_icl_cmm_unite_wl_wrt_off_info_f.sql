...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_icl_cmm_unite_wl_wrt_off_info_f
CreateDate: 20180529
FileName:   ${iel_data_path}/cmm_unite_wl_wrt_off_info.f.${batch_date}.dat
IF_mark:    f
Logs:
...
from ${icl_schema}.cmm_unite_wl_wrt_off_info t1
where etl_dt = to_date('${batch_date}','yyyymmdd')-1;" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/cmm_unite_wl_wrt_off_info.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes