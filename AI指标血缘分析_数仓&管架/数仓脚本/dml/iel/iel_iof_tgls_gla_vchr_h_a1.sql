...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iof_tgls_gla_vchr_h_a1
CreateDate: 20240927
...
where etl_dt between last_day(add_months(to_date('${batch_date}','yyyymmdd'),-6)) and to_date('${batch_date}','yyyymmdd'); " \
