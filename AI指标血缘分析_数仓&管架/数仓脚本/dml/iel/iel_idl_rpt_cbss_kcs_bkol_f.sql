...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_rpt_cbss_kcs_bkol_f
CreateDate: 20180529
FileName:   ${iel_data_path}/rpt_cbss_kcs_bkol.f.${batch_date}.dat
IF_mark:    f
Logs:
...
where t1.start_dt <= to_date('${batch_date}','yyyymmdd') and t1.end_dt > to_date('${batch_date}','yyyymmdd');" \
        ...
        file="${iel_data_path}/rpt_cbss_kcs_bkol.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes