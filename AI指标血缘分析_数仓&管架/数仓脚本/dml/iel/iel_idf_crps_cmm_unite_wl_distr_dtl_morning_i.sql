...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idf_crps_cmm_unite_wl_distr_dtl_morning_i
CreateDate: 20251229
FileName:   ${iel_data_path}/crps_cmm_unite_wl_distr_dtl_morning.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
,replace(replace(t1.recvbl_num_bank_num,chr(13),''),chr(10),'') as recvbl_num_bank_num
,replace(replace(t1.recvbl_num_bank_name,chr(13),''),chr(10),'') as recvbl_num_bank_name

from ${icl_schema}.cmm_unite_wl_distr_dtl t1
where etl_dt = to_date('${batch_date}','yyyymmdd');" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/crps_cmm_unite_wl_distr_dtl_morning.i.${batch_date}.dat" \
        charset=utf8
        safe=yes
