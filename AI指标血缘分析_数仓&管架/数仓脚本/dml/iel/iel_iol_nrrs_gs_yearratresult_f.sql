...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_nrrs_gs_yearratresult_f
CreateDate: 20230904
FileName:   ${iel_data_path}/nrrs_gs_yearratresult.f.${batch_date}.dat
IF_mark:    f
Logs:
' \
        query="select
...
where start_dt <= to_date('${batch_date}','yyyymmdd') and end_dt > to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/nrrs_gs_yearratresult.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
