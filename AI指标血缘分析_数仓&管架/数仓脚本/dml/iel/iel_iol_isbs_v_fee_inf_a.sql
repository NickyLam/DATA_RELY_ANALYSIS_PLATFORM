...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_isbs_v_fee_inf_a
CreateDate: 20231110
FileName:   ${iel_data_path}/isbs_v_fee_inf.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where etl_dt <= to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/isbs_v_fee_inf.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
