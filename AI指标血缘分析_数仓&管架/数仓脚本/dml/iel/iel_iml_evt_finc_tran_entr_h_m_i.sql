...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_finc_tran_entr_h_m_i
CreateDate: 20180529
FileName:   ${iel_data_path}/evt_finc_tran_entr_h_m.i.${batch_date}.dat
IF_mark:    m_i
Logs:
...
where to_char(start_dt,'yyyymm') = to_char(to_date('${batch_date}','yyyymmdd'),'yyyymm')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/evt_finc_tran_entr_h_m.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes