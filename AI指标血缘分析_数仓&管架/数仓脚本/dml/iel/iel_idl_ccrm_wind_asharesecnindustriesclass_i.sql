...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_ccrm_wind_asharesecnindustriesclass_i
CreateDate: 20180529
FileName:   ${iel_data_path}/ccrm_wind_asharesecnindustriesclass.i.${batch_date}.dat
IF_mark:    i
Logs:
...
,'' as opmode
from ${iol_schema}.wind_asharesecnindustriesclass t1
where etl_dt = to_date('${batch_date}','yyyymmdd');" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/ccrm_wind_asharesecnindustriesclass.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes