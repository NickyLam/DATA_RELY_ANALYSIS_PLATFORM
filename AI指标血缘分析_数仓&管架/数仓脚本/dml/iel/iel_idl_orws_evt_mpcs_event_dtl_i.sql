...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_orws_evt_mpcs_event_dtl_i
CreateDate: 20221228
FileName:   ${iel_data_path}/orws_evt_mpcs_event_dtl.i.${batch_date}.dat
IF_mark:    i
Logs:
   Sundexin
' \
