...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_rcrs_credit_origcreditorinfsgmt_f
CreateDate: 20180529
FileName:   ${iel_data_path}/rcrs_credit_origcreditorinfsgmt.f.${batch_date}.dat
IF_mark:    f
Logs:
...
from iol.rcrs_credit_origcreditorinfsgmt    t
  where t.etl_dt = to_date('${batch_date}','yyyymmdd') " \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/rcrs_credit_origcreditorinfsgmt.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes