...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_non_red_tax_info_tax_info_fund_a1
CreateDate: 20180529
FileName:   ${iel_data_path}/non_red_tax_info_tax_info_fund.i.${batch_date}.dat
IF_mark:    i
Logs:
...
from ${idl_schema}.non_red_tax_info_tax_info_fund t1
where etl_dt = to_date('${batch_date}','yyyymmdd');" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/non_red_tax_info_tax_info_fund.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes