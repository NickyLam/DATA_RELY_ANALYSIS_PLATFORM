...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_icrm_evt_ibank_tran_i
CreateDate: 20180529
FileName:   ${iel_data_path}/icrm_evt_ibank_tran.i.${batch_date}.dat
IF_mark:    i
Logs:
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/icrm_evt_ibank_tran.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes