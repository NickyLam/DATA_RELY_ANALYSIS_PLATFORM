...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_imf_evt_finc_tran_cfm_i
CreateDate: 20180529
FileName:   ${iel_data_path}/evt_finc_tran_cfm.i.${batch_date}.dat
IF_mark:    i
Logs:
...
where t1.cfm_dt = to_date('${batch_date}','yyyymmdd');" \
        ...
        file="${iel_data_path}/evt_finc_tran_cfm.i.${batch_date}.dat" \
        charset=utf8
        safe=yes