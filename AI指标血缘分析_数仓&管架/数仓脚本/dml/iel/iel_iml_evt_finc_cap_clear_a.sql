...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_finc_cap_clear_a
CreateDate: 20180529
FileName:   ${iel_data_path}/evt_finc_cap_clear.a.${batch_date}.dat
IF_mark:    a
Logs:
   zjj 2018-07-27 create template
' \
        query="select 
t1.clear_dt as etl_dt 
...
from iml.evt_finc_cap_clear t1 
where t1.clear_dt >= to_date('20201201','yyyymmdd') and t1.clear_dt <= to_date('${batch_date}','yyyymmdd') " \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/evt_finc_cap_clear.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes