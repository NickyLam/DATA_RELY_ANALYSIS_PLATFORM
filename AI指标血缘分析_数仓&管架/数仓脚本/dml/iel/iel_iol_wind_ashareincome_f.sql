...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_wind_ashareincome_f
CreateDate: 20240715
FileName:   ${iel_data_path}/wind_ashareincome.f.${batch_date}.dat
IF_mark:    f
Logs:
...
,t.ebit as ebit
,t.ebitda as ebitda
,t.net_profit_after_ded_nr_lp as net_profit_after_ded_nr_lp
,t.net_profit_under_intl_acc_sta as net_profit_under_intl_acc_sta
...
from iol.wind_ashareincome t
where etl_dt <=to_date('${batch_date}','yyyymmdd');
" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/wind_ashareincome.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes