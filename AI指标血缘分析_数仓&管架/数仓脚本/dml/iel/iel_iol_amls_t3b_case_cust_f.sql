...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_amls_t3b_case_cust_f
CreateDate: 20180529
FileName:   ${iel_data_path}/amls_t3b_case_cust.f.${batch_date}.dat
IF_mark:    f
Logs:
...
from iol.amls_t3b_case_cust t
  where t.etl_dt = to_date('${batch_date}','yyyymmdd') " \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/amls_t3b_case_cust.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes