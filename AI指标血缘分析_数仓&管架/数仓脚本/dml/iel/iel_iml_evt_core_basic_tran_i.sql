...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_core_basic_tran_i
CreateDate: 20180529
FileName:   ${iel_data_path}/evt_core_basic_tran.i.${batch_date}.dat
IF_mark:    i
Logs:
...
from iml.evt_core_basic_tran t
  where t.tran_dt = to_date('${batch_date}','yyyymmdd') " \
        ...
        file="${iel_data_path}/evt_core_basic_tran.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes