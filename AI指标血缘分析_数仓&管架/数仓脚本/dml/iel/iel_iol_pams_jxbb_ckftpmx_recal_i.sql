...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_pams_jxbb_ckftpmx_recal_i
CreateDate: 20250829
FileName:   ${iel_data_path}/pams_jxbb_ckftpmx_recal.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
,ydshrq
,replace(replace(t1.sjssjgdh,chr(13),''),chr(10),'') as sjssjgdh
,zhjrjye
,recal_dt
,xhczhll

from ${iol_schema}.pams_jxbb_ckftpmx_recal t1
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/pams_jxbb_ckftpmx_recal.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
