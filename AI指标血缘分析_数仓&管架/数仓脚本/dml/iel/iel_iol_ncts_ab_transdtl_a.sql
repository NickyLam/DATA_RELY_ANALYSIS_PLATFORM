...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_ncts_ab_transdtl_a
CreateDate: 20180529
FileName:   ${iel_data_path}/ncts_ab_transdtl.a.${batch_date}.dat
IF_mark:    a
Logs:
...
where 1=1 ;" \
        ...
        file="${iel_data_path}/ncts_ab_transdtl.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes