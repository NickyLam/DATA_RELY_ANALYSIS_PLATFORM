...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_tmrs_hdws_iml_pty_indv_party_info_f
CreateDate: 20180529
FileName:   ${iel_data_path}/tmrs_hdws_iml_pty_indv_party_info.f.${batch_date}.dat
IF_mark:    f
Logs:
...
from ${idl_schema}.hdws_iml_pty_indv_party_info t1
where etl_dt = to_date('${batch_date}','yyyymmdd');" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/tmrs_hdws_iml_pty_indv_party_info.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes