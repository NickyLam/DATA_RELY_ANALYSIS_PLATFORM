...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_rwas_rpt_mr_sa_rwa_result_i
CreateDate: 20241022
FileName:   ${iel_data_path}/rwas_rpt_mr_sa_rwa_result.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/rwas_rpt_mr_sa_rwa_result.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
