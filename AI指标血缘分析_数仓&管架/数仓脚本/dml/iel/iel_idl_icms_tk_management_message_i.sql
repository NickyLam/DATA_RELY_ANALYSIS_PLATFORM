...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_icms_tk_management_message_i
CreateDate: 20241105
FileName:   ${iel_data_path}/icms_tk_management_message.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/icms_tk_management_message.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
