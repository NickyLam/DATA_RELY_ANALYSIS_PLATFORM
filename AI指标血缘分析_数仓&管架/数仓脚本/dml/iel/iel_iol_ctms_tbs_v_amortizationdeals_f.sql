...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_ctms_tbs_v_amortizationdeals_f
CreateDate: 20221013
FileName:   ${iel_data_path}/ctms_tbs_v_amortizationdeals.f.${batch_date}.dat
IF_mark:    f
Logs:
' \
        query="select
...
,t1.amortizeamount as amortizeamount
,t1.cleanpricecost2 as cleanpricecost2
,t1.erate as erate
...
from ${iol_schema}.ctms_tbs_v_amortizationdeals t1
where start_dt <= to_date('${batch_date}','yyyymmdd') and end_dt > to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/ctms_tbs_v_amortizationdeals.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
