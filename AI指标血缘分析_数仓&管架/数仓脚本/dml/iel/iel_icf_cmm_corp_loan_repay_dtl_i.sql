...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_icf_cmm_corp_loan_repay_dtl_i
CreateDate: 20250416
FileName:   ${iel_data_path}/cmm_corp_loan_repay_dtl.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/cmm_corp_loan_repay_dtl.i.${batch_date}.dat" \
        charset=utf8
        safe=yes
