...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iof_ctms_b_bond_cost_analyse_dtl_a
CreateDate: 20250415
FileName:   ${iel_data_path}/ctms_b_bond_cost_analyse_dtl.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where etl_dt <= to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/ctms_b_bond_cost_analyse_dtl.a.${batch_date}.dat" \
        charset=utf8
        safe=yes
