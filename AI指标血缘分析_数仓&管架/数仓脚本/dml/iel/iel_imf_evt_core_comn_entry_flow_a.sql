...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_imf_evt_core_comn_entry_flow_a
CreateDate: 20250303
FileName:   ${iel_data_path}/evt_core_comn_entry_flow.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where etl_dt <= to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/evt_core_comn_entry_flow.a.${batch_date}.dat" \
        charset=utf8
        safe=yes
