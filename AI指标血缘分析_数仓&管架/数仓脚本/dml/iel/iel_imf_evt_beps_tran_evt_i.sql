...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_imf_evt_beps_tran_evt_i
CreateDate: 20230423
FileName:   ${iel_data_path}/evt_beps_tran_evt.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt <= to_date('${batch_date}','yyyymmdd') and etl_dt > to_date('${batch_date}','yyyymmdd')-15;" \
        ...
        file="${iel_data_path}/evt_beps_tran_evt.i.${batch_date}.dat" \
        charset=utf8
        safe=yes
