...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_pams_v_yjzb_jg_a
CreateDate: 20180529
FileName:   ${iel_data_path}/pams_v_yjzb_jg.a.${batch_date}.dat
IF_mark:    a
Logs:
...
,t1.khdxdh as khdxdh 
,t1.zbz as zbz 
from iol.pams_v_yjzb_jg t1 
where t1.tjrq >= '20201201' and t1.tjrq <= '${batch_date}'" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/pams_v_yjzb_jg.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes