...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_tsafebox_swi_doc_batch_a
CreateDate: 20240330
FileName:   ${iel_data_path}/evt_tsafebox_swi_doc_batch.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where etl_dt <= to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/evt_tsafebox_swi_doc_batch.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
