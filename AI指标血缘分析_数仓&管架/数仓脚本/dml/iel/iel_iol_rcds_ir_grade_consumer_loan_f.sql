...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_rcds_ir_grade_consumer_loan_f
CreateDate: 20180529
FileName:   ${iel_data_path}/rcds_ir_grade_consumer_loan.f.${batch_date}.dat
IF_mark:    f
Logs:
...
from iol.rcds_ir_grade_consumer_loan t
  where t.start_dt <= to_date('${batch_date}','yyyymmdd') and t.end_dt > to_date('${batch_date}','yyyymmdd') " \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/rcds_ir_grade_consumer_loan.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes