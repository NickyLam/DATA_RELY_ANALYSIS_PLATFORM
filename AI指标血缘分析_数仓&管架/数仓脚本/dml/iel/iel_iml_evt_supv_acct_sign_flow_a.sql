...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_supv_acct_sign_flow_a
CreateDate: 20230927
FileName:   ${iel_data_path}/evt_supv_acct_sign_flow.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where etl_dt <= to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/evt_supv_acct_sign_flow.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
