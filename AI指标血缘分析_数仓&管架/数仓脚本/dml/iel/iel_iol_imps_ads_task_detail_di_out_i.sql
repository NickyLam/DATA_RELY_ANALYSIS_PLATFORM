...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_imps_ads_task_detail_di_out_i
CreateDate: 20241220
FileName:   ${iel_data_path}/imps_ads_task_detail_di_out.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/imps_ads_task_detail_di_out.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
