...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_hdws_dul_d_rpts_evt_lpss_event_dtl_f
CreateDate: 20180529
FileName:   ${iel_data_path}/hdws_dul_d_rpts_evt_lpss_event_dtl.f.${batch_date}.dat
IF_mark:    f
Logs:
...
where to_date(${batch_date},'yyyymmdd') = etl_dt;" \
        ...
        file="${iel_data_path}/hdws_dul_d_rpts_evt_lpss_event_dtl.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes