...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_icf_cmm_dep_acct_tran_dtl_a
CreateDate: 20230822
...
where etl_dt = to_date('${batch_date}','yyyymmdd') and etl_dt >= add_months(TRUNC(to_date('${batch_date}','YYYYmmdd'),'mm'),-12) and t1.entry_flg='1';" \
