...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_rsts_rcd_ir_grade_collection_sum_i
CreateDate: 20241012
FileName:   ${iel_data_path}/rsts_rcd_ir_grade_collection_sum.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
from ${iol_schema}.rsts_rcd_ir_grade_collection_sum t1
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/rsts_rcd_ir_grade_collection_sum.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
