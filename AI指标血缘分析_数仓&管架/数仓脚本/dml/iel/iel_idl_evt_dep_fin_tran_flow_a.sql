...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_evt_dep_fin_tran_flow_a
CreateDate: 20221105
FileName:   ${iel_data_path}/evt_dep_fin_tran_flow.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where etl_dt <= to_date('${batch_date}','yyyymmdd') and etl_dt >= to_date('20230501','yyyymmdd') " \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/evt_dep_fin_tran_flow.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
