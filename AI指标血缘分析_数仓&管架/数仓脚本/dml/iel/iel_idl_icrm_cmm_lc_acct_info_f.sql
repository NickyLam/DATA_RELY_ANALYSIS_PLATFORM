...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_icrm_cmm_lc_acct_info_f
CreateDate: 20180529
FileName:   ${iel_data_path}/icrm_cmm_lc_acct_info.f.${batch_date}.dat
IF_mark:    f
Logs:
...
,cl_curr_q_avg_bal
,cl_curr_m_avg_bal
from ${idl_schema}.icrm_cmm_lc_acct_info
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/icrm_cmm_lc_acct_info.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes