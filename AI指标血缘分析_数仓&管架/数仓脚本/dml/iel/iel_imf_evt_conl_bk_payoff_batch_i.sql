...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_imf_evt_conl_bk_payoff_batch_i
CreateDate: 20241029
FileName:   ${iel_data_path}/evt_conl_bk_payoff_batch.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/evt_conl_bk_payoff_batch.i.${batch_date}.dat" \
        charset=utf8
        safe=yes
