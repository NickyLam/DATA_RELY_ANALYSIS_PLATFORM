...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_orws_cbss_kub_wkst_f
CreateDate: 20180529
FileName:   ${iel_data_path}/orws_cbss_kub_wkst.f.${batch_date}.dat
IF_mark:    f
Logs:
...
from iol.cbss_kub_wkst t 
  where t.start_dt <= to_date('${batch_date}','yyyymmdd') and t.end_dt > to_date('${batch_date}','yyyymmdd') " \
        ...
        file="${iel_data_path}/orws_cbss_kub_wkst.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes