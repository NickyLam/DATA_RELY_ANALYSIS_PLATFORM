...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_prd_am_prod_coll_amt_info_h_i
CreateDate: 20250928
FileName:   ${iel_data_path}/prd_am_prod_coll_amt_info_h.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/prd_am_prod_coll_amt_info_h.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
