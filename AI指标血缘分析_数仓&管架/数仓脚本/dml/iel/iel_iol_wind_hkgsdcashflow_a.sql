...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_wind_hkgsdcashflow_a
CreateDate: 20240430
FileName:   ${iel_data_path}/wind_hkgsdcashflow.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where etl_dt <= to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/wind_hkgsdcashflow.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
