...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iof_cqss_e_r_dbtcraccbscinf_a
CreateDate: 20250225
FileName:   ${iel_data_path}/cqss_e_r_dbtcraccbscinf.a.${batch_date}.dat
IF_mark:    a
Logs:
...
where etl_dt <= to_date('${batch_date}','yyyymmdd');" \
        ...
        file="${iel_data_path}/cqss_e_r_dbtcraccbscinf.a.${batch_date}.dat" \
        charset=utf8
        safe=yes