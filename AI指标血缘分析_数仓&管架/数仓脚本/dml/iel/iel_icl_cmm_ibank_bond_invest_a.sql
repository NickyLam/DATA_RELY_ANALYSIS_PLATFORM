...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_icl_cmm_ibank_bond_invest_a
CreateDate: 20240426
FileName:   ${iel_data_path}/cmm_ibank_bond_invest.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where etl_dt <= to_date('${batch_date}','yyyymmdd') and etl_dt >= to_date('20240101','yyyymmdd')" \
        ...
        file="${iel_data_path}/cmm_ibank_bond_invest.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
