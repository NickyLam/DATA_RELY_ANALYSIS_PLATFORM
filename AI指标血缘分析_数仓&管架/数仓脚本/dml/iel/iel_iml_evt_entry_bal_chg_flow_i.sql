...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_entry_bal_chg_flow_i
CreateDate: 20230130
FileName:   ${iel_data_path}/evt_entry_bal_chg_flow.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/evt_entry_bal_chg_flow.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
