...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_rpt_ibms_ttrd_trade_type_f
CreateDate: 20180529
FileName:   ${iel_data_path}/rpt_ibms_ttrd_trade_type.f.${batch_date}.dat
IF_mark:    f
Logs:
...
,t1.def_transfer_type as def_transfer_type
 from iol.ibms_ttrd_trade_type T1
where start_dt <= to_date('${batch_date}','yyyymmdd') and end_dt > to_date('${batch_date}','yyyymmdd');" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/rpt_ibms_ttrd_trade_type.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes