...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_icl_cmm_dep_acct_tran_dtl_a
CreateDate: 20240104
...
where t1.etl_dt <= to_date('${batch_date}','yyyymmdd') and t1.etl_dt >= to_date('20231201','yyyymmdd') and t1.entry_flg='1';" \
