...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_icf_cmm_agent_consmt_tran_dtl_a
CreateDate: 20230817
FileName:   ${iel_data_path}/cmm_agent_consmt_tran_dtl.a.${batch_date}.dat
IF_mark:    a
Logs:
   zjj 2018-07-27 create template
' \
        query="select
trunc(t1.ta_cfm_dt) as etl_dt
...
where trunc(t1.ta_cfm_dt) <= to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/cmm_agent_consmt_tran_dtl.i.${batch_date}.dat" \
        charset=utf8
        safe=yes