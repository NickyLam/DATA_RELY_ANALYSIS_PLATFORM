...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_aml_cmm_unite_wl_dubil_info_f
CreateDate: 20180529
FileName:   ${iel_data_path}/aml_cmm_unite_wl_dubil_info.f.${batch_date}.dat
IF_mark:    f
Logs:
...
,job_cd from idl.aml_cmm_unite_wl_dubil_info where etl_dt=to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/aml_cmm_unite_wl_dubil_info.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes