...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_ncbs_rb_pcp_tran_hist_i
CreateDate: 20251111
FileName:   ${iel_data_path}/ncbs_rb_pcp_tran_hist.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/ncbs_rb_pcp_tran_hist.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
