...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_pams_jxbb_tycdmx_a1
CreateDate: 20250516
FileName:   ${iel_data_path}/pams_jxbb_tycdmx.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
from ${iol_schema}.pams_jxbb_tycdmx t1
where (etl_dt between to_date('20250501','yyyymmdd') and to_date('20250531','yyyymmdd')) or (etl_dt between to_date('20231201','yyyymmdd') and to_date('20250430','yyyymmdd') and etl_dt = last_day(etl_dt))" \
        ...
        file="${iel_data_path}/pams_jxbb_tycdmx.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
