...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_icl_cmm_elec_chn_tran_dtl_a26
CreateDate: 20250103
FileName:   ${iel_data_path}/cmm_elec_chn_tran_dtl.i.${batch_date}.dat
IF_mark:    a
Logs:
...
where etl_dt <= to_date('${batch_date}','yyyymmdd');" \
        ...
        file="${iel_data_path}/cmm_elec_chn_tran_dtl.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes