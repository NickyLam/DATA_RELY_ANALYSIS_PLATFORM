...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_cqss_i_r_batch_dig_main_i
CreateDate: 20241107
FileName:   ${iel_data_path}/cqss_i_r_batch_dig_main.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where to_char(crt_dt_tm,'yyyymmdd') = '${batch_date}' " \
        ...
        file="${iel_data_path}/cqss_i_r_batch_dig_main.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
