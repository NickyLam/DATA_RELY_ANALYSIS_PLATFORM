...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idf_crps_cmm_unite_wl_loan_guar_cont_rela_morning_f
CreateDate: 20251229
FileName:   ${iel_data_path}/crps_cmm_unite_wl_loan_guar_cont_rela_morning.f.${batch_date}.dat
IF_mark:    f
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/crps_cmm_unite_wl_loan_guar_cont_rela_morning.f.${batch_date}.dat" \
        charset=utf8
        safe=yes
