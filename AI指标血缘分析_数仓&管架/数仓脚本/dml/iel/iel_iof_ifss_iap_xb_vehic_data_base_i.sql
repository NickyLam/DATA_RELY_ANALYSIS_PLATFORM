...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iof_ifss_iap_xb_vehic_data_base_i
CreateDate: 20250514
FileName:   ${iel_data_path}/ifss_iap_xb_vehic_data_base.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/ifss_iap_xb_vehic_data_base.i.${batch_date}.dat" \
        charset=utf8
        safe=yes
