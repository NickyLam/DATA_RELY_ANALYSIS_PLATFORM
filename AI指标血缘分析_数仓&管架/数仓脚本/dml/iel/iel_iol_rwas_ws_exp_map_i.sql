...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_rwas_ws_exp_map_i
CreateDate: 20230323
FileName:   ${iel_data_path}/rwas_ws_exp_map.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
from ${iol_schema}.rwas_ws_exp_map t1
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/rwas_ws_exp_map.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
