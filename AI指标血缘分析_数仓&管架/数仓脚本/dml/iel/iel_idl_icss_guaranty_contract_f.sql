...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_icss_guaranty_contract_f
CreateDate: 20180529
...
,thirdcreditparty
,thirdcreditcurrency
,thirdcreditsum from idl.icss_guaranty_contract where etl_dt =to_date('${batch_date}','yyyymmdd');" \
        field="|#|" record="0x0a"  \
