...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_cmm_indv_cust_basic_info_fund_a
CreateDate: 20180529
FileName:   ${iel_data_path}/cmm_indv_cust_basic_info_fund.a.${batch_date}.dat
IF_mark:    a
Logs:
...
,t1.corp_work_years as corp_work_years
,t1.indv_mon_inco as indv_mon_inco
,t1.indv_anl_inco as indv_anl_inco
,t1.family_mon_inco as family_mon_inco
,t1.family_anl_inco as family_anl_inco
...
,t1.curt_corp_empyt_dt as curt_corp_empyt_dt
from idl.cmm_indv_cust_basic_info_fund t1
where t1.etl_dt = to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/cmm_indv_cust_basic_info_fund.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes