...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_aml_evt_super_olbk_tran_evt_a
CreateDate: 20180529
FileName:   ${iel_data_path}/aml_evt_super_olbk_tran_evt.a.${batch_date}.dat
IF_mark:    a
Logs:
...
,esb_intfc_tran_flow_num from idl.aml_evt_super_olbk_tran_evt where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/aml_evt_super_olbk_tran_evt.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes