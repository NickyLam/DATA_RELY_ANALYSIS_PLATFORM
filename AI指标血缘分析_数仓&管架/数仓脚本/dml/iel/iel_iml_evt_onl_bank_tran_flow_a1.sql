...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_onl_bank_tran_flow_a1
CreateDate: 20240312
...
where t1.tran_dt <= to_date('${batch_date}','yyyymmdd') and t1.tran_dt >= to_date('20240101','yyyymmdd') " \
