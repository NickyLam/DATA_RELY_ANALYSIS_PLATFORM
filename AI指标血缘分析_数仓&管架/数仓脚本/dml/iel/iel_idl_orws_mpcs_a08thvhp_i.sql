...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_orws_mpcs_a08thvhp_i
CreateDate: 20180529
FileName:   ${iel_data_path}/orws_mpcs_a08thvhp.i.${batch_date}.dat
IF_mark:    i
Logs:
...
where etl_dt = to_date('${batch_date}','yyyymmdd');" \
        ...
        file="${iel_data_path}/orws_mpcs_a08thvhp.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes