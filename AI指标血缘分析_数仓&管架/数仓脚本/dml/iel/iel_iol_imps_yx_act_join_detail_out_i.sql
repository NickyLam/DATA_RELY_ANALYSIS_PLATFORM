...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_imps_yx_act_join_detail_out_i
CreateDate: 20250527
FileName:   ${iel_data_path}/imps_yx_act_join_detail_out.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/imps_yx_act_join_detail_out.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
