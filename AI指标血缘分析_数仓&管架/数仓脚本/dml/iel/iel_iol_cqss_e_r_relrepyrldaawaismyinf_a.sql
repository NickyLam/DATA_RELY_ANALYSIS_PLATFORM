...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_cqss_e_r_relrepyrldaawaismyinf_a
CreateDate: 20240827
FileName:   ${iel_data_path}/cqss_e_r_relrepyrldaawaismyinf.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where to_char(t1.crt_dt_tm,'yyyymmdd') <= '${batch_date}'" \
        ...
        file="${iel_data_path}/cqss_e_r_relrepyrldaawaismyinf.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
