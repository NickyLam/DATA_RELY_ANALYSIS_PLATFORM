...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_rpt_osbs_pbs_logon_flow_i
CreateDate: 20180529
FileName:   ${iel_data_path}/rpt_osbs_pbs_logon_flow.i.${batch_date}.dat
IF_mark:    i
Logs:
...
where t1.etl_dt =to_date('${batch_date}','yyyymmdd');" \
        ...
        file="${iel_data_path}/rpt_osbs_pbs_logon_flow.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes