...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_vtms_a01_dsout_cbss_tran_fes_detl_i
CreateDate: 20180529
FileName:   ${iel_data_path}/vtms_a01_dsout_cbss_tran_fes_detl.i.${batch_date}.dat
IF_mark:    i
Logs:
...
from ${iol_schema}.cbss_tran_fes_detl t1 
where  trandate = '${batch_date}';" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/vtms_a01_dsout_cbss_tran_fes_detl.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
