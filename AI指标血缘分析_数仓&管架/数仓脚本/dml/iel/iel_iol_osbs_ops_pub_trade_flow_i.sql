...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_osbs_ops_pub_trade_flow_i
CreateDate: 20240328
FileName:   ${iel_data_path}/osbs_ops_pub_trade_flow.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
from ${iol_schema}.osbs_ops_pub_trade_flow t1
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/osbs_ops_pub_trade_flow.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
