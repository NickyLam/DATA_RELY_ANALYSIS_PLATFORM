...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_fams_fin_open_plan_f
CreateDate: 20241120
FileName:   ${iel_data_path}/fams_fin_open_plan.f.${batch_date}.dat
IF_mark:    f
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/fams_fin_open_plan.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
