...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_hdws_dul_d_mims_coll_guar_contr_info_f
CreateDate: 20180529
FileName:   ${iel_data_path}/hdws_dul_d_mims_coll_guar_contr_info.f.${batch_date}.dat
IF_mark:    f
Logs:
...
,replace(replace(t1.biz_breed_cd,chr(13),''),chr(10),'') as biz_breed_cd
...
from ${idl_schema}.hdws_dul_d_mims_coll_guar_contr_info t1
where etl_dt = to_date('${batch_date}','yyyymmdd');" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/hdws_dul_d_mims_coll_guar_contr_info.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes