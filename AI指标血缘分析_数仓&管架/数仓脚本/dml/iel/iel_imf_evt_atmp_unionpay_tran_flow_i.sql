...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_imf_evt_atmp_unionpay_tran_flow_i
CreateDate: 20180529
...
where etl_dt between to_date('${batch_date}','yyyymmdd')-14 and to_date('${batch_date}','yyyymmdd') " \
