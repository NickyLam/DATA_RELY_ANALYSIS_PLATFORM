...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_cqss_e_r_pyfacc24esmpyfsttninf_i
CreateDate: 20180529
FileName:   ${iel_data_path}/cqss_e_r_pyfacc24esmpyfsttninf.i.${batch_date}.dat
IF_mark:    i
Logs:
...
from iol.cqss_e_r_pyfacc24esmpyfsttninf t
  where to_char(t.crt_dt_tm,'yyyymmdd')='${batch_date}' " \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/cqss_e_r_pyfacc24esmpyfsttninf.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes