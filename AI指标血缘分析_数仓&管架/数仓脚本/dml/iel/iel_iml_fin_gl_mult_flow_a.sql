...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_fin_gl_mult_flow_a
CreateDate: 20231201
FileName:   ${iel_data_path}/fin_gl_mult_flow.a.${batch_date}.dat
IF_mark:    a
Logs:
...
where etl_dt <= to_date('${batch_date}','yyyymmdd');" \
        ...
        file="${iel_data_path}/fin_gl_mult_flow.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes