...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_icms_wyd_loan_trans_detail_a
CreateDate: 20250305
FileName:   ${iel_data_path}/icms_wyd_loan_trans_detail.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where etl_dt <= to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/icms_wyd_loan_trans_detail.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
