...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_tmss_sys_user_login_log_a
CreateDate: 20260410
FileName:   ${iel_data_path}/tmss_sys_user_login_log.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where etl_dt <= to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/tmss_sys_user_login_log.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
