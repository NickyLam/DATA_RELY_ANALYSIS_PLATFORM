...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_fin_am_prod_intnal_subj_bal_a
CreateDate: 20240226
FileName:   ${iel_data_path}/fin_am_prod_intnal_subj_bal.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where etl_dt <= to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/fin_am_prod_intnal_subj_bal.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
