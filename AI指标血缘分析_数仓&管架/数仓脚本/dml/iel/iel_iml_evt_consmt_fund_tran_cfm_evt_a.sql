...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_consmt_fund_tran_cfm_evt_a
CreateDate: 20220628
FileName:   ${iel_data_path}/evt_consmt_fund_tran_cfm_evt.a.${batch_date}.dat
IF_mark:    a
Logs:
   sundexin 20220628
' \
...
where 1=1  " \
        ...
        file="${iel_data_path}/evt_consmt_fund_tran_cfm_evt.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes