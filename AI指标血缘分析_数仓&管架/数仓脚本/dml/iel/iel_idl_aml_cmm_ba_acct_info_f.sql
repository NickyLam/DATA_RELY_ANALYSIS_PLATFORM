...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_aml_cmm_ba_acct_info_f
CreateDate: 20180529
FileName:   ${iel_data_path}/aml_cmm_ba_acct_info.f.${batch_date}.dat
IF_mark:    f
Logs:
...
,etl_timestamp from idl.aml_cmm_ba_acct_info where etl_dt=to_date('${batch_date}','yyyymmdd');" \
        ...
        file="${iel_data_path}/aml_cmm_ba_acct_info.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes