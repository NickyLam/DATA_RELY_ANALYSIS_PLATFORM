...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_rwas_rwa_report_debt_info_a
CreateDate: 20230630
FileName:   ${iel_data_path}/rwas_rwa_report_debt_info.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where etl_dt <= to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/rwas_rwa_report_debt_info.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
