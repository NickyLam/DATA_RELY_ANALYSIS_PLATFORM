...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_wind_cbondanalysisshc_i_w
CreateDate: 20180529
FileName:   ${iel_data_path}/wind_cbondanalysisshc_w.i.${batch_date}.dat
IF_mark:    i_w
Logs:
...
,replace(replace(b_anal_surpluscapital,chr(10),''),chr(13),'') as b_anal_surpluscapital
...
,etl_dt
,etl_timestamp
from ${iol_schema}.wind_cbondanalysisshc
where etl_dt between to_date('${batch_date}', 'yyyymmdd') - 6 and to_date('${batch_date}', 'yyyymmdd');" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/wind_cbondanalysisshc_w.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes