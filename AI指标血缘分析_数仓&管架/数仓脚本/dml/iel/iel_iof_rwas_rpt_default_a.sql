...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iof_rwas_rpt_default_a
CreateDate: 20260306
FileName:   ${iel_data_path}/rwas_rpt_default.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where etl_dt <= to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/rwas_rpt_default.a.${batch_date}.dat" \
        charset=utf8
        safe=yes
