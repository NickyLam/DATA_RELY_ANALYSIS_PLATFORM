...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_finc_cap_clear_i_q
CreateDate: 20180529
FileName:   ${iel_data_path}/evt_finc_cap_clear_q.i.${batch_date}.dat
IF_mark:    i_q
Logs:
...
where t1.clear_dt > add_months(to_date('${batch_date}','yyyymmdd') ,-3) 
  and t1.clear_dt <= to_date('${batch_date}','yyyymmdd')
  and t1.start_dt <= to_date('${batch_date}','yyyymmdd') 
  and t1.end_dt > to_date('${batch_date}','yyyymmdd') " \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/evt_finc_cap_clear_q.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes