...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_qxb_tran_entr_h_a
CreateDate: 20180529
FileName:   ${iel_data_path}/evt_qxb_tran_entr_h.a.${batch_date}.dat
IF_mark:    a
Logs:
...
where t1.start_dt <= to_date('${batch_date}','yyyymmdd')  and t1.end_dt > to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/evt_qxb_tran_entr_h.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes