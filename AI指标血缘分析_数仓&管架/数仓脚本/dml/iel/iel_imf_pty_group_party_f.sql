...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_imf_pty_group_party_f
CreateDate: 20240802
...
,replace(replace(t1.bk_idtfy_group_cust_flg,chr(13),''),chr(10),'') as bk_idtfy_group_cust_flg
,replace(replace(t1.actl_ctrler_name,chr(13),''),chr(10),'') as actl_ctrler_name
,replace(replace(t1.actl_ctrler_cert_no,chr(13),''),chr(10),'') as actl_ctrler_cert_no
,replace(replace(t1.actl_ctrler_cert_type_cd,chr(13),''),chr(10),'') as actl_ctrler_cert_type_cd
,replace(replace(t1.actl_ctrler_cty_cd,chr(13),''),chr(10),'') as actl_ctrler_cty_cd
