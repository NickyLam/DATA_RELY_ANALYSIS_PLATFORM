...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_cabs_v_sys_clerk_oper_i
CreateDate: 20220916
FileName:   ${iel_data_path}/cabs_v_sys_clerk_oper.i.${batch_date}.dat
IF_mark:    i
Logs:
   Sundexin
' \
...
where to_char(txn_dt,'yyyymmdd')='${batch_date}'" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/cabs_v_sys_clerk_oper.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes