...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_ibms_ttrd_ftp_ratecurve_i
CreateDate: 20250612
FileName:   ${iel_data_path}/ibms_ttrd_ftp_ratecurve.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/ibms_ttrd_ftp_ratecurve.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
