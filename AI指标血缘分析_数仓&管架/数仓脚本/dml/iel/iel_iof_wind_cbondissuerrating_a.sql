...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iof_wind_cbondissuerrating_a
CreateDate: 20260402
FileName:   ${iel_data_path}/wind_cbondissuerrating.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where etl_dt <= to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/wind_cbondissuerrating.a.${batch_date}.dat" \
        charset=utf8
        safe=yes
