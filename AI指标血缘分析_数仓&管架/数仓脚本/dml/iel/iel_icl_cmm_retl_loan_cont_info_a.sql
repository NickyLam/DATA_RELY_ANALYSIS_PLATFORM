...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_icl_cmm_retl_loan_cont_info_a
CreateDate: 20180529
FileName:   ${iel_data_path}/cmm_retl_loan_cont_info.a.${batch_date}.dat
IF_mark:    a
Logs:
...
from icl.cmm_retl_loan_cont_info t
where t.etl_dt >= to_date('20201201','yyyymmdd') and t.etl_dt <= to_date('${batch_date}','yyyymmdd') " \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/cmm_retl_loan_cont_info.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes