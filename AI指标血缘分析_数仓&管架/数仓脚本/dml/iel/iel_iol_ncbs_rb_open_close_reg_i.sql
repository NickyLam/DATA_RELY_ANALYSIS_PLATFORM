...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_ncbs_rb_open_close_reg_i
CreateDate: 20231024
FileName:   ${iel_data_path}/ncbs_rb_open_close_reg.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/ncbs_rb_open_close_reg.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
