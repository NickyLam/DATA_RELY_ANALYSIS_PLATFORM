...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_icl_cmm_unite_wl_distr_dtl_i
CreateDate: 20250804
FileName:   ${iel_data_path}/cmm_unite_wl_distr_dtl.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')-1;" \
        ...
        file="${iel_data_path}/cmm_unite_wl_distr_dtl.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
