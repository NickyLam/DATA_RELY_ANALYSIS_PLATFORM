...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_ccrm_wind_cbondsecindustriesclass_f
CreateDate: 20180529
FileName:   ${iel_data_path}/ccrm_wind_cbondsecindustriesclass.f.${batch_date}.dat
IF_mark:    f
Logs:
...
,'' as opmode
from ${iol_schema}.wind_cbondsecindustriesclass t1
where etl_dt = to_date('${batch_date}','yyyymmdd');" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/ccrm_wind_cbondsecindustriesclass.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes