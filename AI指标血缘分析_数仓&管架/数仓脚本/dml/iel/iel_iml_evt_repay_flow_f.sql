...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_repay_flow_f
CreateDate: 20221122
FileName:   ${iel_data_path}/evt_repay_flow.f.${batch_date}.dat
IF_mark:    f
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/evt_repay_flow.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
