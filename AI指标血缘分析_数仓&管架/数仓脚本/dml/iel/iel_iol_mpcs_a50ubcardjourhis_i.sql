...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_mpcs_a50ubcardjourhis_i
CreateDate: 20180529
FileName:   ${iel_data_path}/mpcs_a50ubcardjourhis.i.${batch_date}.dat
IF_mark:    i
Logs:
...
from ${iol_schema}.mpcs_a50ubcardjourhis t 
 where TRANSDATE >= to_char(to_date('20200930','yyyymmdd') - 15 ,'yyyymmdd');" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/mpcs_a50ubcardjourhis.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes