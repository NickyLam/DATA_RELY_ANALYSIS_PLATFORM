...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_rrps_rpt_report_result_archive_rwa_i
CreateDate: 20231107
FileName:   ${iel_data_path}/rrps_rpt_report_result_archive_rwa.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
from ${iol_schema}.rrps_rpt_report_result_archive_rwa t1
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/rrps_rpt_report_result_archive_rwa.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
