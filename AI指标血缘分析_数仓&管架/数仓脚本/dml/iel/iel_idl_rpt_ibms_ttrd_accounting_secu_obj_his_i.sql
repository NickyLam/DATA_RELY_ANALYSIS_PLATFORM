...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_rpt_ibms_ttrd_accounting_secu_obj_his_i
CreateDate: 20180529
FileName:   ${iel_data_path}/rpt_ibms_ttrd_accounting_secu_obj_his.i.${batch_date}.dat
IF_mark:    i
Logs:
...
,t1.prft_id as prft_id
,t1.deviation as deviation
,t1.prft_ir_fut_ai as prft_ir_fut_ai
from ${iol_schema}.ibms_ttrd_accounting_secu_obj_his t1 
where etl_dt = to_date('${batch_date}','yyyymmdd') and replace(beg_date,'-','')='${batch_date}' ;" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/rpt_ibms_ttrd_accounting_secu_obj_his.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes