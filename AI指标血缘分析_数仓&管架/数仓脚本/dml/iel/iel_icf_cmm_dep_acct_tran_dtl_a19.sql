...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py 20241231 iel_icf_cmm_dep_acct_tran_dtl_a19
CreateDate: 20250715
...
where t1.etl_dt between to_date('20240101','yyyymmdd') and to_date('20241231', 'yyyymmdd') 
and t1.entry_flg = '1'; " \
