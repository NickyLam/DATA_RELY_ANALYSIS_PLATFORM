...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_hdws_iml_pty_indv_pty_phys_loc_info_h_f
CreateDate: 20180529
FileName:   ${iel_data_path}/hdws_iml_pty_indv_pty_phys_loc_info_h.f.${batch_date}.dat
IF_mark:    f
Logs:
...
,NVL2(t1.data_src_cd,'PTY_INDV_PTY_PHYS_LOC_INFO_H'||'_'||DECODE(T1.DATA_SRC_CD,'LHWD',UPPER(SUBSTR(T1.JOB_CD,1,4)),T1.DATA_SRC_CD),'PTY_INDV_PTY_PHYS_LOC_INFO_H') as etl_task_name 
...
where etl_dt = to_date('${batch_date}','yyyymmdd')
  and del_flg <> '1';" \
        ...
        file="${iel_data_path}/hdws_iml_pty_indv_pty_phys_loc_info_h.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes