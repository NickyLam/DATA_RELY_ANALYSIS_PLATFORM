...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_icl_cmm_dep_oc_acct_dtl_f
CreateDate: 20250506
FileName:   ${iel_data_path}/cmm_dep_oc_acct_dtl.f.${batch_date}.dat
IF_mark:    f
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/cmm_dep_oc_acct_dtl.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
