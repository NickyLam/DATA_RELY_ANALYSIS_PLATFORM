...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_card_change_rgst_b_i_q
CreateDate: 20180529
FileName:   ${iel_data_path}/evt_card_change_rgst_b_q.i.${batch_date}.dat
IF_mark:    i_q
Logs:
...
where t1.etl_dt > add_months(to_date('${batch_date}','yyyymmdd') ,-3) and t1.etl_dt <= to_date('${batch_date}','yyyymmdd');" \
        ...
        file="${iel_data_path}/evt_card_change_rgst_b_q.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes