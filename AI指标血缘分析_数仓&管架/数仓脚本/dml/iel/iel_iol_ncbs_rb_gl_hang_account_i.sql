...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_ncbs_rb_gl_hang_account_i
CreateDate: 20230509
FileName:   ${iel_data_path}/ncbs_rb_gl_hang_account.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/ncbs_rb_gl_hang_account.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
