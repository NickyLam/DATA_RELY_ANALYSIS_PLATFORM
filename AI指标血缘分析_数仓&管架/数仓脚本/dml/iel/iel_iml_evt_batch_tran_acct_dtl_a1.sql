...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_batch_tran_acct_dtl_a1
CreateDate: 20251110
FileName:   ${iel_data_path}/evt_batch_tran_acct_dtl.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt <= to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/evt_batch_tran_acct_dtl.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
