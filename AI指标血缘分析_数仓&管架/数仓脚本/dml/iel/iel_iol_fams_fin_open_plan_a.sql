...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_fams_fin_open_plan_a
CreateDate: 20240704
FileName:   ${iel_data_path}/fams_fin_open_plan.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where 1 = 1" \
        ...
        file="${iel_data_path}/fams_fin_open_plan.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
