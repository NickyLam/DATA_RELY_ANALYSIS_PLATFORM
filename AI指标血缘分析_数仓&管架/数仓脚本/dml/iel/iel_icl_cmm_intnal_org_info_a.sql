...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_icl_cmm_intnal_org_info_a
CreateDate: 20221115
FileName:   ${iel_data_path}/cmm_intnal_org_info.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/cmm_intnal_org_info.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
