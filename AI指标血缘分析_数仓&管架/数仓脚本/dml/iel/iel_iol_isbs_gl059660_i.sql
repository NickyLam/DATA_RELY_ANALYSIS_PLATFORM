...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_isbs_gl059660_i
CreateDate: 20250604
FileName:   ${iel_data_path}/isbs_gl059660.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/isbs_gl059660.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
