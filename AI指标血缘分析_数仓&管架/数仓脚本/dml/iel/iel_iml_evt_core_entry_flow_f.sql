...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_core_entry_flow_f
CreateDate: 20180529
FileName:   ${iel_data_path}/evt_core_entry_flow.f.${batch_date}.dat
IF_mark:    f
Logs:
...
where t.etl_dt <= to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/evt_core_entry_flow.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes