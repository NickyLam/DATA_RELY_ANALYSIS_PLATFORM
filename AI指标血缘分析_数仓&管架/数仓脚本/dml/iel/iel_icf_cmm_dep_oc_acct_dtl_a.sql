...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_icf_cmm_dep_oc_acct_dtl_a
CreateDate: 20230106
FileName:   ${iel_data_path}/cmm_dep_oc_acct_dtl.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where etl_dt <= to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/cmm_dep_oc_acct_dtl.a.${batch_date}.dat" \
        charset=utf8
        safe=yes
