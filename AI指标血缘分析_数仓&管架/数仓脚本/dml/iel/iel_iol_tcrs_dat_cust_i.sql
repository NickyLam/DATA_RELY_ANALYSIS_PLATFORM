...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_tcrs_dat_cust_i
CreateDate: 20180529
FileName:   ${iel_data_path}/tcrs_dat_cust.i.${batch_date}.dat
IF_mark:    i
Logs:
...
from iol.tcrs_dat_cust t
 where start_dt = to_date('${batch_date}','yyyymmdd');" \
        ...
        file="${iel_data_path}/tcrs_dat_cust.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes