...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iof_amls_t00_user_f
CreateDate: 20241126
FileName:   ${iel_data_path}/amls_t00_user.f.${batch_date}.dat
IF_mark:    f
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/amls_t00_user.f.${batch_date}.dat" \
        charset=utf8
        safe=yes
