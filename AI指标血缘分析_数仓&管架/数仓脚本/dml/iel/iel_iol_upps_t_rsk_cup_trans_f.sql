...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_upps_t_rsk_cup_trans_f
CreateDate: 20180529
FileName:   ${iel_data_path}/upps_t_rsk_cup_trans.f.${batch_date}.dat
IF_mark:    f
Logs:
...
from iol.upps_t_rsk_cup_trans t
where start_dt <=to_date('${batch_date}','yyyymmdd') and end_dt >to_date('${batch_date}','yyyymmdd') ;
" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/upps_t_rsk_cup_trans.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes