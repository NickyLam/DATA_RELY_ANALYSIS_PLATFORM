...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_rsts_rcd_ir_tzbl_jbxx_i
CreateDate: 20241012
FileName:   ${iel_data_path}/rsts_rcd_ir_tzbl_jbxx.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/rsts_rcd_ir_tzbl_jbxx.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
