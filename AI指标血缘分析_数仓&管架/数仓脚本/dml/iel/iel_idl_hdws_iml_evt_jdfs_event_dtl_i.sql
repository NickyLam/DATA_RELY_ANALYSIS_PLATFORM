...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_hdws_iml_evt_jdfs_event_dtl_i
CreateDate: 20180529
FileName:   ${iel_data_path}/hdws_iml_evt_jdfs_event_dtl.i.${batch_date}.dat
IF_mark:    i
Logs:
...
where ((etl_dt = to_date('${batch_date}','yyyymmdd')-1 and data_src_cd = 'LHWD') OR (etl_dt = to_date('${batch_date}','yyyymmdd') and data_src_cd <> 'LHWD')) ;" \
        ...
        file="${iel_data_path}/hdws_iml_evt_jdfs_event_dtl.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes