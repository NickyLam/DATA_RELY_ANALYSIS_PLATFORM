...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_ftps_rpt_ftp_lon_jx_i
CreateDate: 20180529
FileName:   ${iel_data_path}/ftps_rpt_ftp_lon_jx.i.${batch_date}.dat
IF_mark:    i
Logs:
...
,t1.adj09 as adj09
,t1.adj10 as adj10
from ${iol_schema}.ftps_rpt_ftp_lon_jx t1
where etl_dt = to_date('${batch_date}','yyyymmdd');" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/ftps_rpt_ftp_lon_jx.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes