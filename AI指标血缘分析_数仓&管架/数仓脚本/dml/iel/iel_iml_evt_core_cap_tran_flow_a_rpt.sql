...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_core_cap_tran_flow_a
CreateDate: 20180529
FileName:   ${iel_data_path}/evt_core_cap_tran_flow.a.${batch_date}.dat
IF_mark:    a
Logs:
...
where tran_dt <= to_date('${batch_date}','yyyymmdd') and tran_dt >= to_date('20200101','yyyymmdd');" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/evt_core_cap_tran_flow.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes