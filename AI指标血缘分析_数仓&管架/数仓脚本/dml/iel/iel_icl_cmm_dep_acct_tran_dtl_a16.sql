...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_icl_cmm_dep_acct_tran_dtl_a16
CreateDate: 20250306
...
where t1.etl_dt between add_months(to_date('${batch_date}','yyyymmdd'), -2) and to_date('${batch_date}', 'yyyymmdd') 
and t1.entry_flg = '1'; " \
