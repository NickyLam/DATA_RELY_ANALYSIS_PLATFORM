...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_idl_tmrs_hdws_iml_evt_dpst_open_colse_dtl_i
CreateDate: 20180529
FileName:   ${iel_data_path}/tmrs_hdws_iml_evt_dpst_open_colse_dtl.i.${batch_date}.dat
IF_mark:    i
Logs:
...
,NVL2(t1.data_src_cd,'EVT_DPST_OPEN_COLSE_DTL'||'_'||DECODE(T1.DATA_SRC_CD,'LHWD',UPPER(SUBSTR(T1.JOB_CD,1,4)),T1.DATA_SRC_CD),'EVT_DPST_OPEN_COLSE_DTL') as etl_task_name 
...
from ${idl_schema}.hdws_iml_evt_dpst_open_colse_dtl t1
where etl_dt = to_date('${batch_date}','yyyymmdd') ;" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/tmrs_hdws_iml_evt_dpst_open_colse_dtl.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes