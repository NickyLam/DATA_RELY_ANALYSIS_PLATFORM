...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_bdms_cpes_quote_details_f
CreateDate: 20180529
FileName:   ${iel_data_path}/bdms_cpes_quote_details.f.${batch_date}.dat
IF_mark:    f
Logs:
...
,t.due_tenor_days as due_tenor_days
...
from ${iol_schema}.bdms_cpes_quote_details t
where t.start_dt <= to_date('${batch_date}','yyyymmdd') and t.end_dt > to_date('${batch_date}','yyyymmdd');" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/bdms_cpes_quote_details.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes