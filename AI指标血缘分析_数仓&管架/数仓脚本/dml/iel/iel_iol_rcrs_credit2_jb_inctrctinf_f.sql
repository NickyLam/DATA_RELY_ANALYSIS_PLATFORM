...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_rcrs_credit2_jb_inctrctinf_f
CreateDate: 20180529
FileName:   ${iel_data_path}/rcrs_credit2_jb_inctrctinf.f.${batch_date}.dat
IF_mark:    f
Logs:
...
' \
    ...
    ,replace(replace(t.ctrctcertrelsgmt_updflag,chr(13),''),chr(10),'') as ctrctcertrelsgmt_updflag
    ,replace(replace(t.creditlimsgmt_updflag,chr(13),''),chr(10),'') as creditlimsgmt_updflag
    ,t.brernm as brernm
...
from iol.rcrs_credit2_jb_inctrctinf t
where  t.etl_dt = to_date('${batch_date}','yyyymmdd') " \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/rcrs_credit2_jb_inctrctinf.f.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes