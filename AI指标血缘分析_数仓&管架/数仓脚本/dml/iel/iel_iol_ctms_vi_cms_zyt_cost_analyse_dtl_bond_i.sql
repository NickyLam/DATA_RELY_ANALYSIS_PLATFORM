...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_ctms_vi_cms_zyt_cost_analyse_dtl_bond_i
CreateDate: 20240111
FileName:   ${iel_data_path}/ctms_vi_cms_zyt_cost_analyse_dtl_bond.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
from ${iol_schema}.ctms_vi_cms_zyt_cost_analyse_dtl_bond t1
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        field="0x1b" record="0x0a"  \
        file="${iel_data_path}/ctms_vi_cms_zyt_cost_analyse_dtl_bond.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
