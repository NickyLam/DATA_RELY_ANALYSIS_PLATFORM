...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_evt_super_olbk_tran_evt_a1
CreateDate: 20180529
FileName:   ${iel_data_path}/evt_super_olbk_tran_evt.i.${batch_date}.dat
IF_mark:    i
Logs:
...
where t1.send_bank_dt <= to_date('${batch_date}','yyyymmdd');" \
        ...
        file="${iel_data_path}/evt_super_olbk_tran_evt.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes