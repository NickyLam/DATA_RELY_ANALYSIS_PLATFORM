...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iol_rrps_m_crdt_lmt_info_i
CreateDate: 20240801
FileName:   ${iel_data_path}/rrps_m_crdt_lmt_info.i.${batch_date}.dat
IF_mark:    i
Logs:
' \
        query="select
...
where etl_dt = to_date('${batch_date}','yyyymmdd')" \
        ...
        file="${iel_data_path}/rrps_m_crdt_lmt_info.i.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
