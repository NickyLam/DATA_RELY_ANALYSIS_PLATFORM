...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iel_iml_agt_comb_prod_post_info_h_a
CreateDate: 20241204
FileName:   ${iel_data_path}/agt_comb_prod_post_info_h.a.${batch_date}.dat
IF_mark:    a
Logs:
' \
        query="select
...
where 1 = 1" \
        ...
        file="${iel_data_path}/agt_comb_prod_post_info_h.a.${batch_date}.dat" \
        charset=zhs16gbk
        safe=yes
