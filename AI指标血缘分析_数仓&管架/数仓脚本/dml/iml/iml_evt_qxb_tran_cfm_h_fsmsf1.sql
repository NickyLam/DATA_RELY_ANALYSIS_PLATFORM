...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iml_evt_qxb_tran_cfm_h_fsmsf1
CreateDate: 20180515
Logs:
    zjj 2018-05-15 新建表本
*/
...
alter table ${iml_schema}.evt_qxb_tran_cfm_h add partition p_fsmsf1 values ('fsmsf1')(
...
-- it is no need to check when this segment SQL was return faied
whenever sqlerror continue none ;
create table ${iml_schema}.evt_qxb_tran_cfm_h_fsmsf1_bk nologging
compress ${option_switch} for query high
as
select * from ${iml_schema}.evt_qxb_tran_cfm_h partition for ('fsmsf1')
;

-- 2.2 drop temp table
-- it is no need to check when this segment SQL was return faied
whenever sqlerror continue none ;
drop table ${iml_schema}.evt_qxb_tran_cfm_h_fsmsf1_tm purge;
drop table ${iml_schema}.evt_qxb_tran_cfm_h_fsmsf1_op purge;
drop table ${iml_schema}.evt_qxb_tran_cfm_h_fsmsf1_cl purge;

-- 2.3 create temp table
whenever sqlerror exit sql.sqlcode;
create table ${iml_schema}.evt_qxb_tran_cfm_h_fsmsf1_tm nologging
compress ${option_switch} for query high
as select
    evt_id -- 事件编号
    ,lp_id -- 法人编号
...
from ${iml_schema}.evt_qxb_tran_cfm_h partition for ('fsmsf1')
where 0=1
;

create table ${iml_schema}.evt_qxb_tran_cfm_h_fsmsf1_op nologging
compress ${option_switch} for query high
as
select * from ${iml_schema}.evt_qxb_tran_cfm_h partition for ('fsmsf1') where 0=1;

create table ${iml_schema}.evt_qxb_tran_cfm_h_fsmsf1_cl nologging
compress ${option_switch} for query high
as
select * from ${iml_schema}.evt_qxb_tran_cfm_h partition for ('fsmsf1') where 0=1;
...
-- fsms_yeb_ack_trans-
insert into ${iml_schema}.evt_qxb_tran_cfm_h_fsmsf1_tm(
    evt_id -- 事件编号
    ,lp_id -- 法人编号
    ,ibank_no -- 联行号
    ,ta_cd -- TA代码
...
and p2.end_dt > to_date('${batch_date}','yyyymmdd')
    left join ${iml_schema}.ref_pub_cd_map r1 on P1.CUST_TYPE = R1.SRC_CODE_VAL
        ...
        AND R1.TARGET_TAB_EN_NAME= 'EVT_QXB_TRAN_CFM_H'
    ...
    left join ${iml_schema}.ref_pub_cd_map r2 on P1.SHARETYPE = R2.SRC_CODE_VAL
        ...
        AND R2.TARGET_TAB_EN_NAME= 'EVT_QXB_TRAN_CFM_H'
    ...
    left join ${iml_schema}.ref_pub_cd_map r3 on P1.CURRENCYTYPE = R3.SRC_CODE_VAL
        ...
        AND R3.TARGET_TAB_EN_NAME= 'EVT_QXB_TRAN_CFM_H'
    ...
    left join ${iml_schema}.ref_pub_cd_map r4 on P1.FROZENCAUSE = R4.SRC_CODE_VAL
        ...
        AND R4.TARGET_TAB_EN_NAME= 'EVT_QXB_TRAN_CFM_H'
    ...
    left join ${iml_schema}.ref_pub_cd_map r5 on P1.ACCEPTMETHOD = R5.SRC_CODE_VAL
        ...
        AND R5.TARGET_TAB_EN_NAME= 'EVT_QXB_TRAN_CFM_H'
...
whenever sqlerror exit sql.sqlcode;
insert /*+ append */ into ${iml_schema}.evt_qxb_tran_cfm_h_fsmsf1_op(
        evt_id -- 事件编号
    ,lp_id -- 法人编号
    ,ibank_no -- 联行号
    ,ta_cd -- TA代码
...
select
    ...
    ,'fsmsf1' as job_cd -- 任务编码
    ,n.etl_timestamp as etl_timestamp -- ETL处理时间戳
from ${iml_schema}.evt_qxb_tran_cfm_h_fsmsf1_tm n
    left join (select * from ${iml_schema}.evt_qxb_tran_cfm_h_fsmsf1_bk where start_dt < to_date('${batch_date}','yyyymmdd') and end_dt >=to_date('${batch_date}','yyyymmdd')) o
        on
            o.evt_id = n.evt_id
            and o.lp_id = n.lp_id
...
insert /*+ append */ all
    when end_dt <= to_date('${batch_date}', 'yyyymmdd') then
        into ${iml_schema}.evt_qxb_tran_cfm_h_fsmsf1_cl(
            evt_id -- 事件编号
    ,lp_id -- 法人编号
    ,ibank_no -- 联行号
    ,ta_cd -- TA代码
    ...
    ,add_tm -- 新增时间
        ...
        into ${iml_schema}.evt_qxb_tran_cfm_h_fsmsf1_op(
            evt_id -- 事件编号
    ,lp_id -- 法人编号
    ,ibank_no -- 联行号
    ,ta_cd -- TA代码
...
from ${iml_schema}.evt_qxb_tran_cfm_h_fsmsf1_bk o
    left join ${iml_schema}.evt_qxb_tran_cfm_h_fsmsf1_op n
        on
            o.evt_id = n.evt_id
            and o.lp_id = n.lp_id
            and o.ibank_no = n.ibank_no
...
alter table ${iml_schema}.evt_qxb_tran_cfm_h truncate partition for ('fsmsf1') reuse storage;

-- 4.2 exchange partition
alter table ${iml_schema}.evt_qxb_tran_cfm_h exchange subpartition p_fsmsf1_19000101 with table ${iml_schema}.evt_qxb_tran_cfm_h_fsmsf1_cl;
alter table ${iml_schema}.evt_qxb_tran_cfm_h exchange subpartition p_fsmsf1_20991231 with table ${iml_schema}.evt_qxb_tran_cfm_h_fsmsf1_op;
...
whenever sqlerror exit sql.sqlcode;
drop table ${iml_schema}.evt_qxb_tran_cfm_h_fsmsf1_bk purge;

-- 6 gater table status
whenever sqlerror exit sql.sqlcode;
exec dbms_stats.gather_table_stats(ownname => '${iml_schema}',tabname => 'evt_qxb_tran_cfm_h', partname => 'p_fsmsf1_20991231', granularity => 'SUBPARTITION', degree => 8, cascade => true);
