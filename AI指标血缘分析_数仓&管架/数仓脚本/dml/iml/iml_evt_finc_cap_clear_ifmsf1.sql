...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iml_evt_finc_cap_clear_ifmsf1
CreateDate: 20180515
Logs:
    zjj 2018-05-15 新建表本
*/
...
alter table ${iml_schema}.evt_finc_cap_clear add partition p_ifmsf1 values ('ifmsf1')(
...
-- it is no need to check when this segment SQL was return faied
whenever sqlerror continue none ;
create table ${iml_schema}.evt_finc_cap_clear_ifmsf1_bk nologging
compress ${option_switch} for query high
as
select * from ${iml_schema}.evt_finc_cap_clear partition for ('ifmsf1')
...
whenever sqlerror continue none ;
-- it is no need to check when this segment SQL was return faied
drop table ${iml_schema}.evt_finc_cap_clear_ifmsf1_tm purge;
drop table ${iml_schema}.evt_finc_cap_clear_ifmsf1_op purge;
drop table ${iml_schema}.evt_finc_cap_clear_ifmsf1_cl purge;

-- 2.3 create temp table
-- it is no need to check when this segment SQL was return faied
whenever sqlerror exit sql.sqlcode;
create table ${iml_schema}.evt_finc_cap_clear_ifmsf1_tm nologging
compress ${option_switch} for query high
as select
    evt_id -- 事件编号
    ,lp_id -- 法人编号
...
from ${iml_schema}.evt_finc_cap_clear partition for ('ifmsf1')
where 0=1
;

create table ${iml_schema}.evt_finc_cap_clear_ifmsf1_op nologging
compress ${option_switch} for query high
as
select * from ${iml_schema}.evt_finc_cap_clear partition for ('ifmsf1') where 0=1;

create table ${iml_schema}.evt_finc_cap_clear_ifmsf1_cl nologging
compress ${option_switch} for query high
as
select * from ${iml_schema}.evt_finc_cap_clear partition for ('ifmsf1') where 0=1;
...
-- ifms_tbhissquare-1
insert into ${iml_schema}.evt_finc_cap_clear_ifmsf1_tm(
    evt_id -- 事件编号
    ,lp_id -- 法人编号
    ,clear_flow_num -- 清算流水号
    ,clear_seq_num -- 清算顺序号
...
select
    ...
    ,P1.BANK_NO -- 银行编号
    ,P1.CLIENT_NO -- 交易客户编号
    ,NVL(P3.BANK_ACC, P1.BANK_ACC) -- 银行账号
    ,P1.BANK_ACC_KIND -- 银行帐户类型代码
    ,nvl(trim(p1.CHANNEL),'-')-- 交易渠道代码
    ,P1.OPER_NO -- 交易柜员编号
    ,P1.TERM_NO -- 交易终端编号
    ...
    ,P1.LIQU_DIR -- 账务方向代码
    ,P1.AMT -- 清算金额
    ,CASE WHEN R4.TARGET_CD_VAL IS NOT NULL THEN R4.TARGET_CD_VAL ELSE '@'||p1.CURR_TYPE END -- 币种代码
    ,P1.CASH_FLAG -- 钞汇标识代码
    ,P1.UNFROZEN_AMT -- 解冻金额
    ,P1.HOST_TRANS_CODE -- 主机交易码
    ,${iml_schema}.DATEFORMAT_MIN(P1.HOST_DATE) -- 主机日期
    ...
    ,'ifmsf1' -- 任务编码
    ,to_timestamp('${batch_timestamp}', 'yyyy-mm-dd hh24:mi:ss.ff6') as etl_timestamp -- ETL处理时间戳
from ${iol_schema}.ifms_tbsquare p1
    left join ${iol_schema}.ifms_tbhissquare p2 on p1.square_no = p2.square_no
    left join ${iol_schema}.ifms_tbvirbankaccmap p3 on p1.bank_acc = p3.vir_bank_acc and p3.start_dt <= to_date('${batch_date}', 'yyyymmdd') and p3.end_dt > to_date('${batch_date}', 'yyyymmdd')
    left join ${iml_schema}.ref_pub_cd_map r3 on p1.CLIENT_TYPE = R3.SRC_CODE_VAL
        AND R3.SORC_SYS_CD= 'IFMS'
        AND R3.SRC_TAB_EN_NAME= 'IFMS_TBSQUARE'
        AND R3.SRC_FIELD_EN_NAME= 'CLIENT_TYPE'
        AND R3.TARGET_TAB_EN_NAME= 'EVT_FINC_CAP_CLEAR'
        AND R3.TARGET_TAB_FIELD_EN_NAME= 'CUST_TYPE_CD'
    left join ${iml_schema}.ref_pub_cd_map r4 on p1.CURR_TYPE = R4.SRC_CODE_VAL
        AND R4.SORC_SYS_CD= 'IFMS'
        AND R4.SRC_TAB_EN_NAME= 'IFMS_TBSQUARE'
        AND R4.SRC_FIELD_EN_NAME= 'CURR_TYPE'
        AND R4.TARGET_TAB_EN_NAME= 'EVT_FINC_CAP_CLEAR'
        AND R4.TARGET_TAB_FIELD_EN_NAME= 'CURR_CD'
where p1.start_dt <= to_date('${batch_date}','yyyymmdd') and p1.end_dt > to_date('${batch_date}','yyyymmdd')
and p2.square_no is null
;
commit;
...
begin
  for cur in (select 1 from dual) loop
  	select count(1) into cnt from (select 1 from ${iml_schema}.evt_finc_cap_clear_ifmsf1_tm 
  	                                group by 
  	                                        evt_id
  	                                        ,lp_id
  	                               having count(1) > 1);
...
insert /*+ append */ all
    when end_dt = to_date('${batch_date}', 'yyyymmdd') then
        into ${iml_schema}.evt_finc_cap_clear_ifmsf1_cl(
            evt_id -- 事件编号
    ,lp_id -- 法人编号
    ,clear_flow_num -- 清算流水号
    ,clear_seq_num -- 清算顺序号
    ...
    ,remark_info_5 -- 备注信息5
        ...
        into ${iml_schema}.evt_finc_cap_clear_ifmsf1_op(
            evt_id -- 事件编号
    ,lp_id -- 法人编号
    ,clear_flow_num -- 清算流水号
    ,clear_seq_num -- 清算顺序号
...
select
    ...
    ,nvl(n.clear_seq_num, o.clear_seq_num) as clear_seq_num -- 清算顺序号
    ,nvl(n.tran_dt, o.tran_dt) as tran_dt -- 交易日期
    ,nvl(n.clear_dt, o.clear_dt) as clear_dt -- 清算日期
    ,nvl(n.actl_enter_acct_dt, o.actl_enter_acct_dt) as actl_enter_acct_dt -- 实际入帐日期
    ,nvl(n.chg_bf_clear_dt, o.chg_bf_clear_dt) as chg_bf_clear_dt -- 变动前清算日期
    ...
    ,nvl(n.bank_acct_type_cd, o.bank_acct_type_cd) as bank_acct_type_cd -- 银行帐户类型代码
    ...
    ,nvl(n.acct_amt_src_type_cd, o.acct_amt_src_type_cd) as acct_amt_src_type_cd -- 上帐金额来源类型代码
    ,nvl(n.cap_cate_cd, o.cap_cate_cd) as cap_cate_cd -- 资金类别代码
    ,nvl(n.pric_prft_cd, o.pric_prft_cd) as pric_prft_cd -- 本金收益代码
    ,nvl(n.cfm_lot, o.cfm_lot) as cfm_lot -- 确认份额
    ,nvl(n.pric_amt, o.pric_amt) as pric_amt -- 本金金额
    ,nvl(n.cfm_prft_amt, o.cfm_prft_amt) as cfm_prft_amt -- 确认收益金额
    ,nvl(n.lot_accu_accum, o.lot_accu_accum) as lot_accu_accum -- 份额累积积数
    ...
    ,nvl(n.cap_clear_status_cd, o.cap_clear_status_cd) as cap_clear_status_cd -- 资金清算状态代码
    ...
    ,nvl(n.remark_info_1, o.remark_info_1) as remark_info_1 -- 备注信息1
    ,nvl(n.remark_info_2, o.remark_info_2) as remark_info_2 -- 备注信息2
    ,nvl(n.remark_info_3, o.remark_info_3) as remark_info_3 -- 备注信息3
    ,nvl(n.remark_info_4, o.remark_info_4) as remark_info_4 -- 备注信息4
    ,nvl(n.remark_info_5, o.remark_info_5) as remark_info_5 -- 备注信息5
    ,case when
            n.evt_id is null
            and n.lp_id is null
        then o.start_dt
...
from ${iml_schema}.evt_finc_cap_clear_ifmsf1_tm n
    full join (select * from ${iml_schema}.evt_finc_cap_clear_ifmsf1_bk where start_dt < to_date('${batch_date}','yyyymmdd') and end_dt >= to_date('${batch_date}','yyyymmdd')) o
        on
            o.evt_id = n.evt_id
            and o.lp_id = n.lp_id
where (
    ...
    or (
        ...
        or o.clear_seq_num <> n.clear_seq_num
        or o.tran_dt <> n.tran_dt
        or o.clear_dt <> n.clear_dt
        or o.actl_enter_acct_dt <> n.actl_enter_acct_dt
        or o.chg_bf_clear_dt <> n.chg_bf_clear_dt
        ...
        or o.acct_amt_src_type_cd <> n.acct_amt_src_type_cd
        or o.cap_cate_cd <> n.cap_cate_cd
        or o.pric_prft_cd <> n.pric_prft_cd
        or o.cfm_lot <> n.cfm_lot
        or o.pric_amt <> n.pric_amt
        or o.cfm_prft_amt <> n.cfm_prft_amt
        or o.lot_accu_accum <> n.lot_accu_accum
        or o.prod_acct_num <> n.prod_acct_num
        or o.prod_acct_type_cd <> n.prod_acct_type_cd
        or o.memo_comnt <> n.memo_comnt
        or o.cap_clear_status_cd <> n.cap_clear_status_cd
        or o.init_clear_flow_num <> n.init_clear_flow_num
        or o.return_code <> n.return_code
        or o.err_info_desc <> n.err_info_desc
        or o.intfc_proc_flg <> n.intfc_proc_flg
        or o.remark_info_1 <> n.remark_info_1
        or o.remark_info_2 <> n.remark_info_2
        or o.remark_info_3 <> n.remark_info_3
        or o.remark_info_4 <> n.remark_info_4
        or o.remark_info_5 <> n.remark_info_5
    )
;
commit;
...
select
    ...
    ,o.clear_seq_num -- 清算顺序号
    ,o.tran_dt -- 交易日期
    ,o.clear_dt -- 清算日期
    ,o.actl_enter_acct_dt -- 实际入帐日期
    ,o.chg_bf_clear_dt -- 变动前清算日期
    ,o.flow_num -- 流水号
    ...
    ,o.bank_id -- 银行编号
    ,o.cust_id -- 交易客户编号
    ,o.bank_acct_num -- 银行账号
    ,o.bank_acct_type_cd -- 银行帐户类型代码
    ...
    ,o.acct_amt_src_type_cd -- 上帐金额来源类型代码
    ,o.cap_cate_cd -- 资金类别代码
    ,o.pric_prft_cd -- 本金收益代码
    ,o.cfm_lot -- 确认份额
    ,o.pric_amt -- 本金金额
    ,o.cfm_prft_amt -- 确认收益金额
    ,o.lot_accu_accum -- 份额累积积数
    ,o.prod_acct_num -- 产品账号
    ,o.prod_acct_type_cd -- 产品账户类型代码
    ,o.memo_comnt -- 摘要说明
    ,o.cap_clear_status_cd -- 资金清算状态代码
    ,o.init_clear_flow_num -- 原清算流水号
    ,o.return_code -- 返回码
    ,o.err_info_desc -- 错误信息描述
    ,o.intfc_proc_flg -- 接口处理标志
    ,o.remark_info_1 -- 备注信息1
    ,o.remark_info_2 -- 备注信息2
    ,o.remark_info_3 -- 备注信息3
    ,o.remark_info_4 -- 备注信息4
    ,o.remark_info_5 -- 备注信息5
    ,o.start_dt -- 开始时间
...
from ${iml_schema}.evt_finc_cap_clear_ifmsf1_bk o
    left join ${iml_schema}.evt_finc_cap_clear_ifmsf1_op n
        on
            o.evt_id = n.evt_id
            and o.lp_id = n.lp_id
            and o.end_dt >= to_date('${batch_date}','yyyymmdd')
    left join ${iml_schema}.evt_finc_cap_clear_ifmsf1_cl d
        on
            o.evt_id = d.evt_id
            and o.lp_id = d.lp_id
...
--truncate table ${iml_schema}.evt_finc_cap_clear;
--alter table ${iml_schema}.evt_finc_cap_clear truncate partition for ('ifmsf1') reuse storage;
...
for cur in (select subpartition_name 
             ...
             where table_owner=upper('${iml_schema}') 
               and table_name=upper('evt_finc_cap_clear') 
               and substr(subpartition_name,1,8)=upper('p_ifmsf1')
               and substr(subpartition_name,10) >= '${batch_date}' 
               and substr(subpartition_name,10) < '20991231') loop
    v_sql := 'alter table ${iml_schema}.evt_finc_cap_clear drop subpartition ' || cur.subpartition_name;
...
alter table ${iml_schema}.evt_finc_cap_clear modify partition p_ifmsf1 
add subpartition p_ifmsf1_${batch_date} values(to_date('${batch_date}','YYYYMMDD')) ;

-- 4.3 exchange partition
alter table ${iml_schema}.evt_finc_cap_clear exchange subpartition p_ifmsf1_${batch_date} with table ${iml_schema}.evt_finc_cap_clear_ifmsf1_cl;
alter table ${iml_schema}.evt_finc_cap_clear exchange subpartition p_ifmsf1_20991231 with table ${iml_schema}.evt_finc_cap_clear_ifmsf1_op;
...
whenever sqlerror exit sql.sqlcode;
drop table ${iml_schema}.evt_finc_cap_clear_ifmsf1_bk purge;

-- 6 gater table status
whenever sqlerror exit sql.sqlcode;
exec dbms_stats.gather_table_stats(ownname => '${iml_schema}',tabname => 'evt_finc_cap_clear', partname => 'p_ifmsf1_20991231',ESTIMATE_PERCENT=>10, method_opt=>'for all columns size 1',no_invalidate=>false, force=>true, granularity => 'SUBPARTITION', degree => 8, cascade => true);
