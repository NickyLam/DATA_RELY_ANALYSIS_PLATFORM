...
whenever sqlerror exit sql.sqlcode;
exec dbms_stats.gather_table_stats(ownname => '${iml_schema}',tabname => 'agt_prod_rela_h', partname => 'p_ifcsf1_20991231', granularity => 'SUBPARTITION', degree => 8, cascade => true);
