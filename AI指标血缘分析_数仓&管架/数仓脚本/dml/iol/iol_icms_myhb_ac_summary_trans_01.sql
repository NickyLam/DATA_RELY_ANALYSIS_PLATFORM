...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iol_icms_myhb_ac_summary_trans_01
CreateDate: 20180515
Logs:
    zjj 2018-05-15 新建脚本
*/
...
drop table ${iol_schema}.icms_myhb_ac_summary_trans_01_ex purge;
alter table ${iol_schema}.icms_myhb_ac_summary_trans_01 add partition p_${batch_date} values (to_date('${batch_date}','yyyymmdd'));

-- 2.2 truncate target table
whenever sqlerror exit sql.sqlcode;
truncate table ${iol_schema}.icms_myhb_ac_summary_trans_01;

-- 2.3 insert data to ex table
create table ${iol_schema}.icms_myhb_ac_summary_trans_01_ex nologging
for exchange with table
${iol_schema}.icms_myhb_ac_summary_trans_01;

insert /*+ append */ into ${iol_schema}.icms_myhb_ac_summary_trans_01_ex(
    settledate -- 业务日期
    ,regioncode -- 行政区划代码
...
from ${itl_schema}.icms_myhb_ac_summary_trans_01
where etl_dt = to_date('${batch_date}', 'yyyymmdd')
;

-- 2.4 exchage ex table and target table
alter table ${iol_schema}.icms_myhb_ac_summary_trans_01 exchange partition p_${batch_date} with table ${iol_schema}.icms_myhb_ac_summary_trans_01_ex;
...
exec dbms_stats.gather_table_stats(ownname => '${iol_schema}',tabname => 'icms_myhb_ac_summary_trans_01',partname => 'p_${batch_date}', granularity => 'PARTITION', degree => 8, cascade => true);