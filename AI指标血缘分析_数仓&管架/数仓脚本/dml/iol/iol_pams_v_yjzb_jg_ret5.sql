...
begin
  ...
  for tb in (select table_name, partition_name, substr(partition_name, 3) as etl_dt
               from user_tab_partitions
                ...
                and substr(partition_name, 3) >= '20241107'
                and substr(partition_name, 3) < '20250109'
             ) loop
...
from ${iol_schema}.pams_v_yjzb_jg_bak${batch_date} t1
 where t1.etl_dt >= to_date('20241107', 'yyyymmdd')
 and t1.etl_dt < to_date('20250109', 'yyyymmdd');
