...
create table ${iol_schema}.uuss_uus_organ_bk nologging
...
-- it is no need to check when this segment SQL was return faied
whenever sqlerror continue none ;
drop table ${iol_schema}.uuss_uus_organ_op purge;
drop table ${iol_schema}.uuss_uus_organ_cl purge;

-- 2.3 create temp table
whenever sqlerror exit sql.sqlcode;
create table ${iol_schema}.uuss_uus_organ_op nologging
compress ${option_switch} for query high
as
select * from ${iol_schema}.uuss_uus_organ where 0=1;

create table ${iol_schema}.uuss_uus_organ_cl nologging
compress ${option_switch} for query high
as
select * from ${iol_schema}.uuss_uus_organ where 0=1;
...
insert /*+ append */ all
    when end_dt = to_date('${batch_date}', 'yyyymmdd') then
        into ${iol_schema}.uuss_uus_organ_cl(
        ...
        into ${iol_schema}.uuss_uus_organ_op(
            organcodekey -- 统一组织机构编码
            ,organcode -- 组织机构编号
            ,zoneno -- 分行号
            ,pbocfinancialcode -- 人民银行金融机构编号
...
select
    ...
    ,nvl(n.pbocfinancialcode, o.pbocfinancialcode) as pbocfinancialcode -- 人民银行金融机构编号
    ...
    ,nvl(n.organcnfullname, o.organcnfullname) as organcnfullname -- 组织机构名称
    ,nvl(n.organcnshortname, o.organcnshortname) as organcnshortname -- 组织机构简称
    ...
    ,nvl(n.organclosedate, o.organclosedate) as organclosedate -- 机构关闭日期
    ,nvl(n.organtype, o.organtype) as organtype -- 组织机构类型
    ,nvl(n.isst, o.isst) as isst -- 是否为实体机构
    ,nvl(n.ishs, o.ishs) as ishs -- 是否为核算机构
    ,nvl(n.isyy, o.isyy) as isyy -- 是否为营业机构
    ,nvl(n.isxz, o.isxz) as isxz -- 是否为行政机构
    ,nvl(n.iszw, o.iszw) as iszw -- 是否为账务机构
    ,nvl(n.organlevel, o.organlevel) as organlevel -- 组织机构级别代码
    ,nvl(n.leafnoteflag, o.leafnoteflag) as leafnoteflag -- 叶节点标志
    ,nvl(n.xzuporgancode, o.xzuporgancode) as xzuporgancode -- 行政上级组织机构编码
    ,nvl(n.zwuporgancode, o.zwuporgancode) as zwuporgancode -- 账务上级组织机构编码
    ,nvl(n.hsuporgancode, o.hsuporgancode) as hsuporgancode -- 核算上级组织机构编码
    ...
    ,nvl(n.financiallicnum, o.financiallicnum) as financiallicnum -- 金融许可证号码
    ...
    ,nvl(n.heademplyid, o.heademplyid) as heademplyid -- 负责人员工编号
    ,nvl(n.isxnhs, o.isxnhs) as isxnhs -- 是否为虚拟核算机构
    ,nvl(n.rhregcode, o.rhregcode) as rhregcode -- 人行地区码
    ,nvl(n.blng_city_pbc, o.blng_city_pbc) as blng_city_pbc -- 所属城市(人行)
    ...
    ,nvl(n.note3, o.note3) as note3 -- 备用3
    ,nvl(n.note4, o.note4) as note4 -- 备用4
    ,nvl(n.note5, o.note5) as note5 -- 备用5
    ,nvl(n.note6, o.note6) as note6 -- 备用6
    ,nvl(n.note7, o.note7) as note7 -- 备用7
    ,nvl(n.note8, o.note8) as note8 -- 备用8
    ,nvl(n.note9, o.note9) as note9 -- 备用9
    ,nvl(n.note10, o.note10) as note10 -- 备用10
    ,nvl(n.bbuporgancode, o.bbuporgancode) as bbuporgancode -- 报表上级机构编号
    ,nvl(n.countyflag, o.countyflag) as countyflag -- 县域机构标识
    ,nvl(n.technologyflag, o.technologyflag) as technologyflag -- 科技支行标识
    ,nvl(n.specialflag, o.specialflag) as specialflag -- 科技特色支行标识
    ,nvl(n.financeflag, o.financeflag) as financeflag -- 科技金融专营机构标识
    ,nvl(n.freetradeflag, o.freetradeflag) as freetradeflag -- 自贸区网点标识
    ,nvl(n.busitimedesc, o.busitimedesc) as busitimedesc -- 网点营业时间说明
    ,nvl(n.busiscopdesc, o.busiscopdesc) as busiscopdesc -- 主要业务范围说明
    ,nvl(n.physicsflag, o.physicsflag) as physicsflag -- 零售管户机构|1是 0否
    ,case when
            n.organcode is null
        then o.start_dt
...
from (select * from ${iol_schema}.uuss_uus_organ_bk where start_dt < to_date('${batch_date}','yyyymmdd') and end_dt >= to_date('${batch_date}','yyyymmdd')) o
    full join (select * from ${itl_schema}.uuss_uus_organ where etl_dt = to_date('${batch_date}', 'yyyymmdd')) n
        on
...
where (
    ...
    or (
        ...
        or o.blng_city_pbc <> n.blng_city_pbc
        ...
        or o.note8 <> n.note8
        or o.note9 <> n.note9
        or o.note10 <> n.note10
        or o.bbuporgancode <> n.bbuporgancode
        or o.countyflag <> n.countyflag
        or o.technologyflag <> n.technologyflag
        or o.specialflag <> n.specialflag
        or o.financeflag <> n.financeflag
        or o.freetradeflag <> n.freetradeflag
        or o.busitimedesc <> n.busitimedesc
        or o.busiscopdesc <> n.busiscopdesc
        or o.physicsflag <> n.physicsflag
    )
;
commit;
...
select
    ...
    ,o.organcode -- 组织机构编号
    ,o.zoneno -- 分行号
    ,o.pbocfinancialcode -- 人民银行金融机构编号
    ...
    ,o.isxz -- 是否为行政机构
    ,o.iszw -- 是否为账务机构
    ,o.organlevel -- 组织机构级别代码
    ,o.leafnoteflag -- 叶节点标志
    ,o.xzuporgancode -- 行政上级组织机构编码
    ,o.zwuporgancode -- 账务上级组织机构编码
    ,o.hsuporgancode -- 核算上级组织机构编码
    ,o.seque -- 机构顺序号
    ,o.postcode -- 邮政编码
    ,o.country -- 所在国家
    ,o.province -- 所在省/州
    ...
    ,o.workendtm -- 工作结束时间
    ,o.updatedate -- 更新日期
    ,o.heademplyid -- 负责人员工编号
    ,o.isxnhs -- 是否为虚拟核算机构
    ,o.rhregcode -- 人行地区码
    ,o.blng_city_pbc -- 所属城市(人行)
    ...
    ,o.countyflag -- 县域机构标识
    ,o.technologyflag -- 科技支行标识
    ,o.specialflag -- 科技特色支行标识
    ,o.financeflag -- 科技金融专营机构标识
    ,o.freetradeflag -- 自贸区网点标识
    ,o.busitimedesc -- 网点营业时间说明
    ,o.busiscopdesc -- 主要业务范围说明
    ,o.physicsflag -- 零售管户机构|1是 0否
    ,o.start_dt -- 开始时间
...
from ${iol_schema}.uuss_uus_organ_bk o
    left join ${iol_schema}.uuss_uus_organ_op n
        on
            o.organcode = n.organcode
            and o.end_dt >= to_date('${batch_date}','yyyymmdd')
    left join ${iol_schema}.uuss_uus_organ_cl d
        on
            o.organcode = d.organcode
...
--truncate table ${iol_schema}.uuss_uus_organ;

-- 4.2 rebuild partition
declare
v_sql varchar2(100);
begin
for cur in (select partition_name from all_tab_partitions where table_owner=upper('${iol_schema}') and table_name=upper('uuss_uus_organ') and substr(partition_name,3) >= '${batch_date}' and substr(partition_name,3) < '20991231') loop
    v_sql := 'alter table ${iol_schema}.uuss_uus_organ drop partition ' || cur.partition_name;
    dbms_output.put_line(v_sql);
    execute immediate v_sql;
end loop;
end;
/
alter table ${iol_schema}.uuss_uus_organ add partition p_${batch_date} values(to_date('${batch_date}','YYYYMMDD'));

-- 4.3 exchange partition
alter table ${iol_schema}.uuss_uus_organ exchange partition p_${batch_date} with table ${iol_schema}.uuss_uus_organ_cl;
alter table ${iol_schema}.uuss_uus_organ exchange partition p_20991231 with table ${iol_schema}.uuss_uus_organ_op;
...
whenever sqlerror exit sql.sqlcode;
drop table ${iol_schema}.uuss_uus_organ_bk purge;

-- 6 gater table status
whenever sqlerror exit sql.sqlcode;
exec dbms_stats.gather_table_stats(ownname => '${iol_schema}',tabname => 'uuss_uus_organ',partname => 'p_20991231', granularity => 'PARTITION', degree => 8, cascade => true);
