...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iol_nhrs_org_orgs
CreateDate: 20180515
Logs:
    zjj 2018-05-15 新建脚本
*/
...
create table ${iol_schema}.nhrs_org_orgs_bk nologging
compress ${option_switch} for query high
as
select *
from ${iol_schema}.nhrs_org_orgs
where start_dt < to_date('${batch_date}','yyyymmdd') and end_dt >=to_date('${batch_date}','yyyymmdd');

-- 2.2 drop temp table
-- it is no need to check when this segment SQL was return faied
whenever sqlerror continue none ;
drop table ${iol_schema}.nhrs_org_orgs_op purge;
drop table ${iol_schema}.nhrs_org_orgs_cl purge;

-- 2.3 create temp table
whenever sqlerror exit sql.sqlcode;
create table ${iol_schema}.nhrs_org_orgs_op nologging
compress ${option_switch} for query high
as
select * from ${iol_schema}.nhrs_org_orgs where 0=1;

create table ${iol_schema}.nhrs_org_orgs_cl nologging
compress ${option_switch} for query high
as
select * from ${iol_schema}.nhrs_org_orgs where 0=1;
...
insert /*+ append */ all
    when end_dt = to_date('${batch_date}', 'yyyymmdd') then
        into ${iol_schema}.nhrs_org_orgs_cl(
            address -- 地址
            ,code -- 机构编号
            ,countryzone -- 国家地区
            ,creationtime -- 创建时间
            ...
            ,orgtype8 -- 组织类型8
            ,orgtype9 -- 组织类型9
            ,pk_accperiodscheme -- 备用PK_ACCPERIODSCHEME
            ,pk_controlarea -- 备用PK_CONTROLAREA
            ,pk_corp -- 备用PK_CORP
            ,pk_currtype -- 备用PK_CURRTYPE
            ,pk_exratescheme -- 备用PK_EXRATESCHEME
            ,pk_fatherorg -- 上级业务单元
            ,pk_format -- 数据格式
            ,pk_group -- 所属集团
            ,pk_org -- 组织主键
            ...
            ,pk_vid -- 版本主键
            ,principal -- 负责人
            ,reportconfirm -- 备用REPORTCONFIRM
            ,shortname -- 简称
            ,shortname2 -- 备用SHORTNAME2
            ,shortname3 -- 备用SHORTNAME3
            ,shortname4 -- 备用SHORTNAME4
            ,shortname5 -- 备用SHORTNAME5
            ,shortname6 -- 备用SHORTNAME6
            ,tel -- 电话
            ,ts -- 备用TS
            ,venddate -- 版本失效日期
            ,vname -- 版本名称
            ...
            ,vno -- 版本号
            ,vstartdate -- 版本生效日期
            ,workcalendar -- 备用WORKCALENDAR
            ,orgtype60 -- 备用ORGTYPE60
            ,virtual -- 备用VIRTUAL
            ,glbdef1 -- 备用GLBDEF1
            ,glbdef2 -- 备用GLBDEF2
            ,start_dt -- 开始时间
        ...
        into ${iol_schema}.nhrs_org_orgs_op(
            address -- 地址
            ,code -- 机构编号
            ,countryzone -- 国家地区
            ,creationtime -- 创建时间
...
select
    ...
    ,nvl(n.code, o.code) as code -- 机构编号
    ...
    ,nvl(n.enablestate, o.enablestate) as enablestate -- 机构状态
    ,nvl(n.entitytype, o.entitytype) as entitytype -- 备用ENTITYTYPE
    ,nvl(n.innercode, o.innercode) as innercode -- 内部编码
    ,nvl(n.isbusinessunit, o.isbusinessunit) as isbusinessunit -- 是否业务单元数据
    ,nvl(n.islastversion, o.islastversion) as islastversion -- 是否最新版本
    ,nvl(n.isretail, o.isretail) as isretail -- 备用ISRETAIL
    ...
    ,nvl(n.name2, o.name2) as name2 -- 备用NAME2
    ,nvl(n.name3, o.name3) as name3 -- 备用NAME3
    ,nvl(n.name4, o.name4) as name4 -- 备用NAME4
    ,nvl(n.name5, o.name5) as name5 -- 备用NAME5
    ,nvl(n.name6, o.name6) as name6 -- 备用NAME6
    ,nvl(n.ncindustry, o.ncindustry) as ncindustry -- 所属UAP行业
    ,nvl(n.organizationcode, o.organizationcode) as organizationcode -- 组织机构码
    ...
    ,nvl(n.orgtype2, o.orgtype2) as orgtype2 -- 组织类型2
    ...
    ,nvl(n.orgtype29, o.orgtype29) as orgtype29 -- 组织类型29
    ...
    ,nvl(n.orgtype4, o.orgtype4) as orgtype4 -- 组织类型4
    ,nvl(n.orgtype40, o.orgtype40) as orgtype40 -- 组织类型40
    ,nvl(n.orgtype5, o.orgtype5) as orgtype5 -- 组织类型5
    ...
    ,nvl(n.pk_accperiodscheme, o.pk_accperiodscheme) as pk_accperiodscheme -- 备用PK_ACCPERIODSCHEME
    ,nvl(n.pk_controlarea, o.pk_controlarea) as pk_controlarea -- 备用PK_CONTROLAREA
    ,nvl(n.pk_corp, o.pk_corp) as pk_corp -- 备用PK_CORP
    ,nvl(n.pk_currtype, o.pk_currtype) as pk_currtype -- 备用PK_CURRTYPE
    ,nvl(n.pk_exratescheme, o.pk_exratescheme) as pk_exratescheme -- 备用PK_EXRATESCHEME
    ,nvl(n.pk_fatherorg, o.pk_fatherorg) as pk_fatherorg -- 上级业务单元
    ...
    ,nvl(n.reportconfirm, o.reportconfirm) as reportconfirm -- 备用REPORTCONFIRM
    ,nvl(n.shortname, o.shortname) as shortname -- 简称
    ,nvl(n.shortname2, o.shortname2) as shortname2 -- 备用SHORTNAME2
    ,nvl(n.shortname3, o.shortname3) as shortname3 -- 备用SHORTNAME3
    ,nvl(n.shortname4, o.shortname4) as shortname4 -- 备用SHORTNAME4
    ,nvl(n.shortname5, o.shortname5) as shortname5 -- 备用SHORTNAME5
    ,nvl(n.shortname6, o.shortname6) as shortname6 -- 备用SHORTNAME6
    ...
    ,nvl(n.vname2, o.vname2) as vname2 -- 备用VNAME2
    ,nvl(n.vname3, o.vname3) as vname3 -- 备用VNAME3
    ,nvl(n.vname4, o.vname4) as vname4 -- 备用VNAME4
    ,nvl(n.vname5, o.vname5) as vname5 -- 备用VNAME5
    ,nvl(n.vname6, o.vname6) as vname6 -- 备用VNAME6
    ,nvl(n.vno, o.vno) as vno -- 版本号
    ,nvl(n.vstartdate, o.vstartdate) as vstartdate -- 版本生效日期
    ,nvl(n.workcalendar, o.workcalendar) as workcalendar -- 备用WORKCALENDAR
    ,nvl(n.orgtype60, o.orgtype60) as orgtype60 -- 备用ORGTYPE60
    ,nvl(n.virtual, o.virtual) as virtual -- 备用VIRTUAL
    ,nvl(n.glbdef1, o.glbdef1) as glbdef1 -- 备用GLBDEF1
...
from (select * from ${iol_schema}.nhrs_org_orgs_bk where start_dt < to_date('${batch_date}','yyyymmdd') and end_dt >= to_date('${batch_date}','yyyymmdd')) o
    full join (select * from ${itl_schema}.nhrs_org_orgs where etl_dt = to_date('${batch_date}', 'yyyymmdd')) n
        on
            o.pk_org = n.pk_org
where (
        o.pk_org is null
    ...
    or (
        ...
        or o.orgtype60 <> n.orgtype60
        or o.virtual <> n.virtual
...
select
    ...
    ,o.dr -- 备用DR
    ,o.enablestate -- 机构状态
    ,o.entitytype -- 备用ENTITYTYPE
    ,o.innercode -- 内部编码
    ,o.isbusinessunit -- 是否业务单元数据
    ,o.islastversion -- 是否最新版本
    ,o.isretail -- 备用ISRETAIL
    ,o.memo -- 说明
    ,o.mnecode -- 助记码
    ...
    ,o.name5 -- 备用NAME5
    ,o.name6 -- 备用NAME6
    ,o.ncindustry -- 所属UAP行业
    ,o.organizationcode -- 组织机构码
    ,o.orgtype1 -- 组织类型1
    ,o.orgtype10 -- 组织类型10
    ,o.orgtype11 -- 组织类型11
    ,o.orgtype12 -- 组织类型12
    ...
    ,o.orgtype8 -- 组织类型8
    ,o.orgtype9 -- 组织类型9
    ,o.pk_accperiodscheme -- 备用PK_ACCPERIODSCHEME
    ,o.pk_controlarea -- 备用PK_CONTROLAREA
    ,o.pk_corp -- 备用PK_CORP
    ,o.pk_currtype -- 备用PK_CURRTYPE
    ,o.pk_exratescheme -- 备用PK_EXRATESCHEME
    ,o.pk_fatherorg -- 上级业务单元
    ,o.pk_format -- 数据格式
    ,o.pk_group -- 所属集团
    ,o.pk_org -- 组织主键
    ,o.pk_timezone -- 时区
    ,o.pk_vid -- 版本主键
    ,o.principal -- 负责人
    ,o.reportconfirm -- 备用REPORTCONFIRM
    ,o.shortname -- 简称
    ,o.shortname2 -- 备用SHORTNAME2
    ,o.shortname3 -- 备用SHORTNAME3
    ,o.shortname4 -- 备用SHORTNAME4
    ,o.shortname5 -- 备用SHORTNAME5
    ,o.shortname6 -- 备用SHORTNAME6
    ,o.tel -- 电话
    ,o.ts -- 备用TS
    ,o.venddate -- 版本失效日期
    ,o.vname -- 版本名称
    ...
    ,o.vno -- 版本号
    ,o.vstartdate -- 版本生效日期
    ,o.workcalendar -- 备用WORKCALENDAR
    ,o.orgtype60 -- 备用ORGTYPE60
    ,o.virtual -- 备用VIRTUAL
    ,o.glbdef1 -- 备用GLBDEF1
    ,o.glbdef2 -- 备用GLBDEF2
    ,o.start_dt -- 开始时间
...
from ${iol_schema}.nhrs_org_orgs_bk o
    left join ${iol_schema}.nhrs_org_orgs_op n
        on
            o.pk_org = n.pk_org
            and o.end_dt >= to_date('${batch_date}','yyyymmdd')
    left join ${iol_schema}.nhrs_org_orgs_cl d
        on
            o.pk_org = d.pk_org
...
--truncate table ${iol_schema}.nhrs_org_orgs;

-- 4.2 rebuild partition
declare
v_sql varchar2(100);
begin
for cur in (select partition_name from all_tab_partitions where table_owner=upper('${iol_schema}') and table_name=upper('nhrs_org_orgs') and substr(partition_name,3) >= '${batch_date}' and substr(partition_name,3) < '20991231') loop
    v_sql := 'alter table ${iol_schema}.nhrs_org_orgs drop partition ' || cur.partition_name;
    dbms_output.put_line(v_sql);
    execute immediate v_sql;
end loop;
end;
/
alter table ${iol_schema}.nhrs_org_orgs add partition p_${batch_date} values(to_date('${batch_date}','YYYYMMDD'));

-- 4.3 exchange partition
alter table ${iol_schema}.nhrs_org_orgs exchange partition p_${batch_date} with table ${iol_schema}.nhrs_org_orgs_cl;
alter table ${iol_schema}.nhrs_org_orgs exchange partition p_20991231 with table ${iol_schema}.nhrs_org_orgs_op;
...
whenever sqlerror exit sql.sqlcode;
drop table ${iol_schema}.nhrs_org_orgs_bk purge;

-- 6 gater table status
whenever sqlerror exit sql.sqlcode;
exec dbms_stats.gather_table_stats(ownname => '${iol_schema}',tabname => 'nhrs_org_orgs',partname => 'p_20991231', granularity => 'PARTITION', degree => 8, cascade => true);
