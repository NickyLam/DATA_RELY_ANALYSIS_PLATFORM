...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iol_hgls_gh_uus_employee
CreateDate: 20180515
Logs:
    zjj 2018-05-15 新建脚本
*/
...
create table ${iol_schema}.hgls_gh_uus_employee_bk nologging
compress ${option_switch} for query high
as
select *
from ${iol_schema}.hgls_gh_uus_employee
where start_dt < to_date('${batch_date}','yyyymmdd') and end_dt >=to_date('${batch_date}','yyyymmdd');

-- 2.2 drop temp table
-- it is no need to check when this segment SQL was return faied
whenever sqlerror continue none ;
drop table ${iol_schema}.hgls_gh_uus_employee_op purge;
drop table ${iol_schema}.hgls_gh_uus_employee_cl purge;

-- 2.3 create temp table
whenever sqlerror exit sql.sqlcode;
create table ${iol_schema}.hgls_gh_uus_employee_op nologging
compress ${option_switch} for query high
as
select * from ${iol_schema}.hgls_gh_uus_employee where 0=1;

create table ${iol_schema}.hgls_gh_uus_employee_cl nologging
compress ${option_switch} for query high
as
select * from ${iol_schema}.hgls_gh_uus_employee where 0=1;
...
insert /*+ append */ all
    when end_dt = to_date('${batch_date}', 'yyyymmdd') then
        into ${iol_schema}.hgls_gh_uus_employee_cl(
            id -- 主键id
            ,employeeid -- 员工编号
            ,domainid -- 域帐号
            ,tellerno -- 柜员号
            ...
            ,sallevel -- 薪资级别
            ,orderno -- 序号
            ,partorgancode -- 兼职所在部门编号
            ,partplace -- 
            ,hsorgancode -- 虚拟核算部门编号
            ,parttellerno -- 兼职柜员号
            ,parttellerattachorgan -- 兼职柜员所属机构
            ,subsidydate -- 补贴正式发放日期
            ,userid -- 钉钉UserID
            ,placehr -- HR职务编码(HR更新）
            ,jobcategory -- (职务类别)员工职务代码
            ,jobcategoryname -- 职务类别名称HR
            ,start_dt -- 开始时间
            ,end_dt -- 结束时间
            ,id_mark -- 增删标志
        ...
        into ${iol_schema}.hgls_gh_uus_employee_op(
            id -- 主键id
            ,employeeid -- 员工编号
            ,domainid -- 域帐号
            ,tellerno -- 柜员号
...
select
    ...
    ,nvl(n.givenname, o.givenname) as givenname -- 员工姓名
    ,nvl(n.surname, o.surname) as surname -- 员工姓氏
    ...
    ,nvl(n.sex, o.sex) as sex -- 员工性别
    ,nvl(n.birthdate, o.birthdate) as birthdate -- 员工出生日期
    ...
    ,nvl(n.education, o.education) as education -- 员工学历
    ...
    ,nvl(n.organcode, o.organcode) as organcode -- 所属部门编号
    ...
    ,nvl(n.tellermanagerid, o.tellermanagerid) as tellermanagerid -- 旧柜员号
    ,nvl(n.attachorgan, o.attachorgan) as attachorgan -- 柜员所属机构
    ,nvl(n.theentrydate, o.theentrydate) as theentrydate -- 员工入职日期
    ,nvl(n.leaveofficedate, o.leaveofficedate) as leaveofficedate -- 离职日期
    ,nvl(n.status, o.status) as status -- 员工状态代码
    ...
    ,nvl(n.partorgancode, o.partorgancode) as partorgancode -- 兼职所在部门编号
    ,nvl(n.partplace, o.partplace) as partplace -- 
    ,nvl(n.hsorgancode, o.hsorgancode) as hsorgancode -- 虚拟核算部门编号
    ,nvl(n.parttellerno, o.parttellerno) as parttellerno -- 兼职柜员号
    ,nvl(n.parttellerattachorgan, o.parttellerattachorgan) as parttellerattachorgan -- 兼职柜员所属机构
    ,nvl(n.subsidydate, o.subsidydate) as subsidydate -- 补贴正式发放日期
    ,nvl(n.userid, o.userid) as userid -- 钉钉UserID
    ,nvl(n.placehr, o.placehr) as placehr -- HR职务编码(HR更新）
    ,nvl(n.jobcategory, o.jobcategory) as jobcategory -- (职务类别)员工职务代码
    ,nvl(n.jobcategoryname, o.jobcategoryname) as jobcategoryname -- 职务类别名称HR
    ,case when
            n.id is null
        then o.start_dt
...
from (select * from ${iol_schema}.hgls_gh_uus_employee_bk where start_dt < to_date('${batch_date}','yyyymmdd') and end_dt >= to_date('${batch_date}','yyyymmdd')) o
    full join (select * from ${itl_schema}.hgls_gh_uus_employee where etl_dt = to_date('${batch_date}', 'yyyymmdd')) n
        on
            o.id = n.id
where (
        o.id is null
    ...
    or (
        ...
        or o.partorgancode <> n.partorgancode
        or o.partplace <> n.partplace
        or o.hsorgancode <> n.hsorgancode
        or o.parttellerno <> n.parttellerno
        or o.parttellerattachorgan <> n.parttellerattachorgan
        or o.subsidydate <> n.subsidydate
        or o.userid <> n.userid
        or o.placehr <> n.placehr
        or o.jobcategory <> n.jobcategory
        or o.jobcategoryname <> n.jobcategoryname
    )
;
commit;
...
select
    ...
    ,o.tellerlevel -- 柜员级别
    ,o.tellermanagerid -- 旧柜员号
    ,o.attachorgan -- 柜员所属机构
    ,o.theentrydate -- 员工入职日期
    ...
    ,o.sallevel -- 薪资级别
    ,o.orderno -- 序号
    ,o.partorgancode -- 兼职所在部门编号
    ,o.partplace -- 
    ,o.hsorgancode -- 虚拟核算部门编号
    ,o.parttellerno -- 兼职柜员号
    ,o.parttellerattachorgan -- 兼职柜员所属机构
    ,o.subsidydate -- 补贴正式发放日期
    ,o.userid -- 钉钉UserID
    ,o.placehr -- HR职务编码(HR更新）
    ,o.jobcategory -- (职务类别)员工职务代码
    ,o.jobcategoryname -- 职务类别名称HR
    ,o.start_dt -- 开始时间
...
from ${iol_schema}.hgls_gh_uus_employee_bk o
    left join ${iol_schema}.hgls_gh_uus_employee_op n
        on
            o.id = n.id
            and o.end_dt >= to_date('${batch_date}','yyyymmdd')
    left join ${iol_schema}.hgls_gh_uus_employee_cl d
        on
            o.id = d.id
...
--truncate table ${iol_schema}.hgls_gh_uus_employee;

-- 4.2 rebuild partition
declare
v_sql varchar2(100);
begin
for cur in (select partition_name from all_tab_partitions where table_owner=upper('${iol_schema}') and table_name=upper('hgls_gh_uus_employee') and substr(partition_name,3) >= '${batch_date}' and substr(partition_name,3) < '20991231') loop
    v_sql := 'alter table ${iol_schema}.hgls_gh_uus_employee drop partition ' || cur.partition_name;
    dbms_output.put_line(v_sql);
    execute immediate v_sql;
end loop;
end;
/
alter table ${iol_schema}.hgls_gh_uus_employee add partition p_${batch_date} values(to_date('${batch_date}','YYYYMMDD'));

-- 4.3 exchange partition
alter table ${iol_schema}.hgls_gh_uus_employee exchange partition p_${batch_date} with table ${iol_schema}.hgls_gh_uus_employee_cl;
alter table ${iol_schema}.hgls_gh_uus_employee exchange partition p_20991231 with table ${iol_schema}.hgls_gh_uus_employee_op;
...
whenever sqlerror exit sql.sqlcode;
drop table ${iol_schema}.hgls_gh_uus_employee_bk purge;

-- 6 gater table status
whenever sqlerror exit sql.sqlcode;
exec dbms_stats.gather_table_stats(ownname => '${iol_schema}',tabname => 'hgls_gh_uus_employee',partname => 'p_20991231', granularity => 'PARTITION', degree => 8, cascade => true);
