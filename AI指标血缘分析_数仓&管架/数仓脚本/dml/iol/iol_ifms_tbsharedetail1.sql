...
Author:     Sunline
Usage:      python $ETL_HOME/script/main.py yyyymmdd iol_ifms_tbsharedetail1
CreateDate: 20180515
Logs:
    zjj 2018-05-15 新建脚本
*/
...
create table ${iol_schema}.ifms_tbsharedetail1_bk nologging
compress ${option_switch} for query high
as
select *
from ${iol_schema}.ifms_tbsharedetail1;

-- 2.2 drop temp table
-- it is no need to check when this segment SQL was return faied
whenever sqlerror continue none ;
drop table ${iol_schema}.ifms_tbsharedetail1_op purge;
drop table ${iol_schema}.ifms_tbsharedetail1_cl purge;

-- 2.3 create temp table
whenever sqlerror exit sql.sqlcode;
create table ${iol_schema}.ifms_tbsharedetail1_op nologging
compress ${option_switch} for query high
as
select * from ${iol_schema}.ifms_tbsharedetail1 where 0=1;

create table ${iol_schema}.ifms_tbsharedetail1_cl nologging
compress ${option_switch} for query high
as
select * from ${iol_schema}.ifms_tbsharedetail1 where 0=1;
...
insert /*+ append */ all
    when end_dt = to_date('${batch_date}', 'yyyymmdd') then
        into ${iol_schema}.ifms_tbsharedetail1_cl(
            in_client_no -- 
            ,seller_code -- 
            ,bank_no -- 
            ,client_no -- 
        ...
        into ${iol_schema}.ifms_tbsharedetail1_op(
            in_client_no -- 
            ,seller_code -- 
            ,bank_no -- 
            ,client_no -- 
...
select
    ...
    ,nvl(n.ori_cfm_amt, o.ori_cfm_amt) as ori_cfm_amt -- 
    ,nvl(n.ori_cfm_vol, o.ori_cfm_vol) as ori_cfm_vol -- 
    ,nvl(n.ori_nav, o.ori_nav) as ori_nav -- 
    ,nvl(n.gain_balance, o.gain_balance) as gain_balance -- 
    ,nvl(n.ori_back_fee_rate, o.ori_back_fee_rate) as ori_back_fee_rate -- 
    ,nvl(n.ori_source_flag, o.ori_source_flag) as ori_source_flag -- 
    ,nvl(n.even_nav, o.even_nav) as even_nav -- 
    ,nvl(n.min_back_rate, o.min_back_rate) as min_back_rate -- 
    ,nvl(n.min_redeem_rate, o.min_redeem_rate) as min_redeem_rate -- 
    ,nvl(n.max_allot_rate, o.max_allot_rate) as max_allot_rate -- 
    ,nvl(n.ori_agio, o.ori_agio) as ori_agio -- 
    ,nvl(n.channel, o.channel) as channel -- 
    ,nvl(n.client_group, o.client_group) as client_group -- 
    ,nvl(n.last_cycle_date, o.last_cycle_date) as last_cycle_date -- 
...
from (select * from ${iol_schema}.ifms_tbsharedetail1_bk where start_dt < to_date('${batch_date}','yyyymmdd') and end_dt >= to_date('${batch_date}','yyyymmdd')) o
    full join (select * from ${itl_schema}.ifms_tbsharedetail1 where etl_dt = to_date('${batch_date}', 'yyyymmdd')) n
        on
...
where (
    ...
    or (
        ...
        or o.ori_cfm_amt <> n.ori_cfm_amt
        or o.ori_cfm_vol <> n.ori_cfm_vol
        or o.ori_nav <> n.ori_nav
        or o.gain_balance <> n.gain_balance
        or o.ori_back_fee_rate <> n.ori_back_fee_rate
        or o.ori_source_flag <> n.ori_source_flag
        or o.even_nav <> n.even_nav
        or o.min_back_rate <> n.min_back_rate
        or o.min_redeem_rate <> n.min_redeem_rate
        or o.max_allot_rate <> n.max_allot_rate
...
select
    ...
    ,o.id_mark -- 增删标志
    ,to_timestamp('${batch_timestamp}', 'yyyy-mm-dd hh24:mi:ss.ff6') as etl_timestamp -- ETL处理时间
from ${iol_schema}.ifms_tbsharedetail1_bk o
    left join ${iol_schema}.ifms_tbsharedetail1_op n
        on
            o.in_client_no = n.in_client_no
            and o.seller_code = n.seller_code
            and o.bank_no = n.bank_no
    ...
    left join ${iol_schema}.ifms_tbsharedetail1_cl d
        on
...
-- truncate table ${iol_schema}.ifms_tbsharedetail1;

-- 4.2 exchange partition
alter table ${iol_schema}.ifms_tbsharedetail1 exchange partition p_19000101 with table ${iol_schema}.ifms_tbsharedetail1_cl;
alter table ${iol_schema}.ifms_tbsharedetail1 exchange partition p_20991231 with table ${iol_schema}.ifms_tbsharedetail1_op;
...
whenever sqlerror exit sql.sqlcode;
drop table ${iol_schema}.ifms_tbsharedetail1_bk purge;

-- 6 gater table status
whenever sqlerror exit sql.sqlcode;
exec dbms_stats.gather_table_stats(ownname => '${iol_schema}',tabname => 'ifms_tbsharedetail1',partname => 'p_20991231', granularity => 'PARTITION', degree => 8, cascade => true);
