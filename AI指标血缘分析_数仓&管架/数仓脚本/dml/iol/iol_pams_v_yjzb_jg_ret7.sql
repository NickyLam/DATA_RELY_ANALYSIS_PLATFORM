...
begin
  ...
  for tb in (select table_name, partition_name, substr(partition_name, 3) as etl_dt
               from user_tab_partitions
                ...
                and substr(partition_name, 3) >= '20250313'
                and substr(partition_name, 3) < '20250509'
             ) loop
...
from ${iol_schema}.pams_v_yjzb_jg_bak${batch_date} t1
 where t1.etl_dt >= to_date('20250313', 'yyyymmdd')
 and t1.etl_dt < to_date('20250509', 'yyyymmdd');
