...
begin
  for tb in (select table_name,partition_name,substr(partition_name,3) as etl_dt
               from user_tab_partitions
                ...
                and substr(partition_name, 3) >= '20241204'
		and substr(partition_name, 3) < '20241228'
             ) loop
...
from ${iol_schema}.pams_v_yjzb_hy_bak${batch_date} t1
 where t1.etl_dt >= to_date('20241204', 'yyyymmdd')
 and t1.etl_dt < to_date('20241228', 'yyyymmdd');
