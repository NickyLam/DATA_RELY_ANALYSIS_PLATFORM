/*
Purpose:    流程银行已处理任务数JZ020102-D层业务分析表:数据来源于流程银行PBSS
Author:     Sunline/谢婉宜
Usage:      python $ETL_HOME/script/main.py yyyymmdd idl_mcyy_bu_analysis_jz020102_pbss
Createdate: 20210112
Logs:
