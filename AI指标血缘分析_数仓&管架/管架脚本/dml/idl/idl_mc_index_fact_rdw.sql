...
exec dbms_stats.gather_table_stats(ownname => '${idl_schema}', tabname => 'mc_index_fact',partname => 'p_${batch_date}_rdw', granularity => 'SUBPARTITION', degree => 8, cascade => true);
