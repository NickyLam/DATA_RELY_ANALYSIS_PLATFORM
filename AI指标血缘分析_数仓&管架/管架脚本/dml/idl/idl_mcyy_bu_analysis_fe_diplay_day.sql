...
Author:     Sunline/郑沛隆
Usage:      python $ETL_HOME/script/main.py yyyymmdd idl_mcyy_bu_analysis_fe_diplay_day
Createdate: 20210624
Logs:
...
--需要删除当日数据
delete ${idl_schema}.mcyy_bu_analysis_fe_diplay where etl_dt=to_date('${batch_date}','yyyymmdd');
commit;
