...
load data
infile '${data_path}/ncts_ab_auth_taskpoolthreshold.f.${yyyymmdd}.dat'
truncate into table ${msl_schema}.msl_edw_ncts_ab_auth_taskpoolthreshold
...
(
    ...
    ,THRESHOLD char(4000) nullif THRESHOLD=blanks 
