...
load data
infile '${data_path}/pams_jxbb_ckftpmx_recal.i.${yyyymmdd}.dat'
truncate into table ${msl_schema}.msl_edw_pams_jxbb_ckftpmx_recal
...
(
    ...
    ,sjssjgdh char(4000) nullif sjssjgdh=blanks 
