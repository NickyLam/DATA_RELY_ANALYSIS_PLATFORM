...
load data
infile '${data_path}/mcs_ovdue_loan_dtl.${yyyymmdd}.dat'
truncate into table ${msl_schema}.msl_rdw_rdw_mcs_ovdue_loan_dtl
...
(
    ...
    ,ovdue_happ_dt char(4000) nullif ovdue_happ_dt=blanks 
