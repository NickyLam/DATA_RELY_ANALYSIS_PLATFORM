...
load data
infile '${data_path}/pcls_yxyd_credit_bucket.f.${yyyymmdd}.dat'
truncate into table ${msl_schema}.msl_edw_pcls_yxyd_credit_bucket
fields terminated by x'1b' 
trailing nullcols
(
    etl_dt date "yyyy-mm-dd hh24:mi:ss" nullif etl_dt=blanks 
    ,creditline_area char(4000) nullif creditline_area=blanks 
