...
load data
infile '${data_path}/pcls_yxyd_sj_info.f.${yyyymmdd}.dat'
truncate into table ${msl_schema}.msl_edw_pcls_yxyd_sj_info
fields terminated by x'1b' 
trailing nullcols
(
    etl_dt date "yyyy-mm-dd hh24:mi:ss" nullif etl_dt=blanks 
    ,rj_rule_big char(4000) nullif rj_rule_big=blanks 
    ,rj_rule char(4000) nullif rj_rule=blanks 
