...
load data
infile '${data_path}/U_IP_RESULT_ICRW_MCSS.${yyyymmdd}.dat'
truncate into table ${msl_schema}.msl_ccrw_u_ip_result_icrw_mcss
...
(
    ...
    ,tw_sub_bal char(4000) nullif tw_sub_bal=blanks 
    ,tw_sub_zf char(4000) nullif tw_sub_zf=blanks 
)