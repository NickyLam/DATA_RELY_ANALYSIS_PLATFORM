...
truncate into table ${msl_schema}.msl_edw_cmm_intnal_org_info
...
(
    ...
    ,org_en_name char(4000) nullif org_en_name=blanks 
    ,org_en_abbr char(4000) nullif org_en_abbr=blanks 
    ,tax_regi_cert_num char(4000) nullif tax_regi_cert_num=blanks 
    ,pay_sys_bank_no char(4000) nullif pay_sys_bank_no=blanks 
    ,orgnz_cd char(4000) nullif orgnz_cd=blanks 
    ,dtl_org_flg char(4000) nullif dtl_org_flg=blanks 
    ,swiftcode char(4000) nullif swiftcode=blanks 
    ,idd_area_cd char(4000) nullif idd_area_cd=blanks 
    ,ext_num char(4000) nullif ext_num=blanks 
    ,serv_tel char(4000) nullif serv_tel=blanks 
    ,e_mail char(4000) nullif e_mail=blanks 
    ,url char(4000) nullif url=blanks 
    ,pbc_belong_city_cd char(4000) nullif pbc_belong_city_cd=blanks 
    ,pbc_belong_city char(4000) nullif pbc_belong_city=blanks 
    ,rept_super_org_id char(4000) nullif rept_super_org_id=blanks 
)