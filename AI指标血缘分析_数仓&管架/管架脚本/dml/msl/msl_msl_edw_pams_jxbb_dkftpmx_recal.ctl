...
load data
infile '${data_path}/pams_jxbb_dkftpmx_recal.i.${yyyymmdd}.dat'
truncate into table ${msl_schema}.msl_edw_pams_jxbb_dkftpmx_recal
...
(
    ...
    ,ljtzysje char(4000) nullif ljtzysje=blanks 
    ,tzhljftpjsy char(4000) nullif tzhljftpjsy=blanks 
    ,ljtzfyje char(4000) nullif ljtzfyje=blanks 
    ,jjljftpjsy char(4000) nullif jjljftpjsy=blanks 
)