...
load data
infile '${data_path}/pcls_yxyd_sx_org_info.f.${yyyymmdd}.dat'
truncate into table ${msl_schema}.msl_edw_pcls_yxyd_sx_org_info
fields terminated by x'1b' 
trailing nullcols
(
    etl_dt date "yyyy-mm-dd hh24:mi:ss" nullif etl_dt=blanks 
    ,bank_nm char(4000) nullif bank_nm=blanks 
    ,appl_cnt char(4000) nullif appl_cnt=blanks 
    ,monthcreated1 char(4000) nullif monthcreated1=blanks 
