...
load data
infile '${data_path}/agt_corp_e_prod_acct_rela_h.f.${yyyymmdd}.dat'
truncate into table ${msl_schema}.msl_edw_agt_corp_e_prod_acct_rela_h
...
(
    ...
    ,ACCT_ROLE_TYPE_CD char(4000) nullif ACCT_ROLE_TYPE_CD=blanks 
