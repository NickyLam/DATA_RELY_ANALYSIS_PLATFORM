...
truncate table ${itl_schema}.itl_edw_pams_jxbb_ckftpmx;
...
BEGIN
  FOR rec IN (SELECT DISTINCT etl_dt FROM ${msl_schema}.msl_edw_pams_jxbb_ckftpmx) 
  LOOP
    BEGIN
      EXECUTE IMMEDIATE 
        'ALTER TABLE ${itl_schema}.itl_edw_pams_jxbb_ckftpmx ADD PARTITION p_' || TO_CHAR(rec.etl_dt, 'yyyymmdd') ||
...
whenever sqlerror exit sql.sqlcode;
insert /*+ append */ into ${itl_schema}.itl_edw_pams_jxbb_ckftpmx (
    tjrq -- 
    ,jxdxdh -- 
    ,khdxdh -- 
    ,zhhm -- 账户户名
